...
public final class Route {
    ...
    public Route(Address address2, Proxy proxy2, InetSocketAddress inetSocketAddress) {
        vx2.m53591g(address2, Address.TYPE_NAME);
        vx2.m53591g(proxy2, "proxy");
        vx2.m53591g(inetSocketAddress, "socketAddress");
    ...
    public final Address m75776deprecated_address() {
        return this.address;
    }

    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m75777deprecated_proxy() {
        return this.proxy;
    }

    /* renamed from: -deprecated_socketAddress  reason: not valid java name */
    public final InetSocketAddress m75778deprecated_socketAddress() {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Route) {
            ...
            if (!vx2.m53586b(route.address, this.address) || !vx2.m53586b(route.proxy, this.proxy) || !vx2.m53586b(route.socketAddress, this.socketAddress)) {
                return false;
            }
            return true;
        }
