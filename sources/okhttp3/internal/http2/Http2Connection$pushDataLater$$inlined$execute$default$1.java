...
public final class Http2Connection$pushDataLater$$inlined$execute$default$1 extends Task {
    public final /* synthetic */ m40 $buffer$inlined;
    ...
    public Http2Connection$pushDataLater$$inlined$execute$default$1(String str, boolean z, Http2Connection http2Connection, int i, m40 m40, int i2, boolean z2) {
        super(str, z);
        this.$name = str;
        this.$cancelable = z;
        this.this$0 = http2Connection;
        this.$streamId$inlined = i;
        this.$buffer$inlined = m40;
    ...
    public long runOnce() {
        /*
            ...
            m40 r2 = r5.$buffer$inlined     // Catch:{ IOException -> 0x003e }
