...
public final class Http2Reader implements Closeable {
    ...
    @Metadata(mo44876d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001e\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\b2\u0006\u0010\n\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\bR\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\f"}, mo44877d2 = {"Lokhttp3/internal/http2/Http2Reader$Companion;", "", "()V", "logger", "Ljava/util/logging/Logger;", "getLogger", "()Ljava/util/logging/Logger;", "lengthWithoutPadding", "", "length", "flags", "padding", "okhttp"}, mo44878k = 1, mo44879mv = {1, 6, 0}, mo44881xi = 48)
    /* compiled from: Http2Reader.kt */
    ...
    @Metadata(mo44875bv = {}, mo44876d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0015\b\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\r\u001a\u00020\f¢\u0006\u0004\b\"\u0010#J\b\u0010\u0003\u001a\u00020\u0002H\u0002J\u0018\u0010\b\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0016J\b\u0010\n\u001a\u00020\tH\u0016J\b\u0010\u000b\u001a\u00020\u0002H\u0016R\u0014\u0010\r\u001a\u00020\f8\u0002X\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000eR\"\u0010\u0010\u001a\u00020\u000f8\u0006@\u0006X\u000e¢\u0006\u0012\n\u0004\b\u0010\u0010\u0011\u001a\u0004\b\u0012\u0010\u0013\"\u0004\b\u0014\u0010\u0015R\"\u0010\u0016\u001a\u00020\u000f8\u0006@\u0006X\u000e¢\u0006\u0012\n\u0004\b\u0016\u0010\u0011\u001a\u0004\b\u0017\u0010\u0013\"\u0004\b\u0018\u0010\u0015R\"\u0010\u0019\u001a\u00020\u000f8\u0006@\u0006X\u000e¢\u0006\u0012\n\u0004\b\u0019\u0010\u0011\u001a\u0004\b\u001a\u0010\u0013\"\u0004\b\u001b\u0010\u0015R\"\u0010\u001c\u001a\u00020\u000f8\u0006@\u0006X\u000e¢\u0006\u0012\n\u0004\b\u001c\u0010\u0011\u001a\u0004\b\u001d\u0010\u0013\"\u0004\b\u001e\u0010\u0015R\"\u0010\u001f\u001a\u00020\u000f8\u0006@\u0006X\u000e¢\u0006\u0012\n\u0004\b\u001f\u0010\u0011\u001a\u0004\b \u0010\u0013\"\u0004\b!\u0010\u0015¨\u0006$"}, mo44877d2 = {"Lokhttp3/internal/http2/Http2Reader$ContinuationSource;", "Lz56;", "Lr37;", "readContinuationHeader", "Lm40;", "sink", "", "byteCount", "read", "Lqq6;", "timeout", "close", "Lw40;", "source", "Lw40;", "", "length", "I", "getLength", "()I", "setLength", "(I)V", "flags", "getFlags", "setFlags", "streamId", "getStreamId", "setStreamId", "left", "getLeft", "setLeft", "padding", "getPadding", "setPadding", "<init>", "(Lw40;)V", "okhttp"}, mo44878k = 1, mo44879mv = {1, 6, 0})
    /* compiled from: Http2Reader.kt */
    public static final class ContinuationSource implements z56 {
        private int flags;
        private int left;
        private int length;
        private int padding;
        ...
        public ContinuationSource(w40 w40) {
        ...
        public long read(m40 m40, long j) throws IOException {
            ...
            while (true) {
                ...
                if (i == 0) {
                    ...
                    long read = this.source.read(m40, Math.min(j, (long) i));
                    if (read == -1) {
                        return -1;
                    }
                    this.left -= (int) read;
    ...
    public interface Handler {
        ...
        void data(boolean z, int i, w40 w40, int i2) throws IOException;
    ...
    static {
        ...
        vx2.m53590f(logger2, "getLogger(Http2::class.java.name)");
        logger = logger2;
    }

    public Http2Reader(w40 w40, boolean z) {
        vx2.m53591g(w40, "source");
        this.source = w40;
        this.client = z;
        ContinuationSource continuationSource = new ContinuationSource(w40);
    ...
    private final void readGoAway(Handler handler, int i, int i2, int i3) throws IOException {
        if (i < 8) {
            throw new IOException(vx2.m53598n("TYPE_GOAWAY length < 8: ", Integer.valueOf(i)));
        } else if (i3 == 0) {
            ...
            if (fromHttp2 != null) {
                ...
                if (i4 > 0) {
                    byteString = this.source.mo56106z0((long) i4);
                }
                handler.goAway(readInt, fromHttp2, byteString);
                return;
            }
            throw new IOException(vx2.m53598n("TYPE_GOAWAY unexpected error code: ", Integer.valueOf(readInt2)));
        } else {
    ...
    private final void readPing(Handler handler, int i, int i2, int i3) throws IOException {
        if (i != 8) {
            throw new IOException(vx2.m53598n("TYPE_PING length != 8: ", Integer.valueOf(i)));
        } else if (i3 == 0) {
            int readInt = this.source.readInt();
            int readInt2 = this.source.readInt();
            boolean z = true;
    ...
    private final void readRstStream(Handler handler, int i, int i2, int i3) throws IOException {
        if (i != 4) {
            ...
            throw new IOException(vx2.m53598n("TYPE_RST_STREAM unexpected error code: ", Integer.valueOf(readInt)));
        } else {
    ...
    private final void readSettings(Handler handler, int i, int i2, int i3) throws IOException {
        ...
        if (i3 != 0) {
            ...
            pw2 p = d75.m43394p(d75.m43395q(0, i), 6);
            int n = p.mo46910n();
            int q = p.mo46911q();
            int r = p.mo46912r();
            if ((r > 0 && n <= q) || (r < 0 && q <= n)) {
                ...
                throw new IOException(vx2.m53598n("PROTOCOL_ERROR SETTINGS_MAX_FRAME_SIZE: ", Integer.valueOf(readInt)));
            }
            handler.settings(false, settings);
        } else {
            throw new IOException(vx2.m53598n("TYPE_SETTINGS length % 6 != 0: ", Integer.valueOf(i)));
        }
    }
    ...
    private final void readWindowUpdate(Handler handler, int i, int i2, int i3) throws IOException {
        ...
        throw new IOException(vx2.m53598n("TYPE_WINDOW_UPDATE length !=4: ", Integer.valueOf(i)));
    }
    ...
    public final boolean nextFrame(boolean z, Handler handler) throws IOException {
        vx2.m53591g(handler, "handler");
        try {
            this.source.mo56094u0(9);
            int readMedium = Util.readMedium(this.source);
            if (readMedium <= 16384) {
                int and = Util.and(this.source.readByte(), 255);
                ...
                if (!z || and == 4) {
                    ...
                    throw new IOException(vx2.m53598n("Expected a SETTINGS frame but was ", Http2.INSTANCE.formattedType$okhttp(and)));
                }
            } else {
                throw new IOException(vx2.m53598n("FRAME_SIZE_ERROR: ", Integer.valueOf(readMedium)));
            }
    ...
    public final void readConnectionPreface(Handler handler) throws IOException {
        ...
        if (!this.client) {
            ...
            ByteString z0 = w40.mo56106z0((long) byteString.size());
            Logger logger2 = logger;
            if (logger2.isLoggable(Level.FINE)) {
                logger2.fine(Util.format(vx2.m53598n("<< CONNECTION ", z0.hex()), new Object[0]));
            }
            if (!vx2.m53586b(byteString, z0)) {
                throw new IOException(vx2.m53598n("Expected a connection header but was ", z0.utf8()));
            }
