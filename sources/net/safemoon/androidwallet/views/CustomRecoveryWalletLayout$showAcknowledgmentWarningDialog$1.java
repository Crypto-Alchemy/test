...
public final class CustomRecoveryWalletLayout$showAcknowledgmentWarningDialog$1 extends Lambda implements pc2<r37> {
    ...
    public final void invoke() {
        if (this.$checkType == 1) {
            this.this$0.mo62113y();
        } else {
            this.this$0.mo62112x();
        }
    }
}
