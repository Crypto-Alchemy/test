...
@v21(mo48631c = "net.safemoon.androidwallet.viewmodels.CustomContractTokenViewModel$getContractInfoNonEvm$1", mo48632f = "CustomContractTokenViewModel.kt", mo48633l = {133}, mo48634m = "invokeSuspend")
/* compiled from: CustomContractTokenViewModel.kt */
public final class CustomContractTokenViewModel$getContractInfoNonEvm$1 extends SuspendLambda implements fd2<hu0, ns0<? super r37>, Object> {
    ...
    /* renamed from: net.safemoon.androidwallet.viewmodels.CustomContractTokenViewModel$getContractInfoNonEvm$1$a */
    /* compiled from: CustomContractTokenViewModel.kt */
    ...
    public CustomContractTokenViewModel$getContractInfoNonEvm$1(TokenType tokenType, String str, CustomContractTokenViewModel customContractTokenViewModel, ns0<? super CustomContractTokenViewModel$getContractInfoNonEvm$1> ns0) {
        super(2, ns0);
    ...
    public final ns0<r37> create(Object obj, ns0<?> ns0) {
        return new CustomContractTokenViewModel$getContractInfoNonEvm$1(this.$tokenType, this.$contractAddress, this.this$0, ns0);
    }

    public final Object invoke(hu0 hu0, ns0<? super r37> ns0) {
        return ((CustomContractTokenViewModel$getContractInfoNonEvm$1) create(hu0, ns0)).invokeSuspend(r37.f33317a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            hg5.m45199b(obj);
            if (C8671a.f42705a[this.$tokenType.ordinal()] == 1) {
            ...
            this.this$0.mo61163v().postValue(commonTokenInfo);
            return r37.f33317a;
        } else if (i == 1) {
            try {
                hg5.m45199b(obj);
