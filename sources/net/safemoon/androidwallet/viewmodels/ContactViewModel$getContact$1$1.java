...
public final class ContactViewModel$getContact$1$1 implements IContact {
    private String address;
    private int chainAddress;
    private Long contactCreate = Long.valueOf(System.currentTimeMillis());

    /* renamed from: id */
    private int f42668id;
    private Long lastSent;
    private String linkId;
    private String name;
    private String profilePath;

    public ContactViewModel$getContact$1$1(RequestContact requestContact, Map.Entry<Integer, String> entry, String str) {
        this.f42668id = requestContact.getId();
        String name2 = requestContact.getName();
        vx2.m53588d(name2);
        this.name = name2;
        this.address = entry.getValue();
        this.chainAddress = entry.getKey().intValue();
        this.profilePath = str;
        String linkId2 = requestContact.getLinkId();
        vx2.m53588d(linkId2);
        this.linkId = linkId2;
    }
