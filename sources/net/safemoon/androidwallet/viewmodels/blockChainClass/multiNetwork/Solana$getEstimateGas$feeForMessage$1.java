...
@v21(mo48631c = "net.safemoon.androidwallet.viewmodels.blockChainClass.multiNetwork.Solana$getEstimateGas$feeForMessage$1", mo48632f = "Solana.kt", mo48633l = {226}, mo48634m = "invokeSuspend")
/* compiled from: Solana.kt */
public final class Solana$getEstimateGas$feeForMessage$1 extends SuspendLambda implements fd2<Integer, ns0<? super BigInteger>, Object> {
    ...
    public Solana$getEstimateGas$feeForMessage$1(Solana solana, String str, ns0<? super Solana$getEstimateGas$feeForMessage$1> ns0) {
        super(2, ns0);
        this.this$0 = solana;
    ...
    public final ns0<r37> create(Object obj, ns0<?> ns0) {
        Solana$getEstimateGas$feeForMessage$1 solana$getEstimateGas$feeForMessage$1 = new Solana$getEstimateGas$feeForMessage$1(this.this$0, this.$unSignMessage, ns0);
        solana$getEstimateGas$feeForMessage$1.I$0 = ((Number) obj).intValue();
        return solana$getEstimateGas$feeForMessage$1;
    }

    public final Object invoke(int i, ns0<? super BigInteger> ns0) {
        return ((Solana$getEstimateGas$feeForMessage$1) create(Integer.valueOf(i), ns0)).invokeSuspend(r37.f33317a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            String str = this.$unSignMessage;
            vx2.m53590f(str, "unSignMessage");
            k90<SolanaGetFeeForMessageResponse> c = n.mo56377c(new SolanaGetFeeForMessageRequest(str));
            this.label = 1;
