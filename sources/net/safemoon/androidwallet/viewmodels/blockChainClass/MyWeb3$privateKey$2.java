...
public final class MyWeb3$privateKey$2 extends Lambda implements pc2<String> {
    public final /* synthetic */ MyWeb3 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MyWeb3$privateKey$2(MyWeb3 myWeb3) {
        super(0);
        this.this$0 = myWeb3;
    }
    ...
    public final String invoke() {
        ...
        if (c != null) {
            return c.getPrivateKey(this.this$0.mo61838f().getCoinType().getValue());
        }
        return null;
    }
}
