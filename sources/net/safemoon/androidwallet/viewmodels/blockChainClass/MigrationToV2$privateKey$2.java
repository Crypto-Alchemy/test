...
public final class MigrationToV2$privateKey$2 extends Lambda implements pc2<String> {
    public final /* synthetic */ MigrationToV2 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MigrationToV2$privateKey$2(MigrationToV2 migrationToV2) {
        super(0);
    ...
    public final String invoke() {
        ...
        if (c != null) {
            return c.getPrivateKey(MyCoinType.ETHEREUM.getValue());
        }
        return null;
    }
}
