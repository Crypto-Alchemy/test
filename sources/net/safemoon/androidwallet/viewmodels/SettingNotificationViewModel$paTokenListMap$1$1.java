...
public final class SettingNotificationViewModel$paTokenListMap$1$1 extends Lambda implements rc2<List<? extends PAToken>, r37> {
    ...
    public SettingNotificationViewModel$paTokenListMap$1$1(SettingNotificationViewModel settingNotificationViewModel, ls3<List<PAToken>> ls3) {
        super(1);
