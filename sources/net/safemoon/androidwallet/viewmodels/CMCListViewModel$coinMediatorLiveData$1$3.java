...
public final class CMCListViewModel$coinMediatorLiveData$1$3 extends Lambda implements rc2<String, r37> {
    public final /* synthetic */ ls3<List<qx1>> $this_apply;
    public final /* synthetic */ CMCListViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CMCListViewModel$coinMediatorLiveData$1$3(CMCListViewModel cMCListViewModel, ls3<List<qx1>> ls3) {
        super(1);
