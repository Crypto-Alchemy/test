...
public final class MultiWalletViewModel$fcmDataSource$2 extends Lambda implements pc2<FcmDataSource> {
    public final /* synthetic */ Application $application;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MultiWalletViewModel$fcmDataSource$2(Application application) {
        super(0);
