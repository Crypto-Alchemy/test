...
/* renamed from: net.safemoon.androidwallet.fragments.MyTokensListFragment$special$$inlined$activityViewModels$default$4 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8400xe4ace8ed extends Lambda implements pc2<gd7> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8400xe4ace8ed(Fragment fragment) {
        super(0);
