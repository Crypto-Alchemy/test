...
public final class WalletFragment$special$$inlined$viewModels$default$4 extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ ef3 $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public WalletFragment$special$$inlined$viewModels$default$4(pc2 pc2, ef3 ef3) {
        super(0);
