...
/* renamed from: net.safemoon.androidwallet.fragments.ChainNetworkReflectionFragment$special$$inlined$viewModels$default$3 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8381x21344a51 extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ ef3 $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8381x21344a51(pc2 pc2, ef3 ef3) {
        super(0);
