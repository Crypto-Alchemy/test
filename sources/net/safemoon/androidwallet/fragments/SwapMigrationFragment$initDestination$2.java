...
public final class SwapMigrationFragment$initDestination$2 extends Lambda implements rc2<Swap, r37> {
    public final /* synthetic */ SwapMigrationFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapMigrationFragment$initDestination$2(SwapMigrationFragment swapMigrationFragment) {
        super(1);
    ...
    public final void invoke(Swap swap) {
        if (swap != null) {
            ...
            if ((str.length() > 0) || swap.imageResource > 0) {
                ...
                ((be5) C1710a.m12225u(i0.f28839l).mo23163x(q70.m71190f(new zh0(str2, str3, Integer.valueOf(swap.imageResource)))).mo22581g0(MlKitException.CODE_SCANNER_UNAVAILABLE, MlKitException.CODE_SCANNER_UNAVAILABLE)).mo11567a(qe5.m25623x0()).mo11553K0(i0.f28839l);
            }
            MaterialTextView materialTextView = i0.f28845r;
