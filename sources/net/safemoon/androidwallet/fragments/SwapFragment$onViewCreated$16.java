...
public final class SwapFragment$onViewCreated$16 extends Lambda implements rc2<Gas, r37> {
    public final /* synthetic */ SwapFragment this$0;

    @Metadata(mo44878k = 3, mo44879mv = {1, 7, 1}, mo44881xi = 48)
    /* renamed from: net.safemoon.androidwallet.fragments.SwapFragment$onViewCreated$16$a */
    /* compiled from: SwapFragment.kt */
    public /* synthetic */ class C8465a {
        ...
        static {
            ...
            L_0x0022:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: net.safemoon.androidwallet.fragments.SwapFragment$onViewCreated$16.C8465a.<clinit>():void");
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapFragment$onViewCreated$16(SwapFragment swapFragment) {
        super(1);
    ...
    public final void invoke(Gas gas) {
        int i = gas == null ? -1 : C8465a.f42176a[gas.ordinal()];
        xa2 xa2 = null;
        if (i == 1) {
