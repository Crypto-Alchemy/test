...
public final class SwapMigrationFragment$onViewCreated$28 extends Lambda implements rc2<LoadingState, r37> {
    public final /* synthetic */ SwapMigrationFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapMigrationFragment$onViewCreated$28(SwapMigrationFragment swapMigrationFragment) {
        super(1);
    ...
    public final void invoke(LoadingState loadingState) {
        if (loadingState != null) {
            ...
            if (loadingState == LoadingState.Loading) {
                BestMaxFragment a = BestMaxFragment.f41710U.mo57164a();
                ...
                a.mo57163I(childFragmentManager);
            }
        }
    }
}
