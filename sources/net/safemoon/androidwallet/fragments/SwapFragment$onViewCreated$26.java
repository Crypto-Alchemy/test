...
public final class SwapFragment$onViewCreated$26 extends Lambda implements rc2<LoadingState, r37> {
    public final /* synthetic */ SwapFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapFragment$onViewCreated$26(SwapFragment swapFragment) {
        super(1);
    ...
    public final void invoke(LoadingState loadingState) {
        if (loadingState != null) {
            ...
            if (loadingState == LoadingState.Loading) {
                ...
                vx2.m53590f(string, "resources.getString(R.string.approving)");
