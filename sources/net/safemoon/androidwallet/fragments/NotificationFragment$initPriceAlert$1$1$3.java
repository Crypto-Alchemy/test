...
public final class NotificationFragment$initPriceAlert$1$1$3 extends Lambda implements rc2<Editable, r37> {
    public final /* synthetic */ ga2 $this_with;
    public final /* synthetic */ NotificationFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NotificationFragment$initPriceAlert$1$1$3(ga2 ga2, NotificationFragment notificationFragment) {
        super(1);
        this.$this_with = ga2;
    ...
    public final void invoke(Editable editable) {
        TextInputEditText textInputEditText = this.$this_with.f29156k.f34980b;
