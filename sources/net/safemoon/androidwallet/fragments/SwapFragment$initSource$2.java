...
public final class SwapFragment$initSource$2 extends Lambda implements rc2<Swap, r37> {
    public final /* synthetic */ SwapFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapFragment$initSource$2(SwapFragment swapFragment) {
        super(1);
    ...
    public final void invoke(Swap swap) {
        if (swap != null) {
            ...
            if ((str.length() > 0) || swap.imageResource > 0) {
                ...
                ((be5) C1710a.m12225u(w0.f28839l).mo23163x(q70.m71190f(new zh0(str2, str3, Integer.valueOf(swap.imageResource)))).mo22581g0(swapFragment.f42168x, swapFragment.f42169y)).mo11567a(qe5.m25623x0()).mo11553K0(w0.f28839l);
            }
            MaterialTextView materialTextView = w0.f28845r;
            ...
            if (value != null && value.mo61635b()) {
                ...
                G0.postValue(new SwapViewModel.C8786a(true, bigDecimal));
            }
        }
    }
}
