...
public final class CalculatorFragment$onViewCreated$8 extends Lambda implements rc2<List<? extends C9449vc>, r37> {
    public final /* synthetic */ CalculatorFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CalculatorFragment$onViewCreated$8(CalculatorFragment calculatorFragment) {
        super(1);
    ...
    public final void invoke(List<C9449vc> list) {
        if (list != null) {
            this.this$0.f41904B.mo57152g(list);
        }
        this.this$0.mo57441A0();
    }
}
