...
public final class AddCustomReflectionContractFragment$onViewCreated$1$7 extends Lambda implements rc2<TokenDetail, r37> {
    public final /* synthetic */ a92 $this_apply;
    public final /* synthetic */ AddCustomReflectionContractFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddCustomReflectionContractFragment$onViewCreated$1$7(a92 a92, AddCustomReflectionContractFragment addCustomReflectionContractFragment) {
        super(1);
        this.$this_apply = a92;
    ...
    public final void invoke(TokenDetail tokenDetail) {
        if (tokenDetail != null) {
            ...
            ((be5) u.mo23163x(C9384u3.m72568i(num.intValue(), tokenDetail.symbol, this.this$0.mo57393C().mo61190t())).mo22581g0(MlKitException.CODE_SCANNER_UNAVAILABLE, MlKitException.CODE_SCANNER_UNAVAILABLE)).mo11567a(qe5.m25623x0()).mo11553K0(this.$this_apply.f20837f);
            return;
        }
