...
public final class SwapMigrationFragment$initDestination$3 extends Lambda implements rc2<BigDecimal, r37> {
    public final /* synthetic */ SwapMigrationFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapMigrationFragment$initDestination$3(SwapMigrationFragment swapMigrationFragment) {
        super(1);
    ...
    public final void invoke(BigDecimal bigDecimal) {
        ...
        AppCompatTextView appCompatTextView = i0.f28836i;
        cb6 cb6 = cb6.f21669a;
