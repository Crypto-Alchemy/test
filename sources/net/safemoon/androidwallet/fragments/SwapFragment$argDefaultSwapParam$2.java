...
public final class SwapFragment$argDefaultSwapParam$2 extends Lambda implements pc2<UserTokenItemDisplayModel> {
    public final /* synthetic */ SwapFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapFragment$argDefaultSwapParam$2(SwapFragment swapFragment) {
        super(0);
