...
public final class WalletConnectFragment$onSelectNetwork$1 extends Lambda implements rc2<Intent, r37> {
    ...
    public final void invoke(Intent intent) {
        if (intent != null) {
            ...
            if (serializableExtra instanceof TokenType) {
                walletConnectFragment.mo58165R().mo61794f().postValue(serializableExtra);
            }
        }
    }
}
