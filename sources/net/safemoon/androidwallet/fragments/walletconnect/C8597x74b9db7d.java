...
/* renamed from: net.safemoon.androidwallet.fragments.walletconnect.WalletConnectFragment$special$$inlined$activityViewModels$default$7 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8597x74b9db7d extends Lambda implements pc2<gd7> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8597x74b9db7d(Fragment fragment) {
        super(0);
