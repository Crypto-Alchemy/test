...
/* renamed from: net.safemoon.androidwallet.fragments.walletconnect.WalletConnectFragment$special$$inlined$activityViewModels$default$9 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8599x74b9db7f extends Lambda implements pc2<C0729l.C0733b> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8599x74b9db7f(Fragment fragment) {
        super(0);
