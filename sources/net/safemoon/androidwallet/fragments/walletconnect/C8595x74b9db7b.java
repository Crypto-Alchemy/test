...
/* renamed from: net.safemoon.androidwallet.fragments.walletconnect.WalletConnectFragment$special$$inlined$activityViewModels$default$5 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8595x74b9db7b extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8595x74b9db7b(pc2 pc2, Fragment fragment) {
        super(0);
