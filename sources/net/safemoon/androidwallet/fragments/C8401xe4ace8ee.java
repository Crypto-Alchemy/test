...
/* renamed from: net.safemoon.androidwallet.fragments.MyTokensListFragment$special$$inlined$activityViewModels$default$5 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8401xe4ace8ee extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8401xe4ace8ee(pc2 pc2, Fragment fragment) {
        super(0);
