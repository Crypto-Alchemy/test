...
/* renamed from: net.safemoon.androidwallet.fragments.AddCustomReflectionContractFragment$special$$inlined$viewModels$default$4 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8352x7d28c709 extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ ef3 $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8352x7d28c709(pc2 pc2, ef3 ef3) {
        super(0);
