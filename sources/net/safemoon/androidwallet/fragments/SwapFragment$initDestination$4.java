...
public final class SwapFragment$initDestination$4 extends Lambda implements rc2<Double, r37> {
    public final /* synthetic */ SwapFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapFragment$initDestination$4(SwapFragment swapFragment) {
        super(1);
    ...
    public final void invoke(Double d) {
        ...
        if (vx2.m53585a(d, Utils.DOUBLE_EPSILON)) {
            v0.f28843p.setVisibility(4);
        } else {
            v0.f28843p.setVisibility(0);
        }
        MaterialTextView materialTextView = v0.f28843p;
