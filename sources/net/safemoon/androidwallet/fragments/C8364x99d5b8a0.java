...
/* renamed from: net.safemoon.androidwallet.fragments.AllTokensListFragment$special$$inlined$activityViewModels$default$2 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8364x99d5b8a0 extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8364x99d5b8a0(pc2 pc2, Fragment fragment) {
        super(0);
