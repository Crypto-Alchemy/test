...
public final class TransferHistoryFragment$onViewCreated$1$1$2$1 extends Lambda implements rc2<DialogInterface, r37> {
    ...
    public final void invoke(DialogInterface dialogInterface) {
        ...
        this.this$0.mo57893i0(PaymentMethod.MOONPAY, ap2.m55613a(this.$it.getSymbolWithType()).mo67355c(), TokenType.Companion.mo57099b(this.$it.getChainId()).getCoinType().getValue(), true);
    }
}
