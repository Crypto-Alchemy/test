...
public final class EditContactFragment$save$1$3 extends Lambda implements rc2<DialogInterface, r37> {
    public static final EditContactFragment$save$1$3 INSTANCE = new EditContactFragment$save$1$3();

    public EditContactFragment$save$1$3() {
        super(1);
    }
