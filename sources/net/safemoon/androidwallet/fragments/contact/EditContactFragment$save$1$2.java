...
public final class EditContactFragment$save$1$2 extends Lambda implements rc2<DialogInterface, r37> {
    public static final EditContactFragment$save$1$2 INSTANCE = new EditContactFragment$save$1$2();

    public EditContactFragment$save$1$2() {
        super(1);
    }
