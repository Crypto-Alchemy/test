...
public final class AddContactFragment$save$1$2 extends Lambda implements rc2<DialogInterface, r37> {
    public static final AddContactFragment$save$1$2 INSTANCE = new AddContactFragment$save$1$2();

    public AddContactFragment$save$1$2() {
        super(1);
    }
