...
public final class AddContactFragment$save$1$3 extends Lambda implements rc2<DialogInterface, r37> {
    public static final AddContactFragment$save$1$3 INSTANCE = new AddContactFragment$save$1$3();

    public AddContactFragment$save$1$3() {
        super(1);
    }
