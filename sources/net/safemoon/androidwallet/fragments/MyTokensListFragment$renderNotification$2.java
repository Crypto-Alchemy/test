...
public final class MyTokensListFragment$renderNotification$2 extends Lambda implements rc2<NotificationHistory, r37> {
    public final /* synthetic */ MyTokensListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public MyTokensListFragment$renderNotification$2(MyTokensListFragment myTokensListFragment) {
        super(1);
    ...
    public final void invoke(NotificationHistory notificationHistory) {
        ...
        if (notificationHistory != null && (data = notificationHistory.getData()) != null && (result = data.getResult()) != null) {
            MyTokensListFragment myTokensListFragment = this.this$0;
            ...
            bb2 D = myTokensListFragment.f41980k;
            if (D == null) {
                vx2.m53605u("binding");
                D = null;
            }
            if (D != null && (goVar = D.f21228k) != null && (materialTextView = goVar.f29307k) != null) {
                if (size <= 0) {
                    z = false;
                }
