...
public final class SwapFragment$initDestination$3 extends Lambda implements rc2<BigDecimal, r37> {
    public final /* synthetic */ SwapFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapFragment$initDestination$3(SwapFragment swapFragment) {
        super(1);
    ...
    public final void invoke(BigDecimal bigDecimal) {
        ...
        if (bigDecimal != null) {
            AppCompatTextView appCompatTextView = v0.f28836i;
        ...
        v0.f28836i.setText(swapFragment.getString(R.string.loading));
    }
}
