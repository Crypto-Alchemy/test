...
public final class AllTokensListFragment$onCreateView$2 extends Lambda implements rc2<NotificationHistory, r37> {
    public final /* synthetic */ AllTokensListFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AllTokensListFragment$onCreateView$2(AllTokensListFragment allTokensListFragment) {
        super(1);
    ...
    public final void invoke(NotificationHistory notificationHistory) {
        ...
        if (notificationHistory != null && (data = notificationHistory.getData()) != null && (result = data.getResult()) != null) {
            ...
            d92 w = allTokensListFragment.f41887M;
            if (w != null && (goVar = w.f28062l) != null && (materialTextView = goVar.f29307k) != null) {
                if (size <= 0) {
                    z = false;
                }
