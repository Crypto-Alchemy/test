...
public final class TransferHistoryFragment$initRecyclerView$4 extends Lambda implements rc2<List<? extends IToken>, r37> {
    public final /* synthetic */ TransferHistoryFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TransferHistoryFragment$initRecyclerView$4(TransferHistoryFragment transferHistoryFragment) {
        super(1);
    ...
    public final void invoke(List<? extends IToken> list) {
        if (list != null) {
            this.this$0.mo57898n0().mo57013j(list);
        }
    }
}
