...
public final class AddCustomContractFragment$onViewCreated$2$5 extends Lambda implements rc2<TransactionHistoryModel, r37> {
    public final /* synthetic */ a92 $this_apply;
    public final /* synthetic */ AddCustomContractFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddCustomContractFragment$onViewCreated$2$5(AddCustomContractFragment addCustomContractFragment, a92 a92) {
        super(1);
    ...
    public final void invoke(TransactionHistoryModel transactionHistoryModel) {
        if (transactionHistoryModel != null) {
            Result r = this.this$0.mo57382E().mo61159r();
            if (r != null) {
                ...
                if (editText4 != null) {
                    editText4.setText(r.tokenName);
                }
                EditText editText5 = a92.f20842k.getEditText();
                if (editText5 != null) {
                    editText5.setText(r.tokenSymbol);
                }
                EditText editText6 = a92.f20840i.getEditText();
                if (editText6 != null) {
                    editText6.setText(String.valueOf(r.tokenDecimal));
                    return;
                }
                return;
            }
