...
public final class SwapMigrationFragment$initDestination$4 extends Lambda implements rc2<Double, r37> {
    public final /* synthetic */ SwapMigrationFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapMigrationFragment$initDestination$4(SwapMigrationFragment swapMigrationFragment) {
        super(1);
    ...
    public final void invoke(Double d) {
        ...
        if (vx2.m53585a(d, Utils.DOUBLE_EPSILON)) {
            i0.f28843p.setVisibility(4);
        } else {
            i0.f28843p.setVisibility(0);
        }
        MaterialTextView materialTextView = i0.f28843p;
