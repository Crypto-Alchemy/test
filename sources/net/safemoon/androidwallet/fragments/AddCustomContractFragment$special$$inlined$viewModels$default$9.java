...
public final class AddCustomContractFragment$special$$inlined$viewModels$default$9 extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ ef3 $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AddCustomContractFragment$special$$inlined$viewModels$default$9(pc2 pc2, ef3 ef3) {
        super(0);
