...
public final class NotificationFragment$initPriceAlert$1$1$6$1$1$1 extends Lambda implements rc2<DialogInterface, r37> {
    ...
    public final void invoke(DialogInterface dialogInterface) {
        ...
        SettingNotificationViewModel E = this.this$0.mo57518M();
        PAToken pAToken = this.$it;
        vx2.m53590f(pAToken, "it");
        E.mo61413q(pAToken);
    }
}
