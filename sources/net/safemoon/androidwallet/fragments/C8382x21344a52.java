...
/* renamed from: net.safemoon.androidwallet.fragments.ChainNetworkReflectionFragment$special$$inlined$viewModels$default$4 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8382x21344a52 extends Lambda implements pc2<C0729l.C0733b> {
    public final /* synthetic */ ef3 $owner$delegate;
    public final /* synthetic */ Fragment $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8382x21344a52(Fragment fragment, ef3 ef3) {
        super(0);
