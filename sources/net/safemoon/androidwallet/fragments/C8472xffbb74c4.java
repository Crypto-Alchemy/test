...
/* renamed from: net.safemoon.androidwallet.fragments.SwapMigrationFragment$special$$inlined$activityViewModels$default$4 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8472xffbb74c4 extends Lambda implements pc2<gd7> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8472xffbb74c4(Fragment fragment) {
        super(0);
