...
/* renamed from: net.safemoon.androidwallet.fragments.TransferDetailsFragmentStatus$special$$inlined$activityViewModels$default$2 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8492x9633cf70 extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8492x9633cf70(pc2 pc2, Fragment fragment) {
        super(0);
