...
public final class SwitchWalletFragment$updateAllWalletsLinkedStatus$1 extends Lambda implements rc2<List<? extends Wallet>, r37> {
    ...
    public final void invoke(List<Wallet> list) {
        ...
        for (Wallet F : list) {
            this.this$0.mo57821n0().mo61247F(F, this.$linkedState, C84821.INSTANCE);
        }
    }
}
