...
/* renamed from: net.safemoon.androidwallet.fragments.TransferDetailsFragmentStatus$special$$inlined$activityViewModels$default$1 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8491x9633cf6f extends Lambda implements pc2<gd7> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8491x9633cf6f(Fragment fragment) {
        super(0);
