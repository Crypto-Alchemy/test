...
/* renamed from: net.safemoon.androidwallet.fragments.TransferHistoryFragment$special$$inlined$activityViewModels$default$1 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8499xc1d72cef extends Lambda implements pc2<gd7> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8499xc1d72cef(Fragment fragment) {
        super(0);
