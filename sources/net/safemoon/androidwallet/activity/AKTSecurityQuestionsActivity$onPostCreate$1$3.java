...
public final class AKTSecurityQuestionsActivity$onPostCreate$1$3 extends Lambda implements rc2<String, r37> {
    public final /* synthetic */ C6472s9 $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AKTSecurityQuestionsActivity$onPostCreate$1$3(C6472s9 s9Var) {
        super(1);
    ...
    public final void invoke(String str) {
        ...
        if (strArr.length > 1) {
            this.$this_apply.f33786x.setText(strArr[1]);
        }
    }
}
