...
public final class StartWalletActivity$isImportNewWalletOnRegister$2 extends Lambda implements pc2<Boolean> {
    ...
    public final Boolean invoke() {
        ...
        boolean z = false;
        if (intent != null) {
            z = intent.getBooleanExtra("KEY_IS_IMPORT_NEW_WALLET", false);
        }
