...
public final class AnchorCurrencyConverter$2$5 extends Lambda implements rc2<RoomFiat, Boolean> {
    ...
    public AnchorCurrencyConverter$2$5(AnchorCurrencyConverter anchorCurrencyConverter, AutofitEdittext autofitEdittext, ve1 ve1, AutofitEdittext autofitEdittext2) {
        super(1);
    ...
    public final Boolean invoke(RoomFiat roomFiat) {
        if (roomFiat != null) {
            ...
            if (!vx2.m53586b(fiat.getSymbol(), anchorCurrencyConverter.f41689f.getSymbol())) {
                anchorCurrencyConverter.f41688e = fiat;
                if (autofitEdittext.hasFocus()) {
                    CurrencyConverterLayout currencyConverterLayout = ve1.f34929c;
                    vx2.m53590f(currencyConverterLayout, "convertFrom");
                    CurrencyConverterLayout currencyConverterLayout2 = ve1.f34930d;
                    vx2.m53590f(currencyConverterLayout2, "convertTo");
                    anchorCurrencyConverter.mo57129r(currencyConverterLayout, currencyConverterLayout2, autofitEdittext.getText(), true);
                } else {
                    CurrencyConverterLayout currencyConverterLayout3 = ve1.f34930d;
                    vx2.m53590f(currencyConverterLayout3, "convertTo");
                    CurrencyConverterLayout currencyConverterLayout4 = ve1.f34929c;
                    vx2.m53590f(currencyConverterLayout4, "convertFrom");
                    anchorCurrencyConverter.mo57129r(currencyConverterLayout3, currencyConverterLayout4, autofitEdittext2.getText(), false);
                }
                ve1.f34930d.mo62085o(new RoomFiat(fiat));
                return Boolean.TRUE;
            }
        }
