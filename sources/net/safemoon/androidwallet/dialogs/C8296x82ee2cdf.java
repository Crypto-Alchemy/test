...
/* renamed from: net.safemoon.androidwallet.dialogs.Google2FAVerfiedAuthFragment$special$$inlined$activityViewModels$default$1 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8296x82ee2cdf extends Lambda implements pc2<gd7> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8296x82ee2cdf(Fragment fragment) {
        super(0);
