...
/* renamed from: net.safemoon.androidwallet.dialogs.WalletConnectInterfaceV2Fragment$special$$inlined$viewModels$default$8 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8336x7e17ab42 extends Lambda implements pc2<C0729l.C0733b> {
    public final /* synthetic */ ef3 $owner$delegate;
    public final /* synthetic */ Fragment $this_viewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8336x7e17ab42(Fragment fragment, ef3 ef3) {
        super(0);
