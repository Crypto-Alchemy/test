...
public final class CryptoPriceAlertFragment$onViewCreated$1$1$4$3 extends Lambda implements rc2<Editable, r37> {
    public final /* synthetic */ et2 $this_with;
    public final /* synthetic */ CryptoPriceAlertFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CryptoPriceAlertFragment$onViewCreated$1$1$4$3(CryptoPriceAlertFragment cryptoPriceAlertFragment, et2 et2) {
        super(1);
    ...
    public final void invoke(Editable editable) {
        ...
        if (value != null) {
            ...
            value.setIncreasePercentString(str);
