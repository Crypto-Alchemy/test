...
public final class Google2FABackup$special$$inlined$activityViewModels$default$1 extends Lambda implements pc2<gd7> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Google2FABackup$special$$inlined$activityViewModels$default$1(Fragment fragment) {
        super(0);
