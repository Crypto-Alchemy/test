...
public final class CryptoPriceAlertFragment$onViewCreated$1$9 extends Lambda implements rc2<LoadingState, r37> {
    public final /* synthetic */ CryptoPriceAlertFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CryptoPriceAlertFragment$onViewCreated$1$9(CryptoPriceAlertFragment cryptoPriceAlertFragment) {
        super(1);
    ...
    public final void invoke(LoadingState loadingState) {
        if (loadingState == LoadingState.Loading) {
            ProgressLoading M = this.this$0.mo57193R();
            FragmentManager parentFragmentManager = this.this$0.getParentFragmentManager();
            vx2.m53590f(parentFragmentManager, "parentFragmentManager");
            M.mo57295D(parentFragmentManager);
            return;
        }
        this.this$0.mo57193R().mo22266k();
    }
}
