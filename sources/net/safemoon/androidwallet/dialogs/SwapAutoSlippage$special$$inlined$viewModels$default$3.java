...
public final class SwapAutoSlippage$special$$inlined$viewModels$default$3 extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ ef3 $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SwapAutoSlippage$special$$inlined$viewModels$default$3(pc2 pc2, ef3 ef3) {
        super(0);
