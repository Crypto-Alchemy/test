...
/* renamed from: net.safemoon.androidwallet.dialogs.WalletConnectInterfaceV2Fragment$special$$inlined$viewModels$default$3 */
/* compiled from: FragmentViewModelLazy.kt */
public final class C8331x7e17ab3d extends Lambda implements pc2<zv0> {
    public final /* synthetic */ pc2 $extrasProducer;
    public final /* synthetic */ ef3 $owner$delegate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C8331x7e17ab3d(pc2 pc2, ef3 ef3) {
        super(0);
