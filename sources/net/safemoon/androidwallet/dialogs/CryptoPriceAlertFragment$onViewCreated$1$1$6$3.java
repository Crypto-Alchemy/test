...
public final class CryptoPriceAlertFragment$onViewCreated$1$1$6$3 extends Lambda implements rc2<Editable, r37> {
    public final /* synthetic */ CryptoPriceAlertFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CryptoPriceAlertFragment$onViewCreated$1$1$6$3(CryptoPriceAlertFragment cryptoPriceAlertFragment) {
        super(1);
    ...
    public final void invoke(Editable editable) {
        ...
        if (value != null) {
            ...
            value.setPriceReachesString(str);
