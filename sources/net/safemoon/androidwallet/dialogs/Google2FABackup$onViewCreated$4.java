...
public final class Google2FABackup$onViewCreated$4 extends Lambda implements rc2<Bitmap, r37> {
    public final /* synthetic */ Google2FABackup this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public Google2FABackup$onViewCreated$4(Google2FABackup google2FABackup) {
        super(1);
    ...
    public final void invoke(Bitmap bitmap) {
        ...
        D.f34486e.setImageBitmap(bitmap);
    }
}
