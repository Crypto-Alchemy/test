...
public final class AnchorCurrencyConverter$2$7 extends Lambda implements pc2<r37> {
    public final /* synthetic */ ve1 $this_with;
    public final /* synthetic */ AnchorCurrencyConverter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnchorCurrencyConverter$2$7(AnchorCurrencyConverter anchorCurrencyConverter, ve1 ve1) {
        super(0);
    ...
    public final void invoke() {
        this.this$0.f41692i = false;
        this.$this_with.f34928b.showNext();
        AnchorCurrencyConverter anchorCurrencyConverter = this.this$0;
        AnchorCurrencyConverter.m65902t(anchorCurrencyConverter, new RoomFiat(anchorCurrencyConverter.f41688e), (List) null, 2, (Object) null);
