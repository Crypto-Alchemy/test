...
public final class CryptoPriceAlertFragment$onViewCreated$1$1$4$1 extends Lambda implements rc2<Boolean, r37> {
    public final /* synthetic */ CryptoPriceAlertFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CryptoPriceAlertFragment$onViewCreated$1$1$4$1(CryptoPriceAlertFragment cryptoPriceAlertFragment) {
        super(1);
    ...
    public final void invoke(boolean z) {
        ...
        if (value != null) {
            ...
            value.setEnableIncreasePercent(z);
