...
public final class GraphFragment$special$$inlined$activityViewModels$default$4 extends Lambda implements pc2<gd7> {
    public final /* synthetic */ Fragment $this_activityViewModels;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public GraphFragment$special$$inlined$activityViewModels$default$4(Fragment fragment) {
        super(0);
