...
public class ArticleVote {
    ...
    public boolean equals(Object obj) {
        ...
        Long l = this.f46819id;
        if (l == null ? articleVote.f46819id != null : !l.equals(articleVote.f46819id)) {
            return false;
        }
        String str = this.url;
    ...
    public int hashCode() {
        return Arrays.hashCode(new Object[]{this.f46819id, this.url, this.userId, this.value, this.itemId, this.itemType, this.createdAt, this.updatedAt});
    }
}
