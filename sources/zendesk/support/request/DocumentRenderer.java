...
class DocumentRenderer {
    ...
    public static /* synthetic */ class C101051 {
        ...
        static {
            ...
            L_0x00c0:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: zendesk.support.request.DocumentRenderer.C101051.<clinit>():void");
        }
    }
    ...
    public interface Style {
        ...
        public static class C10106Br implements Style {
            public Spannable applyStyle(List<CharSequence> list, Map<String, String> map) {
                return SpannableHelper.foldStrings(Arrays.asList(new CharSequence[]{SpannableHelper.foldStrings(list), kb6.f30798b}));
            }
        }
        ...
        public static class Factory {
            ...
            public Style getStyleForType(Node.Type type) {
                switch (C101051.$SwitchMap$zendesk$support$request$DocumentRenderer$Node$Type[type.ordinal()]) {
                    case 1:
                        return new Bold();
                    case 2:
                    case 3:
                    ...
                    case 15:
                        return new C10107Li();
                    case 16:
                        return new QuotationSpan(UiUtils.themeAttributeToColor(16842906, this.context, y15.zs_fallback_text_color));
                    default:
                        return new Unknown();
                }
            }
        ...
        public static class Header extends Bold {
            public Spannable applyStyle(List<CharSequence> list, Map<String, String> map) {
                return SpannableHelper.foldStrings(Arrays.asList(new CharSequence[]{super.applyStyle(list, map), kb6.f30798b}));
            }
        }
        ...
        public static class Image implements Style {
            ...
            public Spannable applyStyle(List<CharSequence> list, Map<String, String> map) {
                ...
                String queryParameter = HttpUrl.parse(str).queryParameter(PublicResolver.FUNC_NAME);
                String string = this.resources.getString(o45.request_message_inline_image_title_format);
        ...
        public static class C10107Li implements Style {
            ...
            public Spannable applyStyle(List<CharSequence> list, Map<String, String> map) {
                ...
                for (CharSequence next : list) {
                    ...
                    spannableStringBuilder.append(kb6.f30798b);
                }
    ...
    public static class ZendeskUrlSpan extends URLSpan {
        ...
        public ZendeskUrlSpan(String str, ActionHandlerRegistry actionHandlerRegistry, ro0 ro0, Configuration configuration2) {
            super(str);
            this.registry = actionHandlerRegistry;
            this.configHelper = ro0;
        ...
        public void onClick(View view) {
            ...
            this.configHelper.mo67438d(hashMap, this.configuration);
            handlerByAction.handle(hashMap, view.getContext());
        }
    }

    public DocumentRenderer(Context context, ActionHandlerRegistry actionHandlerRegistry2, ro0 ro0, Configuration configuration2) {
    ...
    public Spannable reduce(Node node) {
        ...
        if (type == Node.Type.Ol || type == Node.Type.Ul) {
            ...
            for (Node node2 : node.children) {
                node2.attributes.put(Style.C10107Li.PARENT_ATTRIBUTE, type.name());
                i++;
                node2.attributes.put(Style.C10107Li.INDEX_ATTRIBUTE, String.valueOf(i));
            }
        }
    ...
    public DocumentRenderer(Style.Factory factory, ActionHandlerRegistry actionHandlerRegistry2, ro0 ro0, Configuration configuration2) {
    ...
    public static class HtmlParser {
        ...
        public HtmlParser() {
            ...
            try {
                ...
                Logger.m43087k(RequestActivity.LOG_TAG, "Unable to parse rich text. Error: '%s' | '%s'", e.getLocalizedMessage());
            } finally {
        ...
        public RichRenderingDocument parse(String str, String str2) {
            try {
                ...
                Logger.m43087k(RequestActivity.LOG_TAG, "Unable to parse rich text. Error: '%s' | '%s'", e.getLocalizedMessage(), str);
            }
