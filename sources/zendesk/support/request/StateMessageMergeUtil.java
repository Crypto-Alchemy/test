...
class StateMessageMergeUtil {
    ...
    public static List<StateMessage> mergeMessages(List<StateMessage> list, List<StateMessage> list2) {
        jl4<List<StateMessage>, List<StateMessage>> mergeRemoteMessagesById = mergeRemoteMessagesById(list, list2);
        if (kj0.m47116g((Collection) mergeRemoteMessagesById.f13689b)) {
            return (List) mergeRemoteMessagesById.f13688a;
        }
        return mergeRemoteMessagesBySortOrder((List) mergeRemoteMessagesById.f13688a, (List) mergeRemoteMessagesById.f13689b);
    }

    @SuppressLint({"UseSparseArrays"})
    private static jl4<List<StateMessage>, List<StateMessage>> mergeRemoteMessagesById(List<StateMessage> list, List<StateMessage> list2) {
        ...
        return jl4.m20216a(arrayList, new ArrayList(linkedHashMap.values()));
    }
    ...
    public static StateMessage synchronizeAttachmentOrder(StateMessage stateMessage, StateMessage stateMessage2) {
        if (kj0.m47116g(stateMessage2.getAttachments())) {
