...
class ReducerError extends Reducer<StateError> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x00b3, code lost:
        return new zendesk.support.request.StateError(zendesk.support.request.StateError.ErrorType.InputFormSubmission, ((zendesk.support.request.ActionFactory.ErrorAction) r5).getErrorResponse().mo43366h());
     */
    ...
    public zendesk.support.request.StateError reduce(zendesk.support.request.StateError r4, zendesk.support.suas.Action<?> r5) {
        /*
            ...
            hr1 r0 = r0.getErrorResponse()
            boolean r1 = r0.mo43367i()
            ...
            java.lang.String r0 = r0.mo43366h()
            r4.<init>(r5, r0)
            return r4
        L_0x0025:
        ...
        L_0x007a:
            ...
            java.lang.String r4 = r4.mo43366h()
            r5.<init>(r0, r4)
            return r5
        L_0x0090:
