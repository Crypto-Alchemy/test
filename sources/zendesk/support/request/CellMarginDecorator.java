...
class CellMarginDecorator extends RecyclerView.C1247n {
    ...
    public CellMarginDecorator(ComponentRequestAdapter componentRequestAdapter, Context context) {
        ...
        this.verticalMargin = context.getResources().getDimensionPixelOffset(m25.zs_request_message_margin_vertical);
        this.groupVerticalMargin = context.getResources().getDimensionPixelOffset(m25.zs_request_message_group_margin_vertical);
    }

    /* JADX WARNING: Removed duplicated region for block: B:33:0x0074  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void getItemOffsets(android.graphics.Rect r10, android.view.View r11, androidx.recyclerview.widget.RecyclerView r12, androidx.recyclerview.widget.RecyclerView.C1260x r13) {
        /*
            r9 = this;
            int r11 = r12.mo9041f0(r11)
            r12 = -1
        ...
        L_0x0063:
            ...
            com.zendesk.logger.Logger.m43078b(r12, r0, r13)
        L_0x0072:
