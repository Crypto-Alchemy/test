...
public class RequestModule {
    ...
    public static ActionFactory providesActionFactory(RequestProvider requestProvider, SupportSettingsProvider supportSettingsProvider, UploadProvider uploadProvider, C9800a aVar, SupportUiStorage supportUiStorage, ExecutorService executorService, Executor executor, AuthenticationProvider authenticationProvider, SupportBlipsProvider supportBlipsProvider) {
        return new ActionFactory(requestProvider, uploadProvider, supportSettingsProvider, aVar, supportUiStorage, executorService, "5.0.9", authenticationProvider, Zendesk.INSTANCE, supportBlipsProvider, executor);
    }
    ...
    public static AttachmentDownloaderComponent.AttachmentDownloader providesAttachmentDownloader(C9800a aVar, AttachmentDownloadService attachmentDownloadService) {
    ...
    public CellFactory providesMessageFactory(Context context, Picasso picasso, ActionFactory actionFactory, Dispatcher dispatcher, ActionHandlerRegistry actionHandlerRegistry, ro0 ro0) {
        return new CellFactory(context.getApplicationContext(), picasso, actionFactory, dispatcher, actionHandlerRegistry, ro0, this.configuration);
    }
}
