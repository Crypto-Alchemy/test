...
class ActionFactory {
    ...
    private final Zendesk f46908zendesk;

    public static class ErrorAction<E> extends Action<E> {
        private final hr1 errorResponse;

        public ErrorAction(String str, hr1 hr1) {
            this(str, hr1, (Object) null);
        }

        public hr1 getErrorResponse() {
            return this.errorResponse;
        }

        public ErrorAction(String str, hr1 hr1, E e) {
            super(str, e);
            this.errorResponse = hr1;
        }
    }

    public ActionFactory(RequestProvider requestProvider2, UploadProvider uploadProvider2, SupportSettingsProvider supportSettingsProvider, C9800a aVar, SupportUiStorage supportUiStorage2, Executor executor, String str, AuthenticationProvider authenticationProvider, Zendesk zendesk2, SupportBlipsProvider supportBlipsProvider2, Executor executor2) {
    ...
    public Action attachmentDownloaded(StateRequestAttachment stateRequestAttachment, MediaResult mediaResult) {
        return new Action(ATTACHMENT_DOWNLOADED, jl4.m20216a(stateRequestAttachment, mediaResult));
    }
    ...
    public Action createCommentError(hr1 hr1, StateMessage stateMessage) {
        return new ErrorAction(CREATE_COMMENT_ERROR, hr1, stateMessage);
    }
    ...
    public Action createRequestError(hr1 hr1, StateMessage stateMessage) {
        return new ErrorAction(CREATE_REQUEST_ERROR, hr1, stateMessage);
    }
    ...
    public Action loadCommentsError(boolean z, hr1 hr1) {
        if (z) {
            return new ErrorAction(LOAD_COMMENTS_INITIAL_ERROR, hr1);
        }
        return new ErrorAction(LOAD_COMMENTS_UPDATE_ERROR, hr1);
    }
    ...
    public Action loadCommentsSuccess(boolean z, CommentsResponse commentsResponse, Map<Long, MediaResult> map) {
        jl4 jl4 = new jl4(commentsResponse, map);
        if (z) {
            return new Action(LOAD_COMMENTS_INITIAL_SUCCESS, jl4);
        }
        return new Action(LOAD_COMMENTS_UPDATE_SUCCESS, jl4);
    }
    ...
    public Action loadRequestError(hr1 hr1) {
        return new ErrorAction(LOAD_REQUEST_ERROR, hr1);
    }
    ...
    public Action loadSettingsError(hr1 hr1) {
        return new ErrorAction(LOAD_SETTINGS_ERROR, hr1);
    }
    ...
    public Action updateNameEmailAsync(String str, String str2) {
        return AsyncMiddleware.createAction(new ActionUpdateNameEmail(str, str2, this.authProvider, this.f46908zendesk));
    }
}
