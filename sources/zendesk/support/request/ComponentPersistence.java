...
class ComponentPersistence implements Listener<RequestPersistenceModel> {
    ...
    public static class RequestIdMapper {
        ...
        public boolean hasLocalId(String str) {
            if (!this.remoteToLocal.containsKey(str) || !kb6.m46949b(this.remoteToLocal.get(str))) {
                return false;
            }
            return true;
        }
        ...
        public boolean hasRemoteId(String str) {
            if (!this.localToRemote.containsKey(str) || !kb6.m46949b(this.localToRemote.get(str))) {
                return false;
            }
            return true;
        }
    ...
    public static class RequestPersistenceModel {
        ...
        public RequestPersistenceModel(String str, Date date2, String str2, StateConversation stateConversation, boolean z) {
            this.requestId = str;
            this.date = date2;
            this.version = str2;
    ...
    private void persistConversation(RequestPersistenceModel requestPersistenceModel) {
        ...
        boolean b = kb6.m46949b(requestPersistenceModel.getLocalRequestId());
    ...
    private void persistRequestId(final RequestPersistenceModel requestPersistenceModel) {
        ...
        if (!this.isMappingComplete.get()) {
            ...
            if (kb6.m46949b(remoteId) && kb6.m46949b(localId)) {
                z2 = true;
            }
            if (z2 || z) {
                if (z2) {
        ...
        } else if (kj0.m47116g(requestPersistenceModel.getConversation().getMessages())) {
            this.executor.execute(new Runnable() {
                public void run() {
                    RequestIdMapper requestIdMapper = (RequestIdMapper) ComponentPersistence.this.supportUiStorage.read(SupportUiStorage.REQUEST_MAPPER, RequestIdMapper.class);
