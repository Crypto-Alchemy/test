...
public class HelpCenterSearch implements Serializable, Cloneable {
    ...
    public static class Builder {
        ...
        public HelpCenterSearch build() {
            ...
            String unused3 = helpCenterSearch.include = kb6.m46954g(this.include);
            String unused4 = helpCenterSearch.labelNames = kb6.m46954g(this.labelNames);
        ...
        public Builder withCategoryIds(List<Long> list) {
            this.categoryIds = kb6.m46955h(kj0.m47112c(list));
            return this;
        }
        ...
        public Builder withSectionIds(List<Long> list) {
            this.sectionIds = kb6.m46955h(kj0.m47112c(list));
            return this;
        }
    }
