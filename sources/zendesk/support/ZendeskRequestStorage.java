...
class ZendeskRequestStorage implements RequestStorage {
    ...
    public boolean isRequestDataExpired() {
        ...
        if (!z) {
            Logger.m43078b(LOG_TAG, "Returning Read Requests from cache. Cached Read Requests will expire in %s", HOURS_MINUTES_FORMAT.format(Long.valueOf(j)));
        }
        return z;
    }
