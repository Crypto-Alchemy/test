...
class HelpCenterPresenter implements HelpCenterMvp$Presenter, NetworkAware {
    ...
    public class ViewSafeRetryZendeskCallback extends op7<List<SearchArticle>> {
        /* access modifiers changed from: private */
        public String query;
        ...
        public void onError(final hr1 hr1) {
            ...
            HelpCenterPresenter.this.internalRetryActions.add(new RetryAction() {
                public void onRetry() {
                    ViewSafeRetryZendeskCallback.this.onError(hr1);
                }
            });
        }
    ...
    public void init(HelpCenterConfiguration helpCenterConfiguration, List<Engine> list) {
        ...
        this.model.getSettings(new op7<HelpCenterSettings>() {
            public void onError(hr1 hr1) {
                Logger.m43081e(HelpCenterActivity.LOG_TAG, "Failed to get mobile settings. Cannot determine start screen.", new Object[0]);
                Logger.m43079c(HelpCenterActivity.LOG_TAG, hr1);
                if (HelpCenterPresenter.this.view != null) {
                    HelpCenterPresenter.this.view.hideLoadingState();
            ...
            public void onSuccess(HelpCenterSettings helpCenterSettings) {
                ...
                if (helpCenterSettings.isEnabled()) {
                    Logger.m43078b(HelpCenterActivity.LOG_TAG, "Help center is enabled. starting with Help Center", new Object[0]);
                    if (HelpCenterPresenter.this.view != null) {
                    ...
                    if (HelpCenterPresenter.this.shouldShowContactUsButton()) {
                        Logger.m43078b(HelpCenterActivity.LOG_TAG, "Saved instance states that we should show the contact FAB", new Object[0]);
                        if (HelpCenterPresenter.this.view != null) {
                            HelpCenterPresenter.this.view.showContactUsButton();
                        } else {
                            HelpCenterPresenter.this.internalRetryActions.add(new RetryAction() {
                    ...
                    Logger.m43078b(HelpCenterActivity.LOG_TAG, "Help center is disabled", new Object[0]);
                    if (HelpCenterPresenter.this.actionHandlerRegistry.handlerByAction("action_conversation_list") != null) {
                        Logger.m43078b(HelpCenterActivity.LOG_TAG, "Starting with conversations", new Object[0]);
                        if (HelpCenterPresenter.this.view != null) {
                        ...
                        Logger.m43078b(HelpCenterActivity.LOG_TAG, "Starting with contact", new Object[0]);
                        if (HelpCenterPresenter.this.view != null) {
                        ...
                        Logger.m43078b(HelpCenterActivity.LOG_TAG, "Support SDK is not present, nothing to fall back to. Closing Activity.", new Object[0]);
                        if (HelpCenterPresenter.this.view != null) {
                            HelpCenterPresenter.this.view.exitActivity();
                        } else {
                            HelpCenterPresenter.this.internalRetryActions.add(new RetryAction() {
    ...
    public void onNetworkAvailable() {
        Logger.m43078b(HelpCenterActivity.LOG_TAG, "Network is available.", new Object[0]);
        if (!this.networkPreviouslyUnavailable) {
            Logger.m43078b(HelpCenterActivity.LOG_TAG, "Network was not previously unavailable, no need to dismiss Snackbar", new Object[0]);
            return;
        }
    ...
    public void onNetworkUnavailable() {
        Logger.m43078b(HelpCenterActivity.LOG_TAG, "Network is unavailable.", new Object[0]);
