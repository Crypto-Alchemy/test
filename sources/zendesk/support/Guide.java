...
public enum Guide {
    ...
    public void init(Zendesk zendesk2) {
        ...
        Logger.m43081e(LOG_TAG, "Cannot use Guide SDK without initializing Zendesk. Call Zendesk.INSTANCE.init(...)", new Object[0]);
    }
    ...
    public HelpCenterProvider provider() {
        ...
        Logger.m43081e(LOG_TAG, "Cannot get HelpCenterProvider before SDK has been initialized. init() must be called before provider().", new Object[0]);
        return null;
    }
