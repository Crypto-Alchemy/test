...
class ZendeskNetworkModule {
    ...
    public static og5 provideCoreRetrofit(ApplicationConfiguration applicationConfiguration, Gson gson, OkHttpClient okHttpClient) {
        return new og5.C9026b().mo62921b(applicationConfiguration.getZendeskUrl()).mo62920a(yj2.m74454g(gson)).mo62925f(okHttpClient).mo62923d();
    }
    ...
    public static og5 providePushProviderRetrofit(ApplicationConfiguration applicationConfiguration, Gson gson, OkHttpClient okHttpClient, ZendeskAuthHeaderInterceptor zendeskAuthHeaderInterceptor) {
        return new og5.C9026b().mo62921b(applicationConfiguration.getZendeskUrl()).mo62920a(yj2.m74454g(gson)).mo62925f(okHttpClient.newBuilder().addInterceptor(zendeskAuthHeaderInterceptor).build()).mo62923d();
    }
    ...
    public RestServiceProvider provideRestServiceProvider(og5 og5, OkHttpClient okHttpClient, OkHttpClient okHttpClient2, OkHttpClient okHttpClient3) {
        return new ZendeskRestServiceProvider(og5, okHttpClient, okHttpClient2, okHttpClient3);
    }
