...
class CachingInterceptor implements Interceptor {
    ...
    private Response createResponse(int i, Request request, ResponseBody responseBody) {
        ...
        if (responseBody != null) {
            ...
            Logger.m43087k(LOG_TAG, "Response body is null", new Object[0]);
        }
    ...
    private Response loadData(String str, Interceptor.Chain chain) throws IOException {
        ...
        if (responseBody2 == null) {
            Logger.m43078b(LOG_TAG, "Response not cached, loading it from the network. | %s", str);
            ...
            if (proceed.isSuccessful()) {
                ...
                Logger.m43078b(LOG_TAG, "Unable to load data from network. | %s", str);
                responseBody = proceed.body();
            }
            responseBody2 = responseBody;
            i = proceed.code();
        } else {
            i = MlKitException.CODE_SCANNER_UNAVAILABLE;
        }
