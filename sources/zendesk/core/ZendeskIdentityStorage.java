...
class ZendeskIdentityStorage implements IdentityStorage {
    ...
    public static /* synthetic */ class C98581 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: zendesk.core.ZendeskIdentityStorage.C98581.<clinit>():void");
        }
    }
    ...
    public Identity getIdentity() {
        ...
        if (kb6.m46949b(str) && (authType = AuthenticationType.getAuthType(str)) != null) {
            int i = C98581.$SwitchMap$zendesk$core$AuthenticationType[authType.ordinal()];
            if (i == 1) {
                Logger.m43078b(LOG_TAG, "Loading Jwt identity", new Object[0]);
                return (Identity) this.identityStorage.get(IDENTITY_KEY, JwtIdentity.class);
            } else if (i == 2) {
                Logger.m43078b(LOG_TAG, "Loading Anonymous identity", new Object[0]);
    ...
    public String getUuid() {
        Logger.m43078b(LOG_TAG, "Fetching UUID from preferences store", new Object[0]);
    ...
    public void storeIdentity(Identity identity) {
        if (identity == null) {
            Logger.m43081e(LOG_TAG, "identity is null, will not store the identity", new Object[0]);
            return;
        }
        String str = null;
        if (identity instanceof AnonymousIdentity) {
            Logger.m43078b(LOG_TAG, "Storing anonymous identity", new Object[0]);
            str = AuthenticationType.ANONYMOUS.getAuthenticationType();
        } else if (identity instanceof JwtIdentity) {
            Logger.m43078b(LOG_TAG, "Storing jwt identity", new Object[0]);
            str = AuthenticationType.JWT.getAuthenticationType();
        } else {
            Logger.m43081e(LOG_TAG, "Unknown authentication type, identity will not be stored", new Object[0]);
        }
        if (str != null) {
    ...
    public void storeSdkGuid(String str) {
        Logger.m43078b(LOG_TAG, "Storing new UUID in preference store", new Object[0]);
        this.identityStorage.put(UUID_KEY, str);
    }

    public void storeUserId(Long l) {
        if (l != null) {
            this.identityStorage.put(USER_ID_KEY, (Object) l);
        }
    }

    public String updateBlipsUuid() {
        String uuid = UUID.randomUUID().toString();
        Logger.m43078b(LOG_TAG, "Generate new Blips BUID", new Object[0]);
