...
class ZendeskCoreSettingsStorage implements CoreSettingsStorage {
    ...
    public BlipsSettings getBlipsSettings() {
        ...
        Logger.m43078b(LOG_TAG, "Unable to load blips settings, returning defaults.", new Object[0]);
    ...
    public CoreSettings getCoreSettings() {
        ...
        Logger.m43078b(LOG_TAG, "Unable to load Core SDK Settings, returning default settings.", new Object[0]);
