...
class ZendeskNetworkInfoProvider implements NetworkInfoProvider, NetworkAware {
    ...
    private void registerForNetworkCallbacks() {
        Logger.m43078b(LOG_TAG, "Adding Lollipop network callbacks...", new Object[0]);
    ...
    public void onNetworkAvailable() {
        ...
        if (currentState2 != this.currentState && isConnectedOrConnecting(this.connectivityManager)) {
            ...
            Map<KeyT, ValueT> d = kj0.m47113d(this.listeners);
            Map<KeyT, ValueT> d2 = kj0.m47113d(this.retryActions);
            for (ValueT valuet : d.values()) {
                if (valuet.get() != null) {
                    ((NetworkAware) valuet.get()).onNetworkAvailable();
                }
            }
            for (ValueT valuet2 : d2.values()) {
                if (valuet2.get() != null) {
    ...
    public void onNetworkUnavailable() {
        ...
        if (currentState2 != this.currentState && !isConnectedOrConnecting(this.connectivityManager)) {
            this.currentState = currentState2;
            for (ValueT valuet : kj0.m47113d(this.listeners).values()) {
                if (valuet.get() != null) {
