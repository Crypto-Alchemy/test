...
class ZendeskStorage implements Storage {
    ...
    private String generateSdkHash(ApplicationConfiguration applicationConfiguration) {
        ...
        return ng1.m48766c(String.format(locale, SDK_HASH_FORMAT, new Object[]{applicationConfiguration.getZendeskUrl().toLowerCase(locale), applicationConfiguration.getApplicationId().toLowerCase(locale), applicationConfiguration.getOauthClientId().toLowerCase(locale)}));
    }
