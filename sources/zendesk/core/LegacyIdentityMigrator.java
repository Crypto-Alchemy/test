...
class LegacyIdentityMigrator {
    ...
    public static /* synthetic */ class C98491 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: zendesk.core.LegacyIdentityMigrator.C98491.<clinit>():void");
        }
    }
    ...
    private void clear() {
        ...
        this.legacyIdentityStorage.remove(ZendeskIdentityStorage.USER_ID_KEY);
        ...
        try {
            ...
            if (parse != null) {
                if (parse.isJsonObject()) {
                    ...
                    JsonElement jsonElement2 = asJsonObject.get(ZendeskIdentityStorage.USER_ID_KEY);
            ...
            Logger.m43086j(LOG_TAG, "Unable to read legacy AccessToken.", e, new Object[0]);
            return null;
        }
    }
    ...
    private Identity getLegacyIdentity() {
        ...
        int i = C98491.$SwitchMap$zendesk$core$AuthenticationType[legacyIdentityType.ordinal()];
        if (i == 1) {
    ...
    private String getLegacyPushId() {
        ...
        if (kb6.m46949b(str)) {
            try {
                ...
                if (parse != null) {
                    if (parse.isJsonObject()) {
                        JsonElement jsonElement = parse.getAsJsonObject().get(LEGACY_PUSH_DEVICE_ID_KEY);
                        if (jsonElement != null) {
                ...
                Logger.m43086j(LOG_TAG, "Unable to read legacy push device ID.", e, new Object[0]);
            }
        }
        return null;
    }
    ...
    private long getLegacyUserId() {
        return this.legacyIdentityStorage.getLong(ZendeskIdentityStorage.USER_ID_KEY);
    }
    ...
    private AnonymousIdentity readLegacyAnonymousIdentity() {
        ...
        try {
            ...
            Logger.m43086j(LOG_TAG, "Unable to read legacy AnonymousIdentity.", e, new Object[0]);
            return null;
        }
    }
    ...
    private JwtIdentity readLegacyJwtIdentity() {
        ...
        try {
            ...
            Logger.m43086j(LOG_TAG, "Unable to read legacy JwtIdentity.", e, new Object[0]);
            return null;
        }
    }
