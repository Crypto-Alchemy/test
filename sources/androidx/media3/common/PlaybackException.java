...
public class PlaybackException extends Exception implements C0785d {
    public static final C0785d.C0786a<PlaybackException> CREATOR = new yp4();
    ...
    public PlaybackException(String str, Throwable th, int i) {
        this(str, th, i, dh0.f10712a.mo18770b());
    }

    /* renamed from: a */
    public static RemoteException m5268a(String str) {
        return new RemoteException(str);
    }

    /* renamed from: b */
    public static Throwable m5269b(Class<?> cls, String str) throws Exception {
        return (Throwable) cls.getConstructor(new Class[]{String.class}).newInstance(new Object[]{str});
    }

    /* renamed from: c */
    public static Throwable m5270c(Bundle bundle) {
    ...
    public static String getErrorCodeName(int i) {
        ...
        switch (i) {
            ...
            case ERROR_CODE_BEHIND_LIVE_WINDOW /*1002*/:
                return "ERROR_CODE_BEHIND_LIVE_WINDOW";
            case ERROR_CODE_TIMEOUT /*1003*/:
    ...
    public boolean errorInfoEquals(androidx.media3.common.PlaybackException r7) {
        ...
        L_0x0012:
            ...
            boolean r4 = p000.w67.m29346c(r4, r5)
            if (r4 != 0) goto L_0x002d
            return r1
        L_0x002d:
            java.lang.Class r2 = r2.getClass()
            java.lang.Class r3 = r3.getClass()
            boolean r2 = p000.w67.m29346c(r2, r3)
    ...
    public PlaybackException(Bundle bundle) {
        this(bundle.getString(keyForField(2)), m5270c(bundle), bundle.getInt(keyForField(0), 1000), bundle.getLong(keyForField(1), SystemClock.elapsedRealtime()));
    }
