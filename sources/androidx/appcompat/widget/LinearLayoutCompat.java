...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void layoutHorizontal(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r6 = r24
            boolean r0 = p000.re7.m26176b(r24)
            ...
            int r1 = p000.ga7.m17715B(r24)
            int r1 = p000.pj2.m24971b(r2, r1)
            r15 = 2
            r5 = 1
    ...
    public void layoutVertical(int r18, int r19, int r20, int r21) {
        ...
        L_0x0059:
            ...
            r1 = r11
        L_0x0075:
            int r2 = p000.ga7.m17715B(r17)
            int r1 = p000.pj2.m24971b(r1, r2)
            r1 = r1 & 7
    ...
    public void setWeightSum(float f) {
        this.mWeightSum = Math.max(Utils.FLOAT_EPSILON, f);
    }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        int[] iArr = j65.LinearLayoutCompat;
        yq6 v = yq6.m30733v(context, attributeSet, iArr, i, 0);
        ga7.m17781n0(this, context, iArr, attributeSet, v.mo28192r(), i, 0);
        int k = v.mo28185k(j65.LinearLayoutCompat_android_orientation, -1);
        if (k >= 0) {
            setOrientation(k);
        }
        int k2 = v.mo28185k(j65.LinearLayoutCompat_android_gravity, -1);
        if (k2 >= 0) {
            setGravity(k2);
        }
        boolean a = v.mo28175a(j65.LinearLayoutCompat_android_baselineAligned, true);
        if (!a) {
            setBaselineAligned(a);
        }
        this.mWeightSum = v.mo28183i(j65.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = v.mo28185k(j65.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = v.mo28175a(j65.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(v.mo28181g(j65.LinearLayoutCompat_divider));
        this.mShowDividers = v.mo28185k(j65.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = v.mo28180f(j65.LinearLayoutCompat_dividerPadding, 0);
        v.mo28194w();
    }
