...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: e */
    public static int m1343e(View view) {
        int C = ga7.m17717C(view);
        if (C > 0) {
            return C;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1343e(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: f */
    public final boolean mo1788f(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == j35.topPanel) {
                    view = childAt;
                } else if (id == j35.buttonPanel) {
                    view2 = childAt;
                } else if ((id != j35.contentPanel && id != j35.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r2 = r11
        L_0x007e:
            int r3 = p000.ga7.m17715B(r17)
            int r2 = p000.pj2.m24971b(r2, r3)
            r2 = r2 & 7
            r3 = 1
