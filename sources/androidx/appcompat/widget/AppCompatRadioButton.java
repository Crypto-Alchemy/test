...
public class AppCompatRadioButton extends RadioButton implements zq6 {

    /* renamed from: a */
    public final C3375tm f1032a;

    /* renamed from: d */
    public final C3155qm f1033d;

    /* renamed from: e */
    public final C2765ln f1034e;

    /* renamed from: g */
    public C1640bn f1035g;
    ...
    public void drawableStateChanged() {
        ...
        C3155qm qmVar = this.f1033d;
        if (qmVar != null) {
            qmVar.mo25144b();
        }
        C2765ln lnVar = this.f1034e;
        if (lnVar != null) {
            lnVar.mo22857b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1034e.mo22864j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1034e.mo22865k();
    }
    ...
    public void setSupportCompoundDrawablesTintList(ColorStateList colorStateList) {
        this.f1034e.mo22877w(colorStateList);
        this.f1034e.mo22857b();
    }

    public void setSupportCompoundDrawablesTintMode(PorterDuff.Mode mode) {
        this.f1034e.mo22878x(mode);
        this.f1034e.mo22857b();
    }

    public AppCompatRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, m15.radioButtonStyle);
    }
