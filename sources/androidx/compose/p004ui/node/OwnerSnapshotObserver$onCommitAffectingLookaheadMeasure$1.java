...
public final class OwnerSnapshotObserver$onCommitAffectingLookaheadMeasure$1 extends Lambda implements rc2<LayoutNode, r37> {
    ...
    public final void invoke(LayoutNode layoutNode) {
        ...
        if (layoutNode.isValid()) {
            LayoutNode.m2540L0(layoutNode, false, 1, (Object) null);
        }
    }
}
