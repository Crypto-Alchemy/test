...
public final class NodeCoordinator$speculativeHit$1 extends Lambda implements pc2<r37> {
    ...
    public NodeCoordinator$speculativeHit$1(NodeCoordinator nodeCoordinator, T t, NodeCoordinator.C0393d<T> dVar, long j, em2<T> em2, boolean z, boolean z2, float f) {
        super(0);
    ...
    public final void invoke() {
        this.this$0.mo3628t1((nb1) a84.m129b(this.$this_speculativeHit, this.$hitTestSource.mo3643a(), g84.f12195a.mo20429e()), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
