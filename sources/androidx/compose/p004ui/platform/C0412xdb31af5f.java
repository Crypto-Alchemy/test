...
public final class C0412xdb31af5f extends Lambda implements rc2<LayoutNode, Boolean> {
    public static final C0412xdb31af5f INSTANCE = new C0412xdb31af5f();

    public C0412xdb31af5f() {
        super(1);
    }
