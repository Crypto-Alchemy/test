...
public final class ComposableSingletons$Wrapper_androidKt$lambda1$1 extends Lambda implements fd2<nn0, Integer, r37> {
    ...
    public final void invoke(nn0 nn0, int i) {
        if ((i & 11) != 2 || !nn0.mo2932b()) {
            if (ComposerKt.m1997O()) {
                ComposerKt.m2008Z(-1759434350, i, -1, "androidx.compose.ui.platform.ComposableSingletons$Wrapper_androidKt.lambda-1.<anonymous> (Wrapper.android.kt:127)");
            }
            if (ComposerKt.m1997O()) {
                ComposerKt.m2007Y();
                return;
