...
public final class Rgb$oetf$1 extends Lambda implements rc2<Double, Double> {
    ...
    public final Double invoke(double d) {
        return Double.valueOf(d75.m43387i(this.this$0.mo3295p().invoke(Double.valueOf(d)).doubleValue(), (double) this.this$0.f1690f, (double) this.this$0.f1691g));
    }
