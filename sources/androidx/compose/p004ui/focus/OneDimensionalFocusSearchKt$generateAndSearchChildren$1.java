...
public final class OneDimensionalFocusSearchKt$generateAndSearchChildren$1 extends Lambda implements rc2<z00.C3703a, Boolean> {
    ...
    public OneDimensionalFocusSearchKt$generateAndSearchChildren$1(FocusModifier focusModifier, FocusModifier focusModifier2, int i, rc2<? super FocusModifier, Boolean> rc2) {
        super(1);
    ...
    public final Boolean invoke(z00.C3703a aVar) {
        ...
        Boolean valueOf = Boolean.valueOf(OneDimensionalFocusSearchKt.m2407i(this.$this_generateAndSearchChildren, this.$focusedItem, this.$direction, this.$onFound));
