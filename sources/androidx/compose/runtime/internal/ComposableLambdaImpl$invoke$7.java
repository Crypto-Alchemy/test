...
public final class ComposableLambdaImpl$invoke$7 extends Lambda implements fd2<nn0, Integer, r37> {
    ...
    public final void invoke(nn0 nn0, int i) {
        vx2.m53591g(nn0, "nc");
        this.this$0.mo3135e(this.$p1, this.$p2, this.$p3, this.$p4, this.$p5, this.$p6, this.$p7, nn0, this.$changed | 1);
    }
}
