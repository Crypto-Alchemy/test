...
public final class ComposableSingletons$CompositionKt$lambda1$1 extends Lambda implements fd2<nn0, Integer, r37> {
    ...
    public final void invoke(nn0 nn0, int i) {
        if ((i & 11) != 2 || !nn0.mo2932b()) {
            if (ComposerKt.m1997O()) {
                ComposerKt.m2008Z(954879418, i, -1, "androidx.compose.runtime.ComposableSingletons$CompositionKt.lambda-1.<anonymous> (Composition.kt:505)");
            }
            if (ComposerKt.m1997O()) {
                ComposerKt.m2007Y();
                return;
