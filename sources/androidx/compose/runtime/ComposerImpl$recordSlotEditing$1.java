...
public final class ComposerImpl$recordSlotEditing$1 extends Lambda implements id2<C3379tp<?>, t46, mc5, r37> {
    public final /* synthetic */ C1628bg $anchor;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ComposerImpl$recordSlotEditing$1(C1628bg bgVar) {
        super(3);
        this.$anchor = bgVar;
    }
