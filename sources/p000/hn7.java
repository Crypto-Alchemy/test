...
public class hn7 {
    ...
    /* renamed from: hn7$a */
    /* compiled from: WorkTypeConverters */
    public static /* synthetic */ class C2498a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f12978a;

        /* renamed from: b */
        public static final /* synthetic */ int[] f12979b;

        /* renamed from: c */
        public static final /* synthetic */ int[] f12980c;

        /* renamed from: d */
        public static final /* synthetic */ int[] f12981d;
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f12981d     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x0043:
                r3 = 4
                int[] r4 = f12980c     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                r4 = 5
                int[] r5 = f12980c     // Catch:{ NoSuchFieldError -> 0x0059 }
            ...
            L_0x006a:
                int[] r5 = f12979b     // Catch:{ NoSuchFieldError -> 0x0074 }
            ...
            L_0x0085:
                int[] r1 = f12978a     // Catch:{ NoSuchFieldError -> 0x008f }
            ...
            L_0x008f:
                int[] r0 = f12978a     // Catch:{ NoSuchFieldError -> 0x0099 }
            ...
            L_0x0099:
                int[] r0 = f12978a     // Catch:{ NoSuchFieldError -> 0x00a3 }
            ...
            L_0x00a3:
                int[] r0 = f12978a     // Catch:{ NoSuchFieldError -> 0x00ad }
            ...
            L_0x00ad:
                int[] r0 = f12978a     // Catch:{ NoSuchFieldError -> 0x00b8 }
            ...
            L_0x00b8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p000.hn7.C2498a.<clinit>():void");
        }
    }

    /* renamed from: a */
    public static int m19109a(BackoffPolicy backoffPolicy) {
        int i = C2498a.f12979b[backoffPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    public static p000.vr0 m19110b(byte[] r6) {
        /*
            vr0 r0 = new vr0
            r0.<init>()
        ...
        L_0x0017:
            ...
            r0.mo27304a(r3, r4)     // Catch:{ IOException -> 0x0037 }
            int r6 = r6 + -1
            goto L_0x0017
        L_0x002b:
        ...
        L_0x006a:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.hn7.m19110b(byte[]):vr0");
    }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] m19111c(p000.vr0 r4) {
        /*
            int r0 = r4.mo27306c()
            r1 = 0
        ...
        L_0x0008:
            ...
            int r1 = r4.mo27306c()     // Catch:{ IOException -> 0x004f, all -> 0x004c }
            r2.writeInt(r1)     // Catch:{ IOException -> 0x004f, all -> 0x004c }
            java.util.Set r4 = r4.mo27305b()     // Catch:{ IOException -> 0x004f, all -> 0x004c }
        ...
        L_0x0021:
            ...
            vr0$a r1 = (p000.vr0.C3506a) r1     // Catch:{ IOException -> 0x004f, all -> 0x004c }
            android.net.Uri r3 = r1.mo27309a()     // Catch:{ IOException -> 0x004f, all -> 0x004c }
            java.lang.String r3 = r3.toString()     // Catch:{ IOException -> 0x004f, all -> 0x004c }
            r2.writeUTF(r3)     // Catch:{ IOException -> 0x004f, all -> 0x004c }
            boolean r1 = r1.mo27310b()     // Catch:{ IOException -> 0x004f, all -> 0x004c }
        ...
        L_0x0081:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.hn7.m19111c(vr0):byte[]");
    }

    /* renamed from: d */
    public static BackoffPolicy m19112d(int i) {
        if (i == 0) {
    ...
    /* renamed from: e */
    public static NetworkType m19113e(int i) {
        if (i == 0) {
    ...
    /* renamed from: f */
    public static OutOfQuotaPolicy m19114f(int i) {
        if (i == 0) {
    ...
    /* renamed from: g */
    public static WorkInfo.State m19115g(int i) {
        if (i == 0) {
    ...
    /* renamed from: h */
    public static int m19116h(NetworkType networkType) {
        int i = C2498a.f12980c[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    /* renamed from: i */
    public static int m19117i(OutOfQuotaPolicy outOfQuotaPolicy) {
        int i = C2498a.f12981d[outOfQuotaPolicy.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
    ...
    /* renamed from: j */
    public static int m19118j(WorkInfo.State state) {
        switch (C2498a.f12978a[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
