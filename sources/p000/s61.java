...
public final class s61 implements C2332fx, ov6 {

    /* renamed from: p */
    public static final ImmutableList<Long> f17480p = ImmutableList.m36632of(4800000L, 3100000L, 2100000L, 1500000L, 800000L);

    /* renamed from: q */
    public static final ImmutableList<Long> f17481q = ImmutableList.m36632of(1500000L, 1000000L, 730000L, 440000L, 170000L);

    /* renamed from: r */
    public static final ImmutableList<Long> f17482r = ImmutableList.m36632of(2200000L, 1400000L, 1100000L, 910000L, 620000L);

    /* renamed from: s */
    public static final ImmutableList<Long> f17483s = ImmutableList.m36632of(3000000L, 1900000L, 1400000L, 1000000L, 660000L);

    /* renamed from: t */
    public static final ImmutableList<Long> f17484t = ImmutableList.m36632of(6000000L, 4100000L, 3200000L, 1800000L, 1000000L);

    /* renamed from: u */
    public static final ImmutableList<Long> f17485u = ImmutableList.m36632of(2800000L, 2400000L, 1600000L, 1100000L, 950000L);

    /* renamed from: v */
    public static s61 f17486v;

    /* renamed from: a */
    public final ImmutableMap<Integer, Long> f17487a;

    /* renamed from: b */
    public final C2332fx.C2333a.C2334a f17488b;

    /* renamed from: c */
    public final n46 f17489c;

    /* renamed from: d */
    public final dh0 f17490d;
    ...
    public static final class C3247b {
        ...
        /* renamed from: b */
        public Map<Integer, Long> f17503b;
        ...
        public C3247b(Context context) {
            ...
            this.f17502a = context2;
            this.f17503b = m26677b(w67.m29312J(context));
            this.f17504c = PlaybackException.ERROR_CODE_IO_UNSPECIFIED;
            this.f17505d = dh0.f10712a;
            this.f17506e = true;
        }

        /* renamed from: b */
        public static Map<Integer, Long> m26677b(String str) {
            int[] k = s61.m26662l(str);
            HashMap hashMap = new HashMap(8);
            hashMap.put(0, 1000000L);
            ImmutableList<Long> immutableList = s61.f17480p;
            hashMap.put(2, immutableList.get(k[0]));
            hashMap.put(3, s61.f17481q.get(k[1]));
            hashMap.put(4, s61.f17482r.get(k[2]));
            hashMap.put(5, s61.f17483s.get(k[3]));
            hashMap.put(10, s61.f17484t.get(k[4]));
            hashMap.put(9, s61.f17485u.get(k[5]));
            hashMap.put(7, immutableList.get(k[0]));
            return hashMap;
        }

        /* renamed from: a */
        public s61 mo25651a() {
            return new s61(this.f17502a, this.f17503b, this.f17504c, this.f17505d, this.f17506e);
        }
    }
    ...
    public static int[] m26662l(java.lang.String r3) {
        /*
            r3.hashCode()
            int r0 = r3.hashCode()
            r1 = 6
        ...
        L_0x1078:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.s61.m26662l(java.lang.String):int[]");
    }

    /* renamed from: n */
    public static synchronized s61 m26663n(Context context) {
        s61 s61;
        synchronized (s61.class) {
            if (f17486v == null) {
                f17486v = new C3247b(context).mo25651a();
            }
            s61 = f17486v;
        }
        return s61;
    ...
    /* renamed from: o */
    public static boolean m26664o(d21 d21, boolean z) {
        if (!z || d21.mo18399d(8)) {
            return false;
        }
        return true;
    ...
    /* renamed from: a */
    public /* synthetic */ long mo20255a() {
        return C2204dx.m15450a(this);
    }

    /* renamed from: b */
    public void mo24123b(x11 x11, d21 d21, boolean z) {
    }

    /* renamed from: c */
    public synchronized void mo24124c(x11 x11, d21 d21, boolean z, int i) {
        if (m26664o(d21, z)) {
            this.f17494h += (long) i;
        }
    }
    ...
    /* renamed from: e */
    public synchronized long mo20257e() {
        return this.f17498l;
    }

    /* renamed from: f */
    public synchronized void mo24125f(x11 x11, d21 d21, boolean z) {
        boolean z2;
        if (m26664o(d21, z)) {
            if (this.f17492f > 0) {
                z2 = true;
            ...
            C2725kr.m20987g(z2);
            long b = this.f17490d.mo18770b();
            int i = (int) (b - this.f17493g);
            this.f17496j += (long) i;
            long j = this.f17497k;
            long j2 = this.f17494h;
            this.f17497k = j + j2;
            if (i > 0) {
                this.f17489c.mo23506c((int) Math.sqrt((double) j2), (((float) j2) * 8000.0f) / ((float) i));
                if (this.f17496j >= 2000 || this.f17497k >= 524288) {
                    this.f17498l = (long) this.f17489c.mo23509f(0.5f);
                }
                mo25649p(i, this.f17494h, this.f17498l);
                this.f17493g = b;
                this.f17494h = 0;
            }
            this.f17492f--;
    ...
    /* renamed from: g */
    public synchronized void mo24126g(x11 x11, d21 d21, boolean z) {
        if (m26664o(d21, z)) {
            if (this.f17492f == 0) {
                this.f17493g = this.f17490d.mo18770b();
            }
            this.f17492f++;
        }
    }
    ...
    /* renamed from: h */
    public void mo20258h(Handler handler, C2332fx.C2333a aVar) {
        C2725kr.m20985e(handler);
        C2725kr.m20985e(aVar);
        this.f17488b.mo20260b(handler, aVar);
    }

    /* renamed from: i */
    public void mo20259i(C2332fx.C2333a aVar) {
        this.f17488b.mo20262e(aVar);
    }

    /* renamed from: m */
    public final long mo25648m(int i) {
        Long l = this.f17487a.get(Integer.valueOf(i));
        if (l == null) {
            l = this.f17487a.get(0);
        }
        if (l == null) {
            l = 1000000L;
        }
    ...
    /* renamed from: p */
    public final void mo25649p(int i, long j, long j2) {
        if (i != 0 || j != 0 || j2 != this.f17499m) {
            this.f17499m = j2;
            this.f17488b.mo20261c(i, j, j2);
        }
    }
    ...
    /* renamed from: q */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo25650q(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.f17495i     // Catch:{ all -> 0x0054 }
            if (r0 == 0) goto L_0x000b
            boolean r1 = r8.f17491e     // Catch:{ all -> 0x0054 }
            if (r1 != 0) goto L_0x000b
            monitor-exit(r8)
            return
        L_0x000b:
            boolean r1 = r8.f17500n     // Catch:{ all -> 0x0054 }
            if (r1 == 0) goto L_0x0011
            int r9 = r8.f17501o     // Catch:{ all -> 0x0054 }
        L_0x0011:
            if (r0 != r9) goto L_0x0015
            monitor-exit(r8)
            return
        L_0x0015:
            r8.f17495i = r9     // Catch:{ all -> 0x0054 }
            r0 = 1
            ...
            goto L_0x0052
        L_0x0021:
            long r0 = r8.mo25648m(r9)     // Catch:{ all -> 0x0054 }
            r8.f17498l = r0     // Catch:{ all -> 0x0054 }
            dh0 r9 = r8.f17490d     // Catch:{ all -> 0x0054 }
            long r0 = r9.mo18770b()     // Catch:{ all -> 0x0054 }
            int r9 = r8.f17492f     // Catch:{ all -> 0x0054 }
            if (r9 <= 0) goto L_0x0037
            long r2 = r8.f17493g     // Catch:{ all -> 0x0054 }
            long r2 = r0 - r2
        ...
        L_0x0038:
            r3 = r9
            long r4 = r8.f17494h     // Catch:{ all -> 0x0054 }
            long r6 = r8.f17498l     // Catch:{ all -> 0x0054 }
            r2 = r8
            r2.mo25649p(r3, r4, r6)     // Catch:{ all -> 0x0054 }
            r8.f17493g = r0     // Catch:{ all -> 0x0054 }
            r0 = 0
            r8.f17494h = r0     // Catch:{ all -> 0x0054 }
            r8.f17497k = r0     // Catch:{ all -> 0x0054 }
            r8.f17496j = r0     // Catch:{ all -> 0x0054 }
            n46 r9 = r8.f17489c     // Catch:{ all -> 0x0054 }
            r9.mo23510i()     // Catch:{ all -> 0x0054 }
            monitor-exit(r8)
            return
        L_0x0052:
            monitor-exit(r8)
        ...
        L_0x0054:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.s61.mo25650q(int):void");
    }

    public s61(Context context, Map<Integer, Long> map, int i, dh0 dh0, boolean z) {
        this.f17487a = ImmutableMap.copyOf(map);
        this.f17488b = new C2332fx.C2333a.C2334a();
        this.f17489c = new n46(i);
        this.f17490d = dh0;
        this.f17491e = z;
        if (context != null) {
            x54 d = x54.m29901d(context);
            int f = d.mo27673f();
            this.f17495i = f;
            this.f17498l = mo25648m(f);
            d.mo27674i(new r61(this));
            return;
        }
        this.f17495i = 0;
        this.f17498l = mo25648m(0);
    }
}
