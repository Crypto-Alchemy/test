...
public final class q78 {
    ...
    public static void m50388a(p000.bn8 r14, android.database.sqlite.SQLiteDatabase r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String[] r19) throws android.database.sqlite.SQLiteException {
        /*
            r9 = r15
            r10 = r16
            r11 = r19
        ...
        L_0x002f:
            ...
            r1 = r13
        L_0x0031:
            vm8 r2 = r14.mo29673o()     // Catch:{ all -> 0x00f5 }
            java.lang.String r3 = "Error querying for table"
            r2.mo48771c(r3, r10, r0)     // Catch:{ all -> 0x00f5 }
        ...
        L_0x00cf:
            ...
            vm8 r1 = r14.mo29673o()     // Catch:{ SQLiteException -> 0x00ea }
            ...
            r1.mo48771c(r2, r10, r0)     // Catch:{ SQLiteException -> 0x00ea }
        L_0x00e4:
            return
        L_0x00e5:
            r0 = move-exception
        ...
        L_0x00fd:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.q78.m50388a(bn8, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    /* renamed from: b */
    public static void m50389b(bn8 bn8, SQLiteDatabase sQLiteDatabase) {
        if (bn8 != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                bn8.mo29673o().mo48769a("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                bn8.mo29673o().mo48769a("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                bn8.mo29673o().mo48769a("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                bn8.mo29673o().mo48769a("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
