...
public final class ln2 {
    ...
    /* renamed from: a */
    public static final Pattern f14611a = Pattern.compile("bytes (\\d+)-(\\d+)/(?:\\d+|\\*)");

    /* renamed from: b */
    public static final Pattern f14612b = Pattern.compile("bytes (?:(?:\\d+-\\d+)|\\*)/(\\d+)");

    /* renamed from: a */
    public static String m21628a(long j, long j2) {
        if (j == 0 && j2 == -1) {
            return null;
        }
    ...
    public static long m21629b(java.lang.String r9, java.lang.String r10) {
        /*
        ...
        L_0x000f:
            ...
            p000.gk3.m18126c(r2, r0)
        L_0x0026:
            r3 = -1
        L_0x0028:
            boolean r0 = android.text.TextUtils.isEmpty(r10)
            if (r0 != 0) goto L_0x00a4
            java.util.regex.Pattern r0 = f14611a
            java.util.regex.Matcher r0 = r0.matcher(r10)
            boolean r5 = r0.matches()
            if (r5 == 0) goto L_0x00a4
            r5 = 2
            java.lang.String r5 = r0.group(r5)     // Catch:{ NumberFormatException -> 0x008d }
            java.lang.Object r5 = p000.C2725kr.m20985e(r5)     // Catch:{ NumberFormatException -> 0x008d }
            ...
            java.lang.Object r0 = p000.C2725kr.m20985e(r0)     // Catch:{ NumberFormatException -> 0x008d }
        ...
        L_0x0064:
            ...
            p000.gk3.m18132i(r2, r9)     // Catch:{ NumberFormatException -> 0x008d }
        ...
        L_0x008d:
            ...
            p000.gk3.m18126c(r2, r9)
        L_0x00a4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.ln2.m21629b(java.lang.String, java.lang.String):long");
    }

    /* renamed from: c */
    public static long m21630c(String str) {
        if (TextUtils.isEmpty(str)) {
            return -1;
        }
        Matcher matcher = f14612b.matcher(str);
        if (matcher.matches()) {
            return Long.parseLong((String) C2725kr.m20985e(matcher.group(1)));
        }
        return -1;
    }
}
