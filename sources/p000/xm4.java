...
public class xm4 {
    ...
    /* renamed from: a */
    public static void m30206a(ArrayList<C3631b> arrayList, char c, float[] fArr) {
        arrayList.add(new C3631b(c, fArr));
    }

    /* renamed from: b */
    public static boolean m30207b(C3631b[] bVarArr, C3631b[] bVarArr2) {
        if (bVarArr == null || bVarArr2 == null || bVarArr.length != bVarArr2.length) {
            return false;
        }
        for (int i = 0; i < bVarArr.length; i++) {
            C3631b bVar = bVarArr[i];
            char c = bVar.f19917a;
            C3631b bVar2 = bVarArr2[i];
            if (c != bVar2.f19917a || bVar.f19918b.length != bVar2.f19918b.length) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: c */
    public static float[] m30208c(float[] fArr, int i, int i2) {
        if (i <= i2) {
    ...
    /* renamed from: d */
    public static C3631b[] m30209d(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            int i3 = m30214i(str, i);
            String trim = str.substring(i2, i3).trim();
            if (trim.length() > 0) {
                m30206a(arrayList, trim.charAt(0), m30213h(trim));
            }
            i2 = i3;
            i = i3 + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m30206a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C3631b[]) arrayList.toArray(new C3631b[arrayList.size()]);
    }

    /* renamed from: e */
    public static Path m30210e(String str) {
        Path path = new Path();
        C3631b[] d = m30209d(str);
        if (d == null) {
            return null;
        }
        try {
            C3631b.m30219e(d, path);
            return path;
    ...
    /* renamed from: f */
    public static C3631b[] m30211f(C3631b[] bVarArr) {
        if (bVarArr == null) {
            return null;
        }
        C3631b[] bVarArr2 = new C3631b[bVarArr.length];
        for (int i = 0; i < bVarArr.length; i++) {
            bVarArr2[i] = new C3631b(bVarArr[i]);
        }
        return bVarArr2;
    }
    ...
    public static void m30212g(java.lang.String r8, int r9, p000.xm4.C3630a r10) {
        /*
            r0 = 0
            r10.f19916b = r0
            r1 = r9
        ...
        L_0x003d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.xm4.m30212g(java.lang.String, int, xm4$a):void");
    }

    /* renamed from: h */
    public static float[] m30213h(String str) {
        if (str.charAt(0) == 'z' || str.charAt(0) == 'Z') {
            return new float[0];
        }
        try {
            float[] fArr = new float[str.length()];
            C3630a aVar = new C3630a();
    ...
    /* renamed from: i */
    public static int m30214i(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: j */
    public static void m30215j(C3631b[] bVarArr, C3631b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f19917a = bVarArr2[i].f19917a;
            int i2 = 0;
            while (true) {
                float[] fArr = bVarArr2[i].f19918b;
                if (i2 >= fArr.length) {
                    break;
                }
                bVarArr[i].f19918b[i2] = fArr[i2];
                i2++;
            }
        }
    }
    ...
    public static class C3631b {
        ...
        public C3631b(char c, float[] fArr) {
            this.f19917a = c;
            this.f19918b = fArr;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:103:0x0232, code lost:
            r24 = r7;
            m30218c(r25, r9, r8, r3, r4, r5, r6, r15, r22, r23);
            r9 = r9 + r12[r13];
            r8 = r8 + r12[r14];
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:116:0x02e3, code lost:
            m30218c(r25, r11, r15, r3, r4, r5, r6, r7, r8, r9);
            r9 = r12[r13];
            r8 = r12[r14];
         */
        ...
        /* renamed from: a */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static void m30216a(android.graphics.Path r25, float[] r26, char r27, char r28, float[] r29) {
            /*
                r10 = r25
                r11 = r28
                r12 = r29
            ...
            L_0x0232:
                ...
                r11 = r9
                r9 = r23
                m30218c(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9)
                r0 = r12[r13]
                float r9 = r11 + r0
                r0 = r12[r14]
                float r8 = r15 + r0
            ...
            L_0x02fa:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p000.xm4.C3631b.m30216a(android.graphics.Path, float[], char, char, float[]):void");
        }

        /* renamed from: b */
        public static void m30217b(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
        ...
        /* renamed from: c */
        public static void m30218c(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            boolean z3;
            float f8 = f;
            ...
            if (d22 != Utils.DOUBLE_EPSILON) {
                ...
                if (d23 < Utils.DOUBLE_EPSILON) {
                    ...
                    m30218c(path, f, f2, f3, f4, f10 * sqrt, f6 * sqrt, f7, z, z2);
                    return;
                }
                ...
                double d26 = d2 * d15;
                double d27 = d * d11;
                m30217b(path, (d26 * cos) - (d27 * d21), (d26 * d21) + (d27 * cos), d15, d11, d5, d10, radians, atan2, atan22);
            }
        }

        /* renamed from: e */
        public static void m30219e(C3631b[] bVarArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < bVarArr.length; i++) {
                C3631b bVar = bVarArr[i];
                m30216a(path, fArr, c, bVar.f19917a, bVar.f19918b);
                c = bVarArr[i].f19917a;
            }
        }

        /* renamed from: d */
        public void mo27832d(C3631b bVar, C3631b bVar2, float f) {
            this.f19917a = bVar.f19917a;
            int i = 0;
            while (true) {
                float[] fArr = bVar.f19918b;
                if (i < fArr.length) {
                    this.f19918b[i] = (fArr[i] * (1.0f - f)) + (bVar2.f19918b[i] * f);
                    i++;
                } else {
                    return;
                }
        ...
        public C3631b(C3631b bVar) {
            this.f19917a = bVar.f19917a;
            float[] fArr = bVar.f19918b;
            this.f19918b = xm4.m30208c(fArr, 0, fArr.length);
        }
    }
}
