...
public final class jm8 extends qo8 {

    /* renamed from: c */
    public final gm8 f30528c;
    ...
    public jm8(kr8 kr8) {
        ...
        this.f30528c = new gm8(this, q, "google_app_measurement_local.db");
    }
    ...
    /* renamed from: l */
    public final void mo44514l() {
        int delete;
        mo29006e();
        try {
            SQLiteDatabase u = mo44521u();
            if (u != null && (delete = u.delete("messages", (String) null, (String[]) null)) > 0) {
                this.f34342a.mo45237A().mo29678v().mo48770b("Reset local analytics data. records", Integer.valueOf(delete));
            }
        } catch (SQLiteException e) {
            this.f34342a.mo45237A().mo29670l().mo48770b("Error resetting local analytics data. error", e);
        }
    }

    /* renamed from: m */
    public final boolean mo44515m(zzas zzas) {
        Parcel obtain = Parcel.obtain();
        d98.m43414a(zzas, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return mo44523w(0, marshall);
        }
        this.f34342a.mo45237A().mo29671m().mo48769a("Event is too long for local database. Sending event directly to service");
        return false;
    }

    /* renamed from: n */
    public final boolean mo44516n(zzkq zzkq) {
        Parcel obtain = Parcel.obtain();
        x59.m54232a(zzkq, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return mo44523w(1, marshall);
        }
        this.f34342a.mo45237A().mo29671m().mo48769a("User property too long for local database. Sending directly to service");
        return false;
    }

    /* renamed from: o */
    public final boolean mo44517o(zzaa zzaa) {
        byte[] L = this.f34342a.mo45243G().mo42796L(zzaa);
        if (L.length <= 131072) {
            return mo44523w(2, L);
        }
        this.f34342a.mo45237A().mo29671m().mo48769a("Conditional user property too long for local database. Sending directly to service");
        return false;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:?, code lost:
        r1.f34342a.mo45237A().mo29670l().mo48769a("Failed to load event from local database");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:49:?, code lost:
        r12.recycle();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:60:?, code lost:
        r1.f34342a.mo45237A().mo29670l().mo48769a("Failed to load user property from local database");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:75:?, code lost:
        r1.f34342a.mo45237A().mo29670l().mo48769a("Failed to load conditional user property from local database");
     */
    ...
    public final java.util.List<com.google.android.gms.common.internal.safeparcel.AbstractSafeParcelable> mo44518p(int r23) {
        /*
            r22 = this;
            r1 = r22
        ...
        L_0x001e:
            ...
            r10 = 1
            android.database.sqlite.SQLiteDatabase r15 = r22.mo44521u()     // Catch:{ SQLiteFullException -> 0x022e, SQLiteDatabaseLockedException -> 0x021b, SQLiteException -> 0x01f6, all -> 0x01f3 }
            if (r15 != 0) goto L_0x002a
            r1.f30529d = r10     // Catch:{ SQLiteFullException -> 0x01ee, SQLiteDatabaseLockedException -> 0x01ea, SQLiteException -> 0x01e5, all -> 0x01e0 }
            return r4
        L_0x002a:
        ...
        L_0x008f:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzas> r0 = com.google.android.gms.measurement.internal.zzas.CREATOR     // Catch:{ ParseException -> 0x00c2 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ ParseException -> 0x00c2 }
            com.google.android.gms.measurement.internal.zzas r0 = (com.google.android.gms.measurement.internal.zzas) r0     // Catch:{ ParseException -> 0x00c2 }
        ...
        L_0x00c0:
            ...
            goto L_0x00d5
        L_0x00c2:
            kr8 r0 = r1.f34342a     // Catch:{ all -> 0x00c0 }
            bn8 r0 = r0.mo45237A()     // Catch:{ all -> 0x00c0 }
            vm8 r0 = r0.mo29670l()     // Catch:{ all -> 0x00c0 }
            java.lang.String r13 = "Failed to load event from local database"
            r0.mo48769a(r13)     // Catch:{ all -> 0x00c0 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x008f
        L_0x00d5:
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
        ...
        L_0x00d9:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzkq> r0 = com.google.android.gms.measurement.internal.zzkq.CREATOR     // Catch:{ ParseException -> 0x00f4 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ ParseException -> 0x00f4 }
            com.google.android.gms.measurement.internal.zzkq r0 = (com.google.android.gms.measurement.internal.zzkq) r0     // Catch:{ ParseException -> 0x00f4 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x0107
        L_0x00f2:
            r0 = move-exception
            goto L_0x010d
        L_0x00f4:
            kr8 r0 = r1.f34342a     // Catch:{ all -> 0x00f2 }
            bn8 r0 = r0.mo45237A()     // Catch:{ all -> 0x00f2 }
            vm8 r0 = r0.mo29670l()     // Catch:{ all -> 0x00f2 }
            java.lang.String r13 = "Failed to load user property from local database"
            r0.mo48769a(r13)     // Catch:{ all -> 0x00f2 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            r0 = r4
        L_0x0107:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x0111:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzaa> r0 = com.google.android.gms.measurement.internal.zzaa.CREATOR     // Catch:{ ParseException -> 0x012c }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ ParseException -> 0x012c }
            com.google.android.gms.measurement.internal.zzaa r0 = (com.google.android.gms.measurement.internal.zzaa) r0     // Catch:{ ParseException -> 0x012c }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x013f
        L_0x012a:
            r0 = move-exception
            goto L_0x0146
        L_0x012c:
            kr8 r0 = r1.f34342a     // Catch:{ all -> 0x012a }
            bn8 r0 = r0.mo45237A()     // Catch:{ all -> 0x012a }
            vm8 r0 = r0.mo29670l()     // Catch:{ all -> 0x012a }
            java.lang.String r13 = "Failed to load conditional user property from local database"
            r0.mo48769a(r13)     // Catch:{ all -> 0x012a }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            r0 = r4
        L_0x013f:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x014a:
            ...
            kr8 r0 = r1.f34342a     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            bn8 r0 = r0.mo45237A()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            vm8 r0 = r0.mo29673o()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            java.lang.String r12 = "Skipping app launch break"
            r0.mo48769a(r12)     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x008f
        L_0x015e:
            kr8 r0 = r1.f34342a     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            bn8 r0 = r0.mo45237A()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            vm8 r0 = r0.mo29670l()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
        ...
        L_0x016f:
            ...
            kr8 r0 = r1.f34342a     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            bn8 r0 = r0.mo45237A()     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            vm8 r0 = r0.mo29670l()     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            java.lang.String r12 = "Fewer entries removed from local database than expected"
            r0.mo48769a(r12)     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
        L_0x0196:
        ...
        L_0x0204:
            kr8 r12 = r1.f34342a     // Catch:{ all -> 0x024c }
            bn8 r12 = r12.mo45237A()     // Catch:{ all -> 0x024c }
            vm8 r12 = r12.mo29670l()     // Catch:{ all -> 0x024c }
            r12.mo48770b(r3, r0)     // Catch:{ all -> 0x024c }
            r1.f30529d = r10     // Catch:{ all -> 0x024c }
        ...
        L_0x0269:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.jm8.mo44518p(int):java.util.List");
    }

    /* renamed from: r */
    public final boolean mo44519r() {
        return mo44523w(3, new byte[0]);
    }

    /* renamed from: t */
    public final boolean mo44520t() {
        mo29006e();
        if (!this.f30529d && mo44522v()) {
            int i = 5;
            int i2 = 0;
            while (i2 < 5) {
                ...
                try {
                    ...
                    this.f34342a.mo45237A().mo29670l().mo48770b("Error deleting app launch break from local database", e);
                    this.f30529d = true;
                    ...
                    this.f34342a.mo45237A().mo29670l().mo48770b("Error deleting app launch break from local database", e2);
                    this.f30529d = true;
                    if (sQLiteDatabase != null) {
                        sQLiteDatabase.close();
                        i2++;
            ...
            this.f34342a.mo45237A().mo29673o().mo48769a("Error deleting app launch break from local database in reasonable time");
        }
        return false;
    }

    /* renamed from: u */
    public final SQLiteDatabase mo44521u() throws SQLiteException {
        if (this.f30529d) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f30528c.getWritableDatabase();
    ...
    /* renamed from: v */
    public final boolean mo44522v() {
        Context q = this.f34342a.mo45271q();
        this.f34342a.mo45274y();
        return q.getDatabasePath("google_app_measurement_local.db").exists();
    }
    ...
    /* renamed from: w */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean mo44523w(int r17, byte[] r18) {
        /*
            r16 = this;
            r1 = r16
            r16.mo29006e()
        ...
        L_0x0028:
            ...
            r7 = 1
            r8 = 0
            android.database.sqlite.SQLiteDatabase r9 = r16.mo44521u()     // Catch:{ SQLiteFullException -> 0x00fb, SQLiteDatabaseLockedException -> 0x00e9, SQLiteException -> 0x00c2, all -> 0x00bf }
            if (r9 != 0) goto L_0x0035
            r1.f30529d = r7     // Catch:{ SQLiteFullException -> 0x00bb, SQLiteDatabaseLockedException -> 0x00ea, SQLiteException -> 0x00b7 }
            return r2
        L_0x0035:
        ...
        L_0x0054:
            ...
            kr8 r0 = r1.f34342a     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            bn8 r0 = r0.mo45237A()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            vm8 r0 = r0.mo29670l()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            java.lang.String r4 = "Data loss, local db full"
            r0.mo48769a(r4)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            long r13 = r13 - r11
            r11 = 1
            long r13 = r13 + r11
            ...
            r0.mo48772d(r4, r2, r7, r11)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
        L_0x009f:
        ...
        L_0x00cf:
            kr8 r2 = r1.f34342a     // Catch:{ all -> 0x011f }
            bn8 r2 = r2.mo45237A()     // Catch:{ all -> 0x011f }
            vm8 r2 = r2.mo29670l()     // Catch:{ all -> 0x011f }
            java.lang.String r4 = "Error writing entry to local database"
            r2.mo48770b(r4, r0)     // Catch:{ all -> 0x011f }
            r2 = 1
            r1.f30529d = r2     // Catch:{ all -> 0x011f }
        ...
        L_0x012d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.jm8.mo44523w(int, byte[]):boolean");
    }
}
