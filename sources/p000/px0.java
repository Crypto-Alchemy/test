...
@Metadata(mo44875bv = {}, mo44876d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0011\n\u0002\b\u0003\u001a\u000e\u0010\u0002\u001a\u00020\u00002\u0006\u0010\u0001\u001a\u00020\u0000\u001a\u0016\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u0003\u001a\u0016\u0010\u0007\u001a\u00020\u00052\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u0003\u001a\u0018\u0010\t\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\u00002\u0006\u0010\u0004\u001a\u00020\u0003H\u0002\u001a%\u0010\u0001\u001a\u00020\u00052\f\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00030\n2\u0006\u0010\u0004\u001a\u00020\u0003H\u0007¢\u0006\u0004\b\u0001\u0010\f¨\u0006\r"}, mo44877d2 = {"Landroid/database/Cursor;", "c", "a", "", "name", "", "d", "e", "cursor", "b", "", "columnNames", "([Ljava/lang/String;Ljava/lang/String;)I", "room-runtime_release"}, mo44878k = 2, mo44879mv = {1, 7, 1})
/* renamed from: px0 */
...
public final class px0 {
    ...
    public static final android.database.Cursor m25186a(android.database.Cursor r7) {
        /*
        ...
        L_0x0071:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.px0.m25186a(android.database.Cursor):android.database.Cursor");
    }

    /* renamed from: b */
    public static final int m25187b(Cursor cursor, String str) {
        boolean z;
        ...
        vx2.m53590f(columnNames, "columnNames");
        return m25188c(columnNames, str);
    }

    /* renamed from: c */
    public static final int m25188c(String[] strArr, String str) {
        vx2.m53591g(strArr, "columnNames");
        ...
        while (i < length) {
            ...
            if (str4.length() >= str.length() + 2) {
                if (yb6.m74343x(str4, str2, false, 2, (Object) null)) {
                    return i2;
                }
                if (str4.charAt(0) == '`' && yb6.m74343x(str4, str3, false, 2, (Object) null)) {
                    return i2;
                }
            }
            i++;
    ...
    /* renamed from: d */
    public static final int m25189d(Cursor cursor, String str) {
        vx2.m53591g(cursor, "c");
        vx2.m53591g(str, PublicResolver.FUNC_NAME);
        ...
        return m25187b(cursor, str);
    }

    /* renamed from: e */
    public static final int m25190e(Cursor cursor, String str) {
        String str2;
        vx2.m53591g(cursor, "c");
        vx2.m53591g(str, PublicResolver.FUNC_NAME);
        int d = m25189d(cursor, str);
        if (d >= 0) {
            return d;
        }
        try {
            String[] columnNames = cursor.getColumnNames();
            vx2.m53590f(columnNames, "c.columnNames");
            str2 = ArraysKt___ArraysKt.m47269U(columnNames, (CharSequence) null, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (rc2) null, 63, (Object) null);
