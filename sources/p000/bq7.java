...
public final class bq7 {
    ...
    /* renamed from: a */
    public static final Map<Integer, String> f21441a;

    /* renamed from: b */
    public static final Map<Integer, String> f21442b;
    ...
    /* renamed from: a */
    public static String m32685a(int i) {
        Map<Integer, String> map = f21441a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return "";
        }
        String str = map.get(valueOf);
        String str2 = f21442b.get(valueOf);
