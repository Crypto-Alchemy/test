...
public class u87 extends zf5 {

    /* renamed from: c */
    public static boolean f18410c = false;

    /* renamed from: b */
    public final WeakReference<Context> f18411b;

    public u87(Context context, Resources resources) {
        super(resources);
        this.f18411b = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m28119b() {
        return f18410c;
    }

    /* renamed from: c */
    public static boolean m28120c() {
        boolean b = m28119b();
        return false;
    }
    ...
    public Drawable getDrawable(int i) throws Resources.NotFoundException {
        Context context = this.f18411b.get();
        if (context != null) {
            return pf5.m24867h().mo24566t(context, this, i);
        }
        return mo28428a(i);
    }
