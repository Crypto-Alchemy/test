...
/* renamed from: wq5 */
public class wq5 extends nm1.C8993b {
    public wq5(ul1 ul1, zl1 zl1, zl1 zl12) {
        super(ul1, zl1, zl12);
    }

    public wq5(ul1 ul1, zl1 zl1, zl1 zl12, zl1[] zl1Arr) {
    ...
    public nm1 mo50274J() {
        ...
        if (a.mo50983i()) {
            return new wq5(i, a, i.mo66317o().mo50988n());
        }
        zl1 o2 = a.mo50989o();
        ...
        return new wq5(i, o2, zl1.mo50990p(a, j).mo50975a(o2).mo50975a(j2), new zl1[]{j2});
    }
    ...
    public nm1 mo50275K(nm1 nm1) {
        ...
        if (l.mo50983i()) {
            return new wq5(i, l, i.mo66317o().mo50988n());
        }
        zl1 j2 = l.mo50989o().mo50984j(j);
        zl1 j3 = l.mo50984j(o5).mo50984j(o4);
        return new wq5(i, j2, l.mo50975a(o5).mo50989o().mo50986l(a, o.mo50976b(), j3), new zl1[]{j3});
    }
    ...
    public nm1 mo50276a(nm1 nm1) {
        ...
        if (n.mo50983i()) {
            ...
            if (zl15.mo50983i()) {
                return new wq5(i, zl15, i.mo66317o().mo50988n());
            }
            ...
            if (j3.mo50983i()) {
                return new wq5(i, j3, i.mo66317o().mo50988n());
            }
        ...
        return new wq5(i, zl15, zl14, new zl1[]{zl16});
    }

    /* renamed from: d */
    public nm1 mo50277d() {
        return new wq5((ul1) null, mo62737f(), mo62738g());
    }
    ...
    public nm1 mo50278z() {
        ...
        zl1 zl12 = this.f43512c;
        zl1 zl13 = this.f43513d[0];
        return new wq5(this.f43510a, zl1, zl12.mo50975a(zl13), new zl1[]{zl13});
    }
}
