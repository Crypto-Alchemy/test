...
public abstract class j07 {
    ...
    /* renamed from: j07$a */
    /* compiled from: TypeDeserializer */
    public static /* synthetic */ class C2581a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f13475a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f13475a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f13475a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f13475a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p000.j07.C2581a.<clinit>():void");
        }
    }
    ...
    public abstract r07 getTypeIdResolver();
    ...
    public static Object deserializeIfNatural(JsonParser jsonParser, DeserializationContext deserializationContext, Class<?> cls) throws IOException {
        ...
        int i = C2581a.f13475a[g.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i != 4) {
