...
/* renamed from: hc6 */
/* compiled from: SubTypeValidator */
public class hc6 {

    /* renamed from: b */
    public static final Set<String> f12819b;

    /* renamed from: c */
    public static final hc6 f12820c = new hc6();

    /* renamed from: a */
    public Set<String> f12821a = f12819b;
    ...
    static {
        ...
        f12819b = Collections.unmodifiableSet(hashSet);
    }

    /* renamed from: a */
    public static hc6 m18781a() {
        return f12820c;
    }

    /* renamed from: b */
    public void mo21088b(DeserializationContext deserializationContext, JavaType javaType, n00 n00) throws JsonMappingException {
        Class rawClass = javaType.getRawClass();
        String name = rawClass.getName();
        if (!this.f12821a.contains(name)) {
        ...
        deserializationContext.reportBadTypeDefinition(n00, "Illegal type (%s) to deserialize: prevented for security reasons", name);
    }
}
