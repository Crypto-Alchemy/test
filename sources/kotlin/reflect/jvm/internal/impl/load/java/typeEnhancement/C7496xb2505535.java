...
public final class C7496xb2505535 extends Lambda implements rc2<s16.C9297a.C9298a, r37> {
    public final /* synthetic */ String $JLObject;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C7496xb2505535(String str) {
        super(1);
        this.$JLObject = str;
    }
    ...
    public final void invoke(s16.C9297a.C9298a aVar) {
        ...
        aVar.mo65801c(this.$JLObject, PredefinedEnhancementInfoKt.f39581c);
    }
}
