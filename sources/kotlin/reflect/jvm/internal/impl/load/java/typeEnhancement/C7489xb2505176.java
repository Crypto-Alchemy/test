...
public final class C7489xb2505176 extends Lambda implements rc2<s16.C9297a.C9298a, r37> {
    public final /* synthetic */ String $JFBiFunction;
    public final /* synthetic */ String $JLObject;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C7489xb2505176(String str, String str2) {
        super(1);
        this.$JLObject = str;
    ...
    public final void invoke(s16.C9297a.C9298a aVar) {
        ...
        aVar.mo65800b(this.$JFBiFunction, PredefinedEnhancementInfoKt.f39580b, PredefinedEnhancementInfoKt.f39580b, PredefinedEnhancementInfoKt.f39579a, PredefinedEnhancementInfoKt.f39579a);
