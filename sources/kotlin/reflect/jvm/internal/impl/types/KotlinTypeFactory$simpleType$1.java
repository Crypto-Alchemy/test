...
public final class KotlinTypeFactory$simpleType$1 extends Lambda implements rc2<bd3, d36> {
    ...
    public KotlinTypeFactory$simpleType$1(yz6 yz6, List<? extends f17> list, rz6 rz6, boolean z) {
        super(1);
    ...
    public final d36 invoke(bd3 bd3) {
        ...
        yz6 b = a.mo55311b();
        vx2.m53588d(b);
        return KotlinTypeFactory.m62852h(rz6, b, this.$arguments, this.$nullable, bd3);
    }
}
