...
public final class MemberDeserializer$loadProperty$5 extends Lambda implements pc2<gc4<? extends fq0<?>>> {
    ...
    public MemberDeserializer$loadProperty$5(MemberDeserializer memberDeserializer, ProtoBuf$Property protoBuf$Property, xd1 xd1) {
        super(0);
    ...
    public final gc4<fq0<?>> invoke() {
        ...
        return h.mo51162g(new pc2<fq0<?>>() {
            public final fq0<?> invoke() {
                ...
                return d.mo53762j(a, protoBuf$Property, returnType);
            }
        });
    }
}
