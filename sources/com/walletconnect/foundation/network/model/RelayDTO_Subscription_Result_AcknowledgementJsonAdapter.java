...
@Metadata(mo44875bv = {}, mo44876d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u001f\u001a\u00020\u001e¢\u0006\u0004\b \u0010!J\b\u0010\u0004\u001a\u00020\u0003H\u0016J\u0010\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005H\u0016J\u001a\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\b2\b\u0010\n\u001a\u0004\u0018\u00010\u0002H\u0016R\u0014\u0010\u0010\u001a\u00020\r8\u0002X\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00110\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00030\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0013R\u001a\u0010\u0019\u001a\b\u0012\u0004\u0012\u00020\u00170\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0018\u0010\u0013R\u001e\u0010\u001d\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u001a8\u0002@\u0002X\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u001c¨\u0006\""}, mo44877d2 = {"Lcom/walletconnect/foundation/network/model/RelayDTO_Subscription_Result_AcknowledgementJsonAdapter;", "Lcom/squareup/moshi/d;", "Lcom/walletconnect/foundation/network/model/RelayDTO$Subscription$Result$Acknowledgement;", "", "toString", "Lcom/squareup/moshi/JsonReader;", "reader", "k", "Lq73;", "writer", "value_", "Lr37;", "l", "Lcom/squareup/moshi/JsonReader$b;", "a", "Lcom/squareup/moshi/JsonReader$b;", "options", "", "b", "Lcom/squareup/moshi/d;", "longAdapter", "c", "stringAdapter", "", "d", "booleanAdapter", "Ljava/lang/reflect/Constructor;", "e", "Ljava/lang/reflect/Constructor;", "constructorRef", "Lcom/squareup/moshi/h;", "moshi", "<init>", "(Lcom/squareup/moshi/h;)V", "foundation"}, mo44878k = 1, mo44879mv = {1, 7, 1})
/* compiled from: RelayDTO_Subscription_Result_AcknowledgementJsonAdapter.kt */
public final class RelayDTO_Subscription_Result_AcknowledgementJsonAdapter extends C5391d<RelayDTO$Subscription$Result$Acknowledgement> {

    /* renamed from: a */
    public final JsonReader.C5372b f27486a;

    /* renamed from: b */
    public final C5391d<Long> f27487b;

    /* renamed from: c */
    public final C5391d<String> f27488c;

    /* renamed from: d */
    public final C5391d<Boolean> f27489d;

    /* renamed from: e */
    public volatile Constructor<RelayDTO$Subscription$Result$Acknowledgement> f27490e;

    public RelayDTO_Subscription_Result_AcknowledgementJsonAdapter(C5401h hVar) {
    ...
    /* renamed from: k */
    public RelayDTO$Subscription$Result$Acknowledgement mo39346b(JsonReader jsonReader) {
        ...
        while (jsonReader.mo39280f()) {
            int z = jsonReader2.mo39295z(this.f27486a);
            if (z == -1) {
                jsonReader.mo39272I();
                jsonReader.mo39273J();
            } else if (z == 0) {
                l = this.f27487b.mo39346b(jsonReader2);
                if (l == null) {
                ...
                str = this.f27488c.mo39346b(jsonReader2);
                if (str != null) {
                    i &= -3;
                } else {
            ...
            } else if (z == 2 && (bool = this.f27489d.mo39346b(jsonReader2)) == null) {
        ...
        jsonReader.mo39278d();
        if (i != -3) {
            Constructor<RelayDTO$Subscription$Result$Acknowledgement> constructor = this.f27490e;
            if (constructor == null) {
                constructor = RelayDTO$Subscription$Result$Acknowledgement.class.getDeclaredConstructor(new Class[]{Long.TYPE, String.class, Boolean.TYPE, Integer.TYPE, t67.f34130c});
                this.f27490e = constructor;
    ...
    /* renamed from: l */
    public void mo39347j(q73 q73, RelayDTO$Subscription$Result$Acknowledgement relayDTO$Subscription$Result$Acknowledgement) {
        vx2.m53591g(q73, "writer");
        if (relayDTO$Subscription$Result$Acknowledgement != null) {
            q73.mo39394c();
            q73.mo39399j("id");
            this.f27487b.mo39347j(q73, Long.valueOf(relayDTO$Subscription$Result$Acknowledgement.mo40871a()));
            q73.mo39399j("jsonrpc");
            this.f27488c.mo39347j(q73, relayDTO$Subscription$Result$Acknowledgement.mo40872b());
            q73.mo39399j("result");
            this.f27489d.mo39347j(q73, Boolean.valueOf(relayDTO$Subscription$Result$Acknowledgement.mo40873c()));
            q73.mo39398g();
            return;
        }
    ...
    public String toString() {
        ...
        sb.append("RelayDTO.Subscription.Result.Acknowledgement");
        sb.append(')');
