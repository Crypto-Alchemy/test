...
@Metadata(mo44875bv = {}, mo44876d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u001f\u001a\u00020\u001e¢\u0006\u0004\b \u0010!J\b\u0010\u0004\u001a\u00020\u0003H\u0016J\u0010\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005H\u0016J\u001a\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\b2\b\u0010\n\u001a\u0004\u0018\u00010\u0002H\u0016R\u0014\u0010\u0010\u001a\u00020\r8\u0002X\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00030\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R\u001a\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00140\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0012R\u001a\u0010\u0019\u001a\b\u0012\u0004\u0012\u00020\u00170\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0018\u0010\u0012R\u001e\u0010\u001d\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u001a8\u0002@\u0002X\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u001c¨\u0006\""}, mo44877d2 = {"Lcom/walletconnect/foundation/network/model/RelayDTO_Unsubscribe_Result_JsonRpcErrorJsonAdapter;", "Lcom/squareup/moshi/d;", "Lcom/walletconnect/foundation/network/model/RelayDTO$Unsubscribe$Result$JsonRpcError;", "", "toString", "Lcom/squareup/moshi/JsonReader;", "reader", "k", "Lq73;", "writer", "value_", "Lr37;", "l", "Lcom/squareup/moshi/JsonReader$b;", "a", "Lcom/squareup/moshi/JsonReader$b;", "options", "b", "Lcom/squareup/moshi/d;", "stringAdapter", "Lcom/walletconnect/foundation/network/model/RelayDTO$Error;", "c", "errorAdapter", "", "d", "longAdapter", "Ljava/lang/reflect/Constructor;", "e", "Ljava/lang/reflect/Constructor;", "constructorRef", "Lcom/squareup/moshi/h;", "moshi", "<init>", "(Lcom/squareup/moshi/h;)V", "foundation"}, mo44878k = 1, mo44879mv = {1, 7, 1})
/* compiled from: RelayDTO_Unsubscribe_Result_JsonRpcErrorJsonAdapter.kt */
public final class RelayDTO_Unsubscribe_Result_JsonRpcErrorJsonAdapter extends C5391d<RelayDTO.Unsubscribe.Result.JsonRpcError> {

    /* renamed from: a */
    public final JsonReader.C5372b f27509a;

    /* renamed from: b */
    public final C5391d<String> f27510b;

    /* renamed from: c */
    public final C5391d<RelayDTO.Error> f27511c;

    /* renamed from: d */
    public final C5391d<Long> f27512d;

    /* renamed from: e */
    public volatile Constructor<RelayDTO.Unsubscribe.Result.JsonRpcError> f27513e;

    public RelayDTO_Unsubscribe_Result_JsonRpcErrorJsonAdapter(C5401h hVar) {
    ...
    /* renamed from: k */
    public RelayDTO.Unsubscribe.Result.JsonRpcError mo39346b(JsonReader jsonReader) {
        ...
        while (jsonReader.mo39280f()) {
            int z = jsonReader2.mo39295z(this.f27509a);
            if (z == -1) {
                jsonReader.mo39272I();
                jsonReader.mo39273J();
            } else if (z == 0) {
                str = this.f27510b.mo39346b(jsonReader2);
                if (str != null) {
                    i &= -2;
                } else {
        ...
        if (i == -2) {
            ...
            if (error == null) {
                ...
                return new RelayDTO.Unsubscribe.Result.JsonRpcError(str, error, l.longValue());
            } else {
            ...
            Constructor<RelayDTO.Unsubscribe.Result.JsonRpcError> constructor = this.f27513e;
            if (constructor == null) {
                constructor = RelayDTO.Unsubscribe.Result.JsonRpcError.class.getDeclaredConstructor(new Class[]{String.class, RelayDTO.Error.class, Long.TYPE, Integer.TYPE, t67.f34130c});
                this.f27513e = constructor;
    ...
    /* renamed from: l */
    public void mo39347j(q73 q73, RelayDTO.Unsubscribe.Result.JsonRpcError jsonRpcError) {
        vx2.m53591g(q73, "writer");
        if (jsonRpcError != null) {
            q73.mo39394c();
            q73.mo39399j("jsonrpc");
            this.f27510b.mo39347j(q73, jsonRpcError.mo40866c());
            q73.mo39399j("error");
            this.f27511c.mo39347j(q73, jsonRpcError.mo40864a());
            q73.mo39399j("id");
            this.f27512d.mo39347j(q73, Long.valueOf(jsonRpcError.mo40865b()));
            q73.mo39398g();
            return;
        }
    ...
    public String toString() {
        ...
        sb.append("RelayDTO.Unsubscribe.Result.JsonRpcError");
        sb.append(')');
