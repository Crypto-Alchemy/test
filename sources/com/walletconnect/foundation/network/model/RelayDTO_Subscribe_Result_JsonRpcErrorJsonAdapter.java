...
public final class RelayDTO_Subscribe_Result_JsonRpcErrorJsonAdapter extends C5391d<RelayDTO.Subscribe.Result.JsonRpcError> {
    ...
    /* renamed from: k */
    public RelayDTO.Subscribe.Result.JsonRpcError mo39346b(JsonReader jsonReader) {
        ...
        while (jsonReader.mo39280f()) {
            int z = jsonReader2.mo39295z(this.f27470a);
            if (z == -1) {
                jsonReader.mo39272I();
                jsonReader.mo39273J();
            } else if (z == 0) {
                str = this.f27471b.mo39346b(jsonReader2);
                if (str != null) {
                    i &= -2;
                } else {
        ...
        if (i == -2) {
            ...
            if (error == null) {
                ...
                return new RelayDTO.Subscribe.Result.JsonRpcError(str, error, l.longValue());
            } else {
            ...
            Constructor<RelayDTO.Subscribe.Result.JsonRpcError> constructor = this.f27474e;
            if (constructor == null) {
                constructor = RelayDTO.Subscribe.Result.JsonRpcError.class.getDeclaredConstructor(new Class[]{String.class, RelayDTO.Error.class, Long.TYPE, Integer.TYPE, t67.f34130c});
                this.f27474e = constructor;
    ...
    /* renamed from: l */
    public void mo39347j(q73 q73, RelayDTO.Subscribe.Result.JsonRpcError jsonRpcError) {
        vx2.m53591g(q73, "writer");
        if (jsonRpcError != null) {
            q73.mo39394c();
            q73.mo39399j("jsonrpc");
            this.f27471b.mo39347j(q73, jsonRpcError.mo40818c());
            q73.mo39399j("error");
            this.f27472c.mo39347j(q73, jsonRpcError.mo40816a());
            q73.mo39399j("id");
            this.f27473d.mo39347j(q73, Long.valueOf(jsonRpcError.mo40817b()));
            q73.mo39398g();
            return;
        }
    ...
    public String toString() {
        ...
        sb.append("RelayDTO.Subscribe.Result.JsonRpcError");
        sb.append(')');
