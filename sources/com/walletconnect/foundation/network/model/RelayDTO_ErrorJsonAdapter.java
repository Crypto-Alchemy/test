...
@Metadata(mo44875bv = {}, mo44876d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0018\u001a\u00020\u0017¢\u0006\u0004\b\u0019\u0010\u001aJ\b\u0010\u0004\u001a\u00020\u0003H\u0016J\u0010\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005H\u0016J\u001a\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\b2\b\u0010\n\u001a\u0004\u0018\u00010\u0002H\u0016R\u0014\u0010\u0010\u001a\u00020\r8\u0002X\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00110\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00030\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0013¨\u0006\u001b"}, mo44877d2 = {"Lcom/walletconnect/foundation/network/model/RelayDTO_ErrorJsonAdapter;", "Lcom/squareup/moshi/d;", "Lcom/walletconnect/foundation/network/model/RelayDTO$Error;", "", "toString", "Lcom/squareup/moshi/JsonReader;", "reader", "k", "Lq73;", "writer", "value_", "Lr37;", "l", "Lcom/squareup/moshi/JsonReader$b;", "a", "Lcom/squareup/moshi/JsonReader$b;", "options", "", "b", "Lcom/squareup/moshi/d;", "longAdapter", "c", "stringAdapter", "Lcom/squareup/moshi/h;", "moshi", "<init>", "(Lcom/squareup/moshi/h;)V", "foundation"}, mo44878k = 1, mo44879mv = {1, 7, 1})
/* compiled from: RelayDTO_ErrorJsonAdapter.kt */
public final class RelayDTO_ErrorJsonAdapter extends C5391d<RelayDTO.Error> {

    /* renamed from: a */
    public final JsonReader.C5372b f27434a;

    /* renamed from: b */
    public final C5391d<Long> f27435b;

    /* renamed from: c */
    public final C5391d<String> f27436c;

    public RelayDTO_ErrorJsonAdapter(C5401h hVar) {
    ...
    /* renamed from: k */
    public RelayDTO.Error mo39346b(JsonReader jsonReader) {
        vx2.m53591g(jsonReader, "reader");
        jsonReader.mo39276b();
        Long l = null;
        String str = null;
        while (jsonReader.mo39280f()) {
            int z = jsonReader.mo39295z(this.f27434a);
            if (z == -1) {
                jsonReader.mo39272I();
                jsonReader.mo39273J();
            } else if (z == 0) {
                l = this.f27435b.mo39346b(jsonReader);
                if (l == null) {
                    JsonDataException v = t67.m52121v("code", "code", jsonReader);
                    vx2.m53590f(v, "unexpectedNull(\"code\", \"code\",\n            reader)");
                    throw v;
                }
            } else if (z == 1 && (str = this.f27436c.mo39346b(jsonReader)) == null) {
    ...
    /* renamed from: l */
    public void mo39347j(q73 q73, RelayDTO.Error error) {
        vx2.m53591g(q73, "writer");
        if (error != null) {
            q73.mo39394c();
            q73.mo39399j("code");
            this.f27435b.mo39347j(q73, Long.valueOf(error.mo40758a()));
            q73.mo39399j(ThrowableDeserializer.PROP_NAME_MESSAGE);
            this.f27436c.mo39347j(q73, error.mo40760c());
            q73.mo39398g();
            return;
        }
