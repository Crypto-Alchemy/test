...
/* renamed from: com.walletconnect.sign.sdk.NamespaceExtensionDaoQueriesImpl$getNamespaceExtensionByNamespaceKeyAndSessionId$1 */
/* compiled from: SignDatabaseImpl.kt */
public final class C5682x5d1d6ed0 extends Lambda implements rc2<l76, T> {
    ...
    public C5682x5d1d6ed0(id2<? super List<String>, ? super List<String>, ? super List<String>, ? extends T> id2, NamespaceExtensionDaoQueriesImpl namespaceExtensionDaoQueriesImpl) {
        super(1);
        this.$mapper = id2;
    ...
    public final T invoke(l76 l76) {
        ...
        hl0<List<String>, String> a = this.this$0.f27778d.mo42471k0().mo41813a();
        String string = l76.getString(0);
        vx2.m53588d(string);
        List<String> b = a.mo40237b(string);
        hl0<List<String>, String> c = this.this$0.f27778d.mo42471k0().mo41815c();
        String string2 = l76.getString(1);
        vx2.m53588d(string2);
        List<String> b2 = c.mo40237b(string2);
        hl0<List<String>, String> b3 = this.this$0.f27778d.mo42471k0().mo41814b();
