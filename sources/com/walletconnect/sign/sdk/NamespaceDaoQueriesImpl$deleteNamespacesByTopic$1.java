...
public final class NamespaceDaoQueriesImpl$deleteNamespacesByTopic$1 extends Lambda implements rc2<o76, r37> {
    public final /* synthetic */ String $topic;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NamespaceDaoQueriesImpl$deleteNamespacesByTopic$1(String str) {
        super(1);
        this.$topic = str;
    }
