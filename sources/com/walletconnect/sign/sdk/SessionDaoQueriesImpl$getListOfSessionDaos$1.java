...
public final class SessionDaoQueriesImpl$getListOfSessionDaos$1 extends Lambda implements rc2<l76, T> {
    public final /* synthetic */ rd2<Long, String, Long, String, String, String, String, String, Boolean, T> $mapper;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SessionDaoQueriesImpl$getListOfSessionDaos$1(rd2<? super Long, ? super String, ? super Long, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? extends T> rd2) {
        super(1);
        this.$mapper = rd2;
    }
