...
public final class NamespaceDaoQueriesImpl$getNamespaces$1 extends Lambda implements rc2<l76, T> {
    ...
    public NamespaceDaoQueriesImpl$getNamespaces$1(kd2<? super String, ? super List<String>, ? super List<String>, ? super List<String>, ? extends T> kd2, NamespaceDaoQueriesImpl namespaceDaoQueriesImpl) {
        super(1);
        this.$mapper = kd2;
    ...
    public final T invoke(l76 l76) {
        ...
        vx2.m53588d(string);
        hl0<List<String>, String> a = this.this$0.f27769d.mo42468h0().mo28800a();
        String string2 = l76.getString(1);
        vx2.m53588d(string2);
        List<String> b = a.mo40237b(string2);
        hl0<List<String>, String> c = this.this$0.f27769d.mo42468h0().mo28802c();
        String string3 = l76.getString(2);
        vx2.m53588d(string3);
        List<String> b2 = c.mo40237b(string3);
        hl0<List<String>, String> b3 = this.this$0.f27769d.mo42468h0().mo28801b();
