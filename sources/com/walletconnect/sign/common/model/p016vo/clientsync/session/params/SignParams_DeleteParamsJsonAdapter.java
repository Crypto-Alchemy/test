...
@Metadata(mo44875bv = {}, mo44876d1 = {"\u0000H\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u001c\u001a\u00020\u001b¢\u0006\u0004\b\u001d\u0010\u001eJ\b\u0010\u0004\u001a\u00020\u0003H\u0016J\u0010\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005H\u0016J\u001a\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\b2\b\u0010\n\u001a\u0004\u0018\u00010\u0002H\u0016R\u0014\u0010\u0010\u001a\u00020\r8\u0002X\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00110\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00030\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0013R\u001e\u0010\u001a\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u00178\u0002@\u0002X\u000e¢\u0006\u0006\n\u0004\b\u0018\u0010\u0019¨\u0006\u001f"}, mo44877d2 = {"Lcom/walletconnect/sign/common/model/vo/clientsync/session/params/SignParams_DeleteParamsJsonAdapter;", "Lcom/squareup/moshi/d;", "Lcom/walletconnect/sign/common/model/vo/clientsync/session/params/SignParams$DeleteParams;", "", "toString", "Lcom/squareup/moshi/JsonReader;", "reader", "k", "Lq73;", "writer", "value_", "Lr37;", "l", "Lcom/squareup/moshi/JsonReader$b;", "a", "Lcom/squareup/moshi/JsonReader$b;", "options", "", "b", "Lcom/squareup/moshi/d;", "intAdapter", "c", "stringAdapter", "Ljava/lang/reflect/Constructor;", "d", "Ljava/lang/reflect/Constructor;", "constructorRef", "Lcom/squareup/moshi/h;", "moshi", "<init>", "(Lcom/squareup/moshi/h;)V", "sdk_release"}, mo44878k = 1, mo44879mv = {1, 7, 1})
/* renamed from: com.walletconnect.sign.common.model.vo.clientsync.session.params.SignParams_DeleteParamsJsonAdapter */
/* compiled from: SignParams_DeleteParamsJsonAdapter.kt */
public final class SignParams_DeleteParamsJsonAdapter extends C5391d<SignParams.DeleteParams> {

    /* renamed from: a */
    public final JsonReader.C5372b f27633a;

    /* renamed from: b */
    public final C5391d<Integer> f27634b;

    /* renamed from: c */
    public final C5391d<String> f27635c;

    /* renamed from: d */
    public volatile Constructor<SignParams.DeleteParams> f27636d;

    public SignParams_DeleteParamsJsonAdapter(C5401h hVar) {
    ...
    /* renamed from: k */
    public SignParams.DeleteParams mo39346b(JsonReader jsonReader) {
        ...
        while (jsonReader.mo39280f()) {
            int z = jsonReader.mo39295z(this.f27633a);
            if (z == -1) {
                jsonReader.mo39272I();
                jsonReader.mo39273J();
            } else if (z == 0) {
                num = this.f27634b.mo39346b(jsonReader);
                if (num != null) {
                    i &= -2;
                } else {
            ...
            } else if (z == 1 && (str = this.f27635c.mo39346b(jsonReader)) == null) {
        ...
        Constructor<SignParams.DeleteParams> constructor = this.f27636d;
        if (constructor == null) {
            Class cls = Integer.TYPE;
            constructor = SignParams.DeleteParams.class.getDeclaredConstructor(new Class[]{cls, String.class, cls, t67.f34130c});
            this.f27636d = constructor;
            vx2.m53590f(constructor, "SignParams.DeleteParams:…his.constructorRef = it }");
        }
    ...
    /* renamed from: l */
    public void mo39347j(q73 q73, SignParams.DeleteParams deleteParams) {
        vx2.m53591g(q73, "writer");
        if (deleteParams != null) {
            q73.mo39394c();
            q73.mo39399j("code");
            this.f27634b.mo39347j(q73, Integer.valueOf(deleteParams.mo41115a()));
            q73.mo39399j(ThrowableDeserializer.PROP_NAME_MESSAGE);
            this.f27635c.mo39347j(q73, deleteParams.mo41116b());
            q73.mo39398g();
            return;
        }
