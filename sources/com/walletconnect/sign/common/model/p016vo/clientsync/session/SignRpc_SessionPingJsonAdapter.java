...
@Metadata(mo44875bv = {}, mo44876d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u001f\u001a\u00020\u001e¢\u0006\u0004\b \u0010!J\b\u0010\u0004\u001a\u00020\u0003H\u0016J\u0010\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005H\u0016J\u001a\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\b2\b\u0010\n\u001a\u0004\u0018\u00010\u0002H\u0016R\u0014\u0010\u0010\u001a\u00020\r8\u0002X\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00110\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00030\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0015\u0010\u0013R\u001a\u0010\u0019\u001a\b\u0012\u0004\u0012\u00020\u00170\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0018\u0010\u0013R\u001e\u0010\u001d\u001a\n\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u001a8\u0002@\u0002X\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u001c¨\u0006\""}, mo44877d2 = {"Lcom/walletconnect/sign/common/model/vo/clientsync/session/SignRpc_SessionPingJsonAdapter;", "Lcom/squareup/moshi/d;", "Lcom/walletconnect/sign/common/model/vo/clientsync/session/SignRpc$SessionPing;", "", "toString", "Lcom/squareup/moshi/JsonReader;", "reader", "k", "Lq73;", "writer", "value_", "Lr37;", "l", "Lcom/squareup/moshi/JsonReader$b;", "a", "Lcom/squareup/moshi/JsonReader$b;", "options", "", "b", "Lcom/squareup/moshi/d;", "longAdapter", "c", "stringAdapter", "Lcom/walletconnect/sign/common/model/vo/clientsync/session/params/SignParams$a;", "d", "pingParamsAdapter", "Ljava/lang/reflect/Constructor;", "e", "Ljava/lang/reflect/Constructor;", "constructorRef", "Lcom/squareup/moshi/h;", "moshi", "<init>", "(Lcom/squareup/moshi/h;)V", "sdk_release"}, mo44878k = 1, mo44879mv = {1, 7, 1})
/* renamed from: com.walletconnect.sign.common.model.vo.clientsync.session.SignRpc_SessionPingJsonAdapter */
/* compiled from: SignRpc_SessionPingJsonAdapter.kt */
public final class SignRpc_SessionPingJsonAdapter extends C5391d<SignRpc.SessionPing> {

    /* renamed from: a */
    public final JsonReader.C5372b f27593a;

    /* renamed from: b */
    public final C5391d<Long> f27594b;

    /* renamed from: c */
    public final C5391d<String> f27595c;

    /* renamed from: d */
    public final C5391d<SignParams.C5625a> f27596d;

    /* renamed from: e */
    public volatile Constructor<SignRpc.SessionPing> f27597e;

    public SignRpc_SessionPingJsonAdapter(C5401h hVar) {
        ...
        this.f27595c = f2;
        C5391d<SignParams.C5625a> f3 = hVar.mo39411f(SignParams.C5625a.class, ny5.m49095e(), "params");
        vx2.m53590f(f3, "moshi.adapter(SignParams…va, emptySet(), \"params\")");
        this.f27596d = f3;
    }

    /* renamed from: k */
    public SignRpc.SessionPing mo39346b(JsonReader jsonReader) {
        ...
        String str = null;
        String str2 = null;
        SignParams.C5625a aVar = null;
        while (jsonReader.mo39280f()) {
            int z = jsonReader2.mo39295z(this.f27593a);
            if (z == -1) {
                jsonReader.mo39272I();
                jsonReader.mo39273J();
            } else if (z == 0) {
                l = this.f27594b.mo39346b(jsonReader2);
                if (l == null) {
                ...
                str = this.f27595c.mo39346b(jsonReader2);
                if (str != null) {
                    i &= -3;
                } else {
                ...
                str2 = this.f27595c.mo39346b(jsonReader2);
                if (str2 != null) {
                    i &= -5;
                } else {
            ...
            } else if (z == 3 && (aVar = this.f27596d.mo39346b(jsonReader2)) == null) {
        ...
        jsonReader.mo39278d();
        if (i != -7) {
            Constructor<SignRpc.SessionPing> constructor = this.f27597e;
            if (constructor == null) {
                constructor = SignRpc.SessionPing.class.getDeclaredConstructor(new Class[]{Long.TYPE, cls, cls, SignParams.C5625a.class, Integer.TYPE, t67.f34130c});
                this.f27597e = constructor;
                vx2.m53590f(constructor, "SignRpc.SessionPing::cla…his.constructorRef = it }");
            }
    ...
    /* renamed from: l */
    public void mo39347j(q73 q73, SignRpc.SessionPing sessionPing) {
        vx2.m53591g(q73, "writer");
        if (sessionPing != null) {
            q73.mo39394c();
            q73.mo39399j("id");
            this.f27594b.mo39347j(q73, Long.valueOf(sessionPing.getId()));
            q73.mo39399j("jsonrpc");
            this.f27595c.mo39347j(q73, sessionPing.mo41061a());
            q73.mo39399j("method");
            this.f27595c.mo39347j(q73, sessionPing.getMethod());
            q73.mo39399j("params");
            this.f27596d.mo39347j(q73, sessionPing.getParams());
            q73.mo39398g();
            return;
        }
