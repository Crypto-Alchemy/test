...
public final class SignEngine$approve$sessionSettle$2 extends Lambda implements rc2<Throwable, r37> {
    public final /* synthetic */ rc2<Throwable, r37> $onFailure;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SignEngine$approve$sessionSettle$2(rc2<? super Throwable, r37> rc2) {
        super(1);
        this.$onFailure = rc2;
    }
