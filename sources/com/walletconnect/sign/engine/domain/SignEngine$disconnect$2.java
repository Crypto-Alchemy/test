...
public final class SignEngine$disconnect$2 extends Lambda implements rc2<Throwable, r37> {
    public final /* synthetic */ rc2<Throwable, r37> $onFailure;
    public final /* synthetic */ SignEngine this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public SignEngine$disconnect$2(SignEngine signEngine, rc2<? super Throwable, r37> rc2) {
        super(1);
    ...
    public final void invoke(Throwable th) {
        ...
        i.error("Sending session disconnect error: " + th);
