...
@Metadata(mo44875bv = {}, mo44876d1 = {"\u0000P\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u001c\u001a\u00020\u001b¢\u0006\u0004\b\u001d\u0010\u001eJ\b\u0010\u0004\u001a\u00020\u0003H\u0016J\u0010\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0005H\u0016J\u001a\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\b2\b\u0010\n\u001a\u0004\u0018\u00010\u0002H\u0016R\u0014\u0010\u0010\u001a\u00020\r8\u0002X\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0014\u001a\b\u0012\u0004\u0012\u00020\u00110\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u001a\u0010\u0017\u001a\b\u0012\u0004\u0012\u00020\u00150\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0016\u0010\u0013R\u001a\u0010\u001a\u001a\b\u0012\u0004\u0012\u00020\u00180\u00018\u0002X\u0004¢\u0006\u0006\n\u0004\b\u0019\u0010\u0013¨\u0006\u001f"}, mo44877d2 = {"Lcom/walletconnect/android/internal/common/cacao/CacaoJsonAdapter;", "Lcom/squareup/moshi/d;", "Lcom/walletconnect/android/internal/common/cacao/Cacao;", "", "toString", "Lcom/squareup/moshi/JsonReader;", "reader", "k", "Lq73;", "writer", "value_", "Lr37;", "l", "Lcom/squareup/moshi/JsonReader$b;", "a", "Lcom/squareup/moshi/JsonReader$b;", "options", "Lcom/walletconnect/android/internal/common/cacao/Cacao$Header;", "b", "Lcom/squareup/moshi/d;", "headerAdapter", "Lcom/walletconnect/android/internal/common/cacao/Cacao$Payload;", "c", "payloadAdapter", "Lcom/walletconnect/android/internal/common/cacao/Cacao$Signature;", "d", "signatureAdapter", "Lcom/squareup/moshi/h;", "moshi", "<init>", "(Lcom/squareup/moshi/h;)V", "sdk_release"}, mo44878k = 1, mo44879mv = {1, 7, 1})
/* compiled from: CacaoJsonAdapter.kt */
public final class CacaoJsonAdapter extends C5391d<Cacao> {

    /* renamed from: a */
    public final JsonReader.C5372b f27086a;

    /* renamed from: b */
    public final C5391d<Cacao.Header> f27087b;

    /* renamed from: c */
    public final C5391d<Cacao.Payload> f27088c;

    /* renamed from: d */
    public final C5391d<Cacao.Signature> f27089d;

    public CacaoJsonAdapter(C5401h hVar) {
    ...
    /* renamed from: k */
    public Cacao mo39346b(JsonReader jsonReader) {
        ...
        while (jsonReader.mo39280f()) {
            int z = jsonReader.mo39295z(this.f27086a);
            if (z == -1) {
                jsonReader.mo39272I();
                jsonReader.mo39273J();
            } else if (z == 0) {
                header = this.f27087b.mo39346b(jsonReader);
                if (header == null) {
                ...
                payload = this.f27088c.mo39346b(jsonReader);
                if (payload == null) {
                    JsonDataException v2 = t67.m52121v("payload", "p", jsonReader);
                    vx2.m53590f(v2, "unexpectedNull(\"payload\", \"p\",\n            reader)");
                    throw v2;
                }
            } else if (z == 2 && (signature = this.f27089d.mo39346b(jsonReader)) == null) {
    ...
    /* renamed from: l */
    public void mo39347j(q73 q73, Cacao cacao) {
        vx2.m53591g(q73, "writer");
        if (cacao != null) {
            q73.mo39394c();
            q73.mo39399j("h");
            this.f27087b.mo39347j(q73, cacao.mo40183a());
            q73.mo39399j("p");
            this.f27088c.mo39347j(q73, cacao.mo40184b());
            q73.mo39399j("s");
            this.f27089d.mo39347j(q73, cacao.mo40185c());
            q73.mo39398g();
            return;
        }
