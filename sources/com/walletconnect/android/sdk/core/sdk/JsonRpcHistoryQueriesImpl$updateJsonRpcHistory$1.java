...
public final class JsonRpcHistoryQueriesImpl$updateJsonRpcHistory$1 extends Lambda implements rc2<o76, r37> {
    ...
    public final void invoke(o76 o76) {
        ...
        o76.bindString(1, this.$response);
        o76.mo39608b(2, Long.valueOf(this.$request_id));
    }
}
