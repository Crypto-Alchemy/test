...
public final class PairingQueriesImpl$getListOfPairing$1 extends Lambda implements rc2<l76, T> {
    ...
    public PairingQueriesImpl$getListOfPairing$1(tc2<? super String, ? super Long, ? super String, ? super String, ? super String, ? super String, ? super Boolean, ? super String, ? super String, ? super String, ? super List<String>, ? super String, ? extends T> tc2, PairingQueriesImpl pairingQueriesImpl) {
        super(1);
        this.$mapper = tc2;
