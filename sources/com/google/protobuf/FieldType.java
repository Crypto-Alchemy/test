...
public enum FieldType {
    ...
    /* renamed from: a */
    public static final FieldType[] f25546a = null;

    /* renamed from: d */
    public static final Type[] f25547d = null;
    private final Collection collection;
    private final Class<?> elementType;

    /* renamed from: id */
    private final int f25549id;
    ...
    public static /* synthetic */ class C4929a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f25551a = null;

        /* renamed from: b */
        public static final /* synthetic */ int[] f25552b = null;
        ...
        static {
            ...
            L_0x0039:
                int[] r1 = f25551a     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                int[] r0 = f25551a     // Catch:{ NoSuchFieldError -> 0x004d }
            ...
            L_0x004d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.protobuf.FieldType.C4929a.<clinit>():void");
        }
    }
    ...
    static {
        ...
        f25546a = new FieldType[values.length];
        for (FieldType fieldType : values) {
            f25546a[fieldType.f25549id] = fieldType;
        }
    }

    /* access modifiers changed from: public */
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x002d, code lost:
        r5 = com.google.protobuf.FieldType.C4929a.f25552b[r6.ordinal()];
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    FieldType(int r4, com.google.protobuf.FieldType.Collection r5, com.google.protobuf.JavaType r6) {
        /*
            r1 = this;
            r1.<init>(r2, r3)
            r1.f25549id = r4
            r1.collection = r5
            r1.javaType = r6
            int[] r2 = com.google.protobuf.FieldType.C4929a.f25551a
            int r3 = r5.ordinal()
            r2 = r2[r3]
            r3 = 2
            r4 = 1
        ...
        L_0x0028:
            ...
            int[] r5 = com.google.protobuf.FieldType.C4929a.f25552b
            int r6 = r6.ordinal()
            r5 = r5[r6]
    ...
    /* renamed from: a */
    public static Type m38937a(Class<?> cls) {
    ...
    /* renamed from: d */
    public static Type m38938d(Class<?> cls, Type[] typeArr) {
    ...
    public static FieldType forId(int i) {
        ...
        FieldType[] fieldTypeArr = f25546a;
    ...
    /* renamed from: e */
    public final boolean mo36866e(Field field) {
        Class<?> type = field.getType();
        if (!this.javaType.getType().isAssignableFrom(type)) {
            return false;
        }
        Type[] typeArr = f25547d;
        if (field.getGenericType() instanceof ParameterizedType) {
            typeArr = ((ParameterizedType) field.getGenericType()).getActualTypeArguments();
        }
        Type d = m38938d(type, typeArr);
