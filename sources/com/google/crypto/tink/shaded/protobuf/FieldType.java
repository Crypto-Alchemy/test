...
public enum FieldType {
    ...
    /* renamed from: a */
    public static final FieldType[] f25094a = null;

    /* renamed from: d */
    public static final Type[] f25095d = null;
    private final Collection collection;
    private final Class<?> elementType;

    /* renamed from: id */
    private final int f25097id;
    ...
    public static /* synthetic */ class C4679a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f25099a = null;

        /* renamed from: b */
        public static final /* synthetic */ int[] f25100b = null;
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f25100b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f25100b     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0039:
                int[] r1 = f25099a     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                int[] r0 = f25099a     // Catch:{ NoSuchFieldError -> 0x004d }
            ...
            L_0x004d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.shaded.protobuf.FieldType.C4679a.<clinit>():void");
        }
    }
    ...
    static {
        ...
        f25094a = new FieldType[values.length];
        for (FieldType fieldType : values) {
            f25094a[fieldType.f25097id] = fieldType;
        }
    }

    /* access modifiers changed from: public */
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x002d, code lost:
        r5 = com.google.crypto.tink.shaded.protobuf.FieldType.C4679a.f25100b[r6.ordinal()];
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    FieldType(int r4, com.google.crypto.tink.shaded.protobuf.FieldType.Collection r5, com.google.crypto.tink.shaded.protobuf.JavaType r6) {
        /*
            r1 = this;
            r1.<init>(r2, r3)
            r1.f25097id = r4
            r1.collection = r5
            r1.javaType = r6
            int[] r2 = com.google.crypto.tink.shaded.protobuf.FieldType.C4679a.f25099a
            int r3 = r5.ordinal()
            r2 = r2[r3]
            r3 = 2
            r4 = 1
        ...
        L_0x0028:
            ...
            int[] r5 = com.google.crypto.tink.shaded.protobuf.FieldType.C4679a.f25100b
            int r6 = r6.ordinal()
            r5 = r5[r6]
    ...
    /* renamed from: a */
    public static Type m37313a(Class<?> cls) {
    ...
    /* renamed from: d */
    public static Type m37314d(Class<?> cls, Type[] typeArr) {
    ...
    public static FieldType forId(int i) {
        ...
        FieldType[] fieldTypeArr = f25094a;
    ...
    /* renamed from: e */
    public final boolean mo35430e(Field field) {
        Class<?> type = field.getType();
        if (!this.javaType.getType().isAssignableFrom(type)) {
            return false;
        }
        Type[] typeArr = f25095d;
        if (field.getGenericType() instanceof ParameterizedType) {
            typeArr = ((ParameterizedType) field.getGenericType()).getActualTypeArguments();
        }
        Type d = m37314d(type, typeArr);
