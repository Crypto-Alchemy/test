...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r2, com.google.gson.reflect.TypeToken<T> r3) {
            ...
            L_0x001f:
                ...
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C489128.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    public static /* synthetic */ class C489934 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C489934.<clinit>():void");
        }
    }
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            ...
            public java.util.BitSet read(com.google.gson.stream.JsonReader r8) throws java.io.IOException {
                ...
                L_0x000e:
                    ...
                    int[] r4 = com.google.gson.internal.bind.TypeAdapters.C489934.$SwitchMap$com$google$gson$stream$JsonToken
                    int r5 = r1.ordinal()
                    r4 = r4[r5]
                    r5 = 1
                ...
                L_0x0075:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C48822.read(com.google.gson.stream.JsonReader):java.util.BitSet");
            }
        ...
        C48933 r0 = new TypeAdapter<Boolean>() {
            public Boolean read(JsonReader jsonReader) throws IOException {
        ...
        C49015 r02 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C49026 r03 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C49037 r04 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() == JsonToken.NULL) {
                    jsonReader.nextNull();
                    return null;
        ...
        C487614 r05 = new TypeAdapter<Character>() {
        ...
        C487715 r06 = new TypeAdapter<String>() {
        ...
        C488018 r07 = new TypeAdapter<StringBuilder>() {
        ...
        C488119 r08 = new TypeAdapter<StringBuffer>() {
        ...
        C488320 r09 = new TypeAdapter<URL>() {
        ...
        C488421 r010 = new TypeAdapter<URI>() {
        ...
        C488522 r011 = new TypeAdapter<InetAddress>() {
        ...
        C488623 r012 = new TypeAdapter<UUID>() {
        ...
        C488825 r013 = new TypeAdapter<Calendar>() {
        ...
        C488926 r014 = new TypeAdapter<Locale>() {
        ...
        C489027 r015 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof JsonTreeReader) {
                    return ((JsonTreeReader) jsonReader).nextJsonElement();
                }
                switch (C489934.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
