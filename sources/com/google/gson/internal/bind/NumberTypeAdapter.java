...
public final class NumberTypeAdapter extends TypeAdapter<Number> {
    ...
    public static /* synthetic */ class C48662 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.NumberTypeAdapter.C48662.<clinit>():void");
        }
    }
    ...
    public Number read(JsonReader jsonReader) throws IOException {
        ...
        int i = C48662.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
        if (i == 1) {
            jsonReader.nextNull();
            return null;
        } else if (i == 2 || i == 3) {
