...
public final class C4066j extends C4065i {
    /* renamed from: a */
    public final int mo30786a(int i, byte[] bArr, int i2, int i3) {
        ...
        while (r9 < i3) {
            ...
            if (b < 0) {
                if (b < -32) {
                    ...
                    if (i4 >= i3 - 1) {
                        return C4064h.m33898j(bArr, i4, i3);
                    }
                    int i5 = i4 + 1;
                    byte b2 = bArr[i4];
    ...
    /* renamed from: b */
    public final int mo30787b(CharSequence charSequence, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char charAt;
    ...
    /* renamed from: c */
    public final void mo30788c(CharSequence charSequence, ByteBuffer byteBuffer) {
