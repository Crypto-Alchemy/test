...
public enum zzcb {
    ...
    /* renamed from: B1 */
    public static final zzcb[] f22503B1 = null;

    /* renamed from: C1 */
    public static final Type[] f22505C1 = null;
    ...
    static {
        ...
        f22505C1 = new Type[0];
        zzcb[] values = values();
        f22503B1 = new zzcb[values.length];
        for (zzcb zzcb : values) {
            f22503B1[zzcb.f22543id] = zzcb;
        }
    }
    ...
    zzcb(int i, zzcd zzcd, zzcq zzcq) {
        ...
        this.zziy = zzcd;
        this.zzix = zzcq;
        int i3 = C4055d.f22446a[zzcd.ordinal()];
        boolean z = true;
        this.zziz = (i3 == 1 || i3 == 2) ? zzcq.zzbq() : null;
        this.zzja = (zzcd != zzcd.SCALAR || (i2 = C4055d.f22447b[zzcq.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : z;
    }

    /* renamed from: id */
    public final int mo30857id() {
