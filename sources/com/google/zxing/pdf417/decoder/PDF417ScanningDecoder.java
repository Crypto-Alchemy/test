...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, FormatException, ChecksumException {
        ...
        while (true) {
            ...
            merge = merge(detectionResultRowIndicatorColumn, detectionResultRowIndicatorColumn2);
            if (merge != null) {
                ...
                if (!z3 || boundingBox2 == null || (boundingBox2.getMinY() >= boundingBox.getMinY() && boundingBox2.getMaxY() <= boundingBox.getMaxY())) {
                    ...
                    merge.setDetectionResultColumn(barcodeColumnCount, detectionResultRowIndicatorColumn2);
                } else {
                    z3 = false;
                }
            } else {
        ...
        merge.setDetectionResultColumn(0, detectionResultRowIndicatorColumn);
        merge.setDetectionResultColumn(barcodeColumnCount2, detectionResultRowIndicatorColumn2);
        ...
        int i8 = i;
        int i9 = i2;
        for (int i10 = 1; i10 <= barcodeColumnCount2; i10++) {
            if (z) {
                i3 = i10;
            } else {
            ...
            if (merge.getDetectionResultColumn(i3) == null) {
                if (i3 == 0 || i3 == barcodeColumnCount2) {
                    ...
                    detectionResultColumn = new DetectionResultRowIndicatorColumn(boundingBox, z2);
                } else {
                    detectionResultColumn = new DetectionResultColumn(boundingBox);
                }
                merge.setDetectionResultColumn(i3, detectionResultColumn);
                int i11 = -1;
                        ...
                        if (isValidBarcodeColumn(detectionResult, i)) {
                            for (Codeword codeword2 : detectionResult.getDetectionResultColumn(i).getCodewords()) {
                                if (codeword2 != null) {
                                    ...
                                    return i4 + (i3 * i6 * (codeword2.getEndX() - codeword2.getStartX()));
                                }
                            }
                            i6++;
                        } else {
