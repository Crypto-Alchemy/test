...
final class DecodedBitStreamParser {
    ...
    /* renamed from: AL */
    private static final int f25803AL = 28;

    /* renamed from: AS */
    private static final int f25804AS = 27;
    ...
    /* renamed from: LL */
    private static final int f25805LL = 27;
    ...
    /* renamed from: ML */
    private static final int f25806ML = 28;
    ...
    public static /* synthetic */ class C50441 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25809x45bba1d     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25809x45bba1d     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25809x45bba1d     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25809x45bba1d     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25809x45bba1d     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.pdf417.decoder.DecodedBitStreamParser.C50441.<clinit>():void");
        }
    }
    ...
    public static int decodeMacroBlock(int[] iArr, int i, PDF417ResultMetadata pDF417ResultMetadata) throws FormatException {
        ...
        if (i + 2 <= iArr[0]) {
            ...
            while (r9 < iArr[0] && r9 < iArr.length && (i3 = iArr[r9]) != MACRO_PDF417_TERMINATOR && i3 != BEGIN_MACRO_PDF417_OPTIONAL_FIELD) {
                sb.append(String.format("%03d", new Object[]{Integer.valueOf(i3)}));
                i = r9 + 1;
            }
            if (sb.length() != 0) {
                pDF417ResultMetadata.setFileId(sb.toString());
                if (iArr[r9] == BEGIN_MACRO_PDF417_OPTIONAL_FIELD) {
                    i2 = r9 + 1;
                } else {
                    i2 = -1;
                }
    ...
    private static com.google.zxing.pdf417.decoder.DecodedBitStreamParser.Mode decodeTextCompaction(int[] r15, int[] r16, int r17, com.google.zxing.common.ECIStringBuilder r18, com.google.zxing.pdf417.decoder.DecodedBitStreamParser.Mode r19) {
        ...
        L_0x000a:
            ...
            r7 = r15[r6]
            int[] r8 = com.google.zxing.pdf417.decoder.DecodedBitStreamParser.C50441.f25809x45bba1d
            int r9 = r3.ordinal()
            r8 = r8[r9]
            r9 = 32
            r10 = 29
