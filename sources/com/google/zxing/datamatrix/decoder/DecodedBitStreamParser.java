...
final class DecodedBitStreamParser {
    ...
    public static /* synthetic */ class C50381 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f25782xb73eb560     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f25782xb73eb560     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f25782xb73eb560     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f25782xb73eb560     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f25782xb73eb560     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.datamatrix.decoder.DecodedBitStreamParser.C50381.<clinit>():void");
        }
    }
    ...
    static {
        char[] cArr = {'!', JsonFactory.DEFAULT_QUOTE_CHAR, '#', DecodedChar.FNC1, '%', '&', '\'', '(', ')', '*', '+', ',', '-', '.', '/', ':', ';', '<', '=', '>', '?', '@', '[', '\\', ']', '^', '_'};
    ...
    public static com.google.zxing.common.DecoderResult decode(byte[] r13) throws com.google.zxing.FormatException {
        ...
        L_0x0027:
            ...
            goto L_0x0059
        L_0x0030:
            int[] r11 = com.google.zxing.datamatrix.decoder.DecodedBitStreamParser.C50381.f25782xb73eb560
            int r8 = r8.ordinal()
            r8 = r11[r8]
            switch(r8) {
                ...
                if (readBits <= 229) {
                    ...
                    switch (readBits) {
                        ...
                        case 235:
                            ...
                            break;
                        case 236:
                            eCIStringBuilder.append(HighLevelEncoder.MACRO_05_HEADER);
                            sb.insert(0, HighLevelEncoder.MACRO_TRAILER);
                            break;
                        case 237:
                            eCIStringBuilder.append(HighLevelEncoder.MACRO_06_HEADER);
                            sb.insert(0, HighLevelEncoder.MACRO_TRAILER);
                            break;
                        case 238:
    ...
    private static void decodeBase256Segment(BitSource bitSource, ECIStringBuilder eCIStringBuilder, Collection<byte[]> collection) throws FormatException {
        ...
        if (unrandomize255State == 0) {
            ...
            unrandomize255State = ((unrandomize255State - 249) * SQLiteDatabase.MAX_SQL_CACHE_SIZE) + unrandomize255State(bitSource.readBits(8), i);
            i++;
        }
        if (unrandomize255State >= 0) {
