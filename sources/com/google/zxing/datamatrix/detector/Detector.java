...
public final class Detector {
    ...
    private boolean isValid(ResultPoint resultPoint) {
        if (resultPoint.getX() < Utils.FLOAT_EPSILON || resultPoint.getX() > ((float) (this.image.getWidth() - 1)) || resultPoint.getY() <= Utils.FLOAT_EPSILON || resultPoint.getY() > ((float) (this.image.getHeight() - 1))) {
            return false;
        }
        return true;
    }
