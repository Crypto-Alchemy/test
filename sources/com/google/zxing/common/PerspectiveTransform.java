...
public final class PerspectiveTransform {
    ...
    public static PerspectiveTransform squareToQuadrilateral(float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8) {
        ...
        if (f9 == Utils.FLOAT_EPSILON && f10 == Utils.FLOAT_EPSILON) {
            return new PerspectiveTransform(f3 - f, f5 - f3, f, f4 - f2, f6 - f4, f2, Utils.FLOAT_EPSILON, Utils.FLOAT_EPSILON, 1.0f);
        }
        float f11 = f3 - f5;
        float f12 = f7 - f5;
        float f13 = f4 - f6;
