...
public final class Encoder {
    ...
    public static /* synthetic */ class C50561 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.encoder.Encoder.C50561.<clinit>():void");
        }
    }
    ...
    public static void appendBytes(String str, Mode mode, BitArray bitArray, Charset charset) throws WriterException {
        int i = C50561.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x013b, code lost:
        if (com.google.zxing.qrcode.encoder.QRCode.isValidMaskPattern(r8) != false) goto L_0x013f;
     */
