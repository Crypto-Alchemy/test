...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    public static final RegularImmutableSortedSet<Comparable> NATURAL_EMPTY_SET = new RegularImmutableSortedSet<>(ImmutableList.m36627of(), Ordering.natural());
    ...
    public boolean containsAll(Collection<?> collection) {
        ...
        if (!y56.m54626b(comparator(), collection) || collection.size() <= 1) {
    ...
    public boolean equals(java.lang.Object r6) {
        ...
        L_0x001e:
            ...
            boolean r1 = p000.y56.m54626b(r1, r6)
            if (r1 == 0) goto L_0x0047
            java.util.Iterator r6 = r6.iterator()
            c47 r1 = r5.iterator()     // Catch:{ ClassCastException | NoSuchElementException -> 0x0046 }
        L_0x002e:
    ...
    public int headIndex(E e, boolean z) {
        int binarySearch = Collections.binarySearch(this.elements, du4.m43691k(e), comparator());
        if (binarySearch < 0) {
            return ~binarySearch;
        }
        if (z) {
    ...
    /* renamed from: k */
    public final int mo35133k(Object obj) throws ClassCastException {
    ...
    public c47<E> descendingIterator() {
