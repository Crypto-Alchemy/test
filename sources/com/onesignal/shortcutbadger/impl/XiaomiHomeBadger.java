...
@Deprecated
public class XiaomiHomeBadger implements C5719cx {

    /* renamed from: a */
    public ResolveInfo f26537a;
    ...
    public void mo39107b(android.content.Context r5, android.content.ComponentName r6, int r7) throws com.onesignal.shortcutbadger.ShortcutBadgeException {
        /*
            r4 = this;
            java.lang.String r0 = ""
        ...
        L_0x0061:
            ...
            r1.putExtra(r0, r6)
            boolean r6 = p000.g40.m44510a(r5, r1)
        ...
        L_0x0080:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.onesignal.shortcutbadger.impl.XiaomiHomeBadger.mo39107b(android.content.Context, android.content.ComponentName, int):void");
    }

    @TargetApi(16)
    /* renamed from: c */
    public final void mo39115c(Context context, int i) throws ShortcutBadgeException {
        if (this.f26537a == null) {
            Intent intent = new Intent("android.intent.action.MAIN");
            intent.addCategory("android.intent.category.HOME");
            this.f26537a = context.getPackageManager().resolveActivity(intent, 65536);
        }
        if (this.f26537a != null) {
            NotificationManager notificationManager = (NotificationManager) context.getSystemService("notification");
            Notification build = new Notification.Builder(context).setContentTitle("").setContentText("").setSmallIcon(this.f26537a.getIconResource()).build();
            try {
