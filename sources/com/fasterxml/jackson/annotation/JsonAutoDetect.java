...
public @interface JsonAutoDetect {
    ...
    public static /* synthetic */ class C1969a {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f9791b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f9791b     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                r3 = 4
                int[] r4 = f9791b     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                r4 = 5
                int[] r5 = f9791b     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r5 = f9791b     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r5 = f9791b     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0065:
                int[] r1 = f9790a     // Catch:{ NoSuchFieldError -> 0x006f }
            ...
            L_0x006f:
                int[] r0 = f9790a     // Catch:{ NoSuchFieldError -> 0x0079 }
            ...
            L_0x0079:
                int[] r0 = f9790a     // Catch:{ NoSuchFieldError -> 0x0083 }
            ...
            L_0x0083:
                int[] r0 = f9790a     // Catch:{ NoSuchFieldError -> 0x008d }
            ...
            L_0x008d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.annotation.JsonAutoDetect.C1969a.<clinit>():void");
        }
    }
    ...
    public static class Value implements Serializable {
        ...
        /* renamed from: a */
        public static final Visibility f9788a;
        ...
        /* renamed from: a */
        public static boolean m13757a(Value value, Value value2) {
        ...
        /* renamed from: b */
        public static Value m13758b(Visibility visibility, Visibility visibility2, Visibility visibility3, Visibility visibility4, Visibility visibility5) {
            if (visibility == f9788a) {
                Value value = DEFAULT;
        ...
        public static Value construct(PropertyAccessor propertyAccessor, Visibility visibility) {
            ...
            int i = C1969a.f9791b[propertyAccessor.ordinal()];
            if (i != 1) {
                if (i == 2) {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj.getClass() != getClass() || !m13757a(this, (Value) obj)) {
                return false;
            }
            return true;
        }
        ...
        public Object readResolve() {
            Value b = m13758b(this._fieldVisibility, this._getterVisibility, this._isGetterVisibility, this._setterVisibility, this._creatorVisibility);
            if (b == null) {
                return this;
            }
            return b;
        ...
        public Value withOverrides(Value value) {
            if (value == null || value == NO_OVERRIDES || value == this || m13757a(this, value)) {
                return this;
            }
        ...
        public static Value construct(Visibility visibility, Visibility visibility2, Visibility visibility3, Visibility visibility4, Visibility visibility5) {
            Value b = m13758b(visibility, visibility2, visibility3, visibility4, visibility5);
            return b == null ? new Value(visibility, visibility2, visibility3, visibility4, visibility5) : b;
        }
    }
}
