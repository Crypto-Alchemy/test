...
public abstract class TokenStreamFactory implements Serializable {
    ...
    public abstract boolean canUseSchema(d82 d82);
    ...
    public abstract Class<? extends b82> getFormatReadFeatureType();

    public abstract Class<? extends b82> getFormatWriteFeatureType();
