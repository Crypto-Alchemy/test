...
public class SerializedString implements qw5, Serializable {

    /* renamed from: a */
    public static final a73 f9856a = a73.m98j();
    ...
    public int appendQuoted(char[] cArr, int i) {
        ...
        if (cArr2 == null) {
            cArr2 = f9856a.mo81k(this._value);
    ...
    public int appendQuotedUTF8(byte[] bArr, int i) {
        ...
        if (bArr2 == null) {
            bArr2 = f9856a.mo82l(this._value);
    ...
    public int appendUnquotedUTF8(byte[] bArr, int i) {
        ...
        if (bArr2 == null) {
            bArr2 = f9856a.mo80i(this._value);
    ...
    public final char[] asQuotedChars() {
        ...
        char[] k = f9856a.mo81k(this._value);
        this._quotedChars = k;
        return k;
    }
    ...
    public final byte[] asQuotedUTF8() {
        ...
        byte[] l = f9856a.mo82l(this._value);
        this._quotedUTF8Ref = l;
        return l;
    }
    ...
    public final byte[] asUnquotedUTF8() {
        ...
        byte[] i = f9856a.mo80i(this._value);
        this._unquotedUTF8Ref = i;
        return i;
    }
