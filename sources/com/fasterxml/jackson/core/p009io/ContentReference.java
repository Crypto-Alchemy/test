...
public class ContentReference implements Serializable {
    ...
    public static final ContentReference UNKNOWN_CONTENT = new ContentReference(false, (Object) null);
    ...
    public boolean _appendEscaped(StringBuilder sb, int i) {
        ...
        sb.append('\\');
        sb.append('u');
        sb.append(ud0.m28152l((i >> 12) & 15));
        sb.append(ud0.m28152l((i >> 8) & 15));
        sb.append(ud0.m28152l((i >> 4) & 15));
        sb.append(ud0.m28152l(i & 15));
        return true;
    }
    ...
    public String buildSourceDescription() {
        return appendSourceDescription(new StringBuilder(MlKitException.CODE_SCANNER_UNAVAILABLE)).toString();
    }
