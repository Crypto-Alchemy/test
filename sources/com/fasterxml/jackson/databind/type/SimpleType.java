...
public class SimpleType extends TypeBase {
    ...
    /* renamed from: a */
    public static JavaType m14327a(Class<?> cls, TypeBindings typeBindings) {
        if (cls == null) {
            return null;
        }
        if (cls == Object.class) {
        ...
        return new SimpleType(cls, typeBindings, m14327a(cls.getSuperclass(), typeBindings), (JavaType[]) null, (Object) null, (Object) null, false);
    }
    ...
    public static SimpleType construct(Class<?> cls) {
        if (Map.class.isAssignableFrom(cls)) {
            ...
            return new SimpleType(cls, emptyBindings, m14327a(cls.getSuperclass(), emptyBindings), (JavaType[]) null, (Object) null, (Object) null, false);
        } else {
