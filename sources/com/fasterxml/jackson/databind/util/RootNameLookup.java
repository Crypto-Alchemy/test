...
public class RootNameLookup implements Serializable {
    ...
    public transient LRUMap<ClassKey, PropertyName> _rootNames = new LRUMap<>(20, MlKitException.CODE_SCANNER_UNAVAILABLE);
    ...
    public PropertyName findRootName(Class<?> cls, MapperConfig<?> mapperConfig) {
        ...
        PropertyName findRootName = mapperConfig.getAnnotationIntrospector().findRootName(mapperConfig.introspectClassAnnotations(cls).mo23462t());
