...
public final class CompactStringObjectMap implements Serializable {
    ...
    /* renamed from: a */
    public static final CompactStringObjectMap f10164a = new CompactStringObjectMap(1, 0, new Object[4]);
    ...
    /* renamed from: b */
    public static final int m14339b(int i) {
        if (i <= 5) {
            return 8;
        }
        if (i <= 12) {
    ...
    /* renamed from: a */
    public final Object mo16946a(String str, int i, Object obj) {
        if (obj == null) {
            return null;
        }
    ...
    public Object find(String str) {
        ...
        return mo16946a(str, hashCode, obj);
    }
