...
public class UnrecognizedPropertyException extends PropertyBindingException {
    ...
    public static UnrecognizedPropertyException from(JsonParser jsonParser, Object obj, String str, Collection<Object> collection) {
        ...
        UnrecognizedPropertyException unrecognizedPropertyException = new UnrecognizedPropertyException(jsonParser2, String.format("Unrecognized field \"%s\" (class %s), not marked as ignorable", new Object[]{str, cls2.getName()}), jsonParser.mo13981q(), cls2, str, collection);
