...
public interface VisibilityChecker<T extends VisibilityChecker<T>> {
    ...
    public static class Std implements VisibilityChecker<Std>, Serializable {
        ...
        /* renamed from: a */
        public final JsonAutoDetect.Visibility mo16030a(JsonAutoDetect.Visibility visibility, JsonAutoDetect.Visibility visibility2) {
        ...
        public Std withOverrides(JsonAutoDetect.Value value) {
            ...
            return _with(mo16030a(this._getterMinLevel, value.getGetterVisibility()), mo16030a(this._isGetterMinLevel, value.getIsGetterVisibility()), mo16030a(this._setterMinLevel, value.getSetterVisibility()), mo16030a(this._creatorMinLevel, value.getCreatorVisibility()), mo16030a(this._fieldMinLevel, value.getFieldVisibility()));
        }
        ...
        public Std withVisibility(PropertyAccessor propertyAccessor, JsonAutoDetect.Visibility visibility) {
            switch (C2020a.f10004a[propertyAccessor.ordinal()]) {
                case 1:
        ...
        public Std with(JsonAutoDetect jsonAutoDetect) {
            ...
            return _with(mo16030a(this._getterMinLevel, jsonAutoDetect.getterVisibility()), mo16030a(this._isGetterMinLevel, jsonAutoDetect.isGetterVisibility()), mo16030a(this._setterMinLevel, jsonAutoDetect.setterVisibility()), mo16030a(this._creatorMinLevel, jsonAutoDetect.creatorVisibility()), mo16030a(this._fieldMinLevel, jsonAutoDetect.fieldVisibility()));
        }
    ...
    public static /* synthetic */ class C2020a {
        ...
        static {
            ...
            L_0x0033:
                int[] r0 = f10004a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f10004a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.introspect.VisibilityChecker.C2020a.<clinit>():void");
        }
    }
