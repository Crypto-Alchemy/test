...
public class UUIDDeserializer extends FromStringDeserializer<UUID> {
    ...
    /* renamed from: c */
    public static int m14118c(byte[] bArr, int i) {
        return (bArr[i + 3] & 255) | (bArr[i] << 24) | ((bArr[i + 1] & 255) << 16) | ((bArr[i + 2] & 255) << 8);
    }

    /* renamed from: d */
    public static long m14119d(byte[] bArr, int i) {
        return ((((long) m14118c(bArr, i + 4)) << 32) >>> 32) | (((long) m14118c(bArr, i)) << 32);
    }
    ...
    /* renamed from: a */
    public final UUID mo15843a(String str, DeserializationContext deserializationContext) throws IOException {
    ...
    /* renamed from: b */
    public final UUID mo15844b(byte[] bArr, DeserializationContext deserializationContext) throws JsonMappingException {
        if (bArr.length == 16) {
            return new UUID(m14119d(bArr, 0), m14119d(bArr, 8));
        }
    ...
    public UUID _deserialize(String str, DeserializationContext deserializationContext) throws IOException {
        if (str.length() == 36) {
            if (!(str.charAt(8) == '-' && str.charAt(13) == '-' && str.charAt(18) == '-' && str.charAt(23) == '-')) {
                mo15843a(str, deserializationContext);
            }
            ...
            return mo15844b(C3514vx.m29159a().decode(str), deserializationContext);
        } else {
            return mo15843a(str, deserializationContext);
        }
    }

    public UUID _deserializeEmbedded(Object obj, DeserializationContext deserializationContext) throws IOException {
        if (obj instanceof byte[]) {
            return mo15844b((byte[]) obj, deserializationContext);
        }
