...
public class BeanPropertyMap implements Iterable<SettableBeanProperty>, Serializable {
    ...
    public BeanPropertyMap(boolean z, Collection<SettableBeanProperty> collection, Map<String, List<PropertyName>> map, Locale locale) {
        ...
        this._aliasDefs = map;
        this._locale = locale;
        this._aliasMapping = mo15560e(map, z, locale);
        init(collection);
    }
    ...
    /* renamed from: s */
    public static final int m14058s(int i) {
        if (i <= 5) {
            return 8;
        }
        if (i <= 12) {
    ...
    /* renamed from: e */
    public final Map<String, String> mo15560e(Map<String, List<PropertyName>> map, boolean z, Locale locale) {
    ...
    public Iterator<SettableBeanProperty> iterator() {
        return mo15575r().iterator();
    }

    /* renamed from: j */
    public final SettableBeanProperty mo15570j(String str, int i, Object obj) {
        if (obj == null) {
            return mo15573o(this._aliasMapping.get(str));
        }
    ...
    /* renamed from: k */
    public final SettableBeanProperty mo15571k(String str, int i, Object obj) {
        int i2 = this._hashMask + 1;
        int i3 = ((i >> 1) + i2) << 1;
        Object obj2 = this._hashArea[i3];
        if (str.equals(obj2)) {
    ...
    /* renamed from: n */
    public final int mo15572n(SettableBeanProperty settableBeanProperty) {
    ...
    /* renamed from: o */
    public final SettableBeanProperty mo15573o(String str) {
        if (str == null) {
            return null;
        }
        int q = mo15574q(str);
        ...
        return mo15571k(str, q, obj);
    }

    /* renamed from: q */
    public final int mo15574q(String str) {
        return str.hashCode() & this._hashMask;
    }

    /* renamed from: r */
    public final List<SettableBeanProperty> mo15575r() {
        ...
        for (int i = 1; i < length; i += 2) {
            ...
            if (settableBeanProperty2 != null) {
                if (z || !(z = propertyName.equals(objArr[i - 1]))) {
                    ...
                    this._propsInOrder[mo15572n(settableBeanProperty2)] = null;
                }
            }
        }
        if (z) {
    ...
    public void replace(SettableBeanProperty settableBeanProperty, SettableBeanProperty settableBeanProperty2) {
        ...
        for (int i = 1; i < length; i += 2) {
            ...
            if (objArr[i] == settableBeanProperty) {
                ...
                this._propsInOrder[mo15572n(settableBeanProperty)] = settableBeanProperty2;
                return;
            }
        }
    ...
    public BeanPropertyMap withProperty(SettableBeanProperty settableBeanProperty) {
        ...
        for (int i = 1; i < length; i += 2) {
            ...
            if (settableBeanProperty2 != null && settableBeanProperty2.getName().equals(propertyName)) {
                return new BeanPropertyMap(this, settableBeanProperty, i, mo15572n(settableBeanProperty2));
            }
        }
        return new BeanPropertyMap(this, settableBeanProperty, propertyName, mo15574q(propertyName));
    }
    ...
    public BeanPropertyMap withoutProperties(Collection<String> collection, Collection<String> collection2) {
        ...
        ArrayList arrayList = new ArrayList(r0);
        for (SettableBeanProperty settableBeanProperty : this._propsInOrder) {
            if (settableBeanProperty != null && !IgnorePropertiesUtil.m14343c(settableBeanProperty.getName(), collection, collection2)) {
                arrayList.add(settableBeanProperty);
            }
        }
        return new BeanPropertyMap(this._caseInsensitive, (Collection<SettableBeanProperty>) arrayList, this._aliasDefs, this._locale);
    ...
    public SettableBeanProperty find(String str) {
        if (str != null) {
            ...
            return mo15570j(str, hashCode, obj);
        }
