...
public class InetAddressSerializer extends StdScalarSerializer<InetAddress> implements ls0 {
    ...
    public p000.y63<?> createContextual(p000.zw5 r2, com.fasterxml.jackson.databind.BeanProperty r3) throws com.fasterxml.jackson.databind.JsonMappingException {
        ...
        L_0x0025:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.ser.std.InetAddressSerializer.createContextual(zw5, com.fasterxml.jackson.databind.BeanProperty):y63");
    }
    ...
    public void serialize(InetAddress inetAddress, JsonGenerator jsonGenerator, zw5 zw5) throws IOException {
        String str;
        if (this._asNumeric) {
    ...
    public void serializeWithType(InetAddress inetAddress, JsonGenerator jsonGenerator, zw5 zw5, m17 m17) throws IOException {
        WritableTypeId g = m17.mo16712g(jsonGenerator, m17.mo23020f(inetAddress, InetAddress.class, JsonToken.VALUE_STRING));
        serialize(inetAddress, jsonGenerator, zw5);
