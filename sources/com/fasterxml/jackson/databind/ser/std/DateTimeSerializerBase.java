...
public abstract class DateTimeSerializerBase<T> extends StdScalarSerializer<T> implements ls0 {
    ...
    public void _acceptJsonFormatVisitor(t43 t43, JavaType javaType, boolean z) throws JsonMappingException {
        if (z) {
            visitIntFormat(t43, javaType, JsonParser.NumberType.LONG, JsonValueFormat.UTC_MILLISEC);
        } else {
            visitStringFormat(t43, javaType, JsonValueFormat.DATE_TIME);
        }
    }

    public boolean _asTimestamp(zw5 zw5) {
        ...
        if (zw5 != null) {
            return zw5.isEnabled(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS);
        }
        throw new IllegalArgumentException("Null SerializerProvider passed for " + handledType().getName());
    }

    public void _serializeAsString(Date date, JsonGenerator jsonGenerator, zw5 zw5) throws IOException {
        if (this._customFormat == null) {
            zw5.defaultSerializeDateValue(date, jsonGenerator);
            return;
        }
        ...
        jsonGenerator.mo13860Z0(andSet.format(date));
        ao0.m10672a(this._reusedCustomFormat, (Object) null, andSet);
    }
    ...
    public void acceptJsonFormatVisitor(t43 t43, JavaType javaType) throws JsonMappingException {
        _acceptJsonFormatVisitor(t43, javaType, _asTimestamp(t43.mo25637b()));
    }
    ...
    public y63<?> createContextual(zw5 zw5, BeanProperty beanProperty) throws JsonMappingException {
        ...
        DateFormat dateFormat = zw5.getConfig().getDateFormat();
        ...
        if (!(dateFormat instanceof SimpleDateFormat)) {
            zw5.reportBadDefinition((Class<?>) handledType(), String.format("Configured `DateFormat` (%s) not a `SimpleDateFormat`; cannot configure `Locale` or `TimeZone`", new Object[]{dateFormat.getClass().getName()}));
        }
