...
public class ViewPortHandler {
    ...
    public float mChartHeight = Utils.FLOAT_EPSILON;
    public float mChartWidth = Utils.FLOAT_EPSILON;
    ...
    public boolean hasChartDimens() {
        if (this.mChartHeight <= Utils.FLOAT_EPSILON || this.mChartWidth <= Utils.FLOAT_EPSILON) {
            return false;
        }
        return true;
    }
    ...
    public boolean hasNoDragOffset() {
        if (this.mTransOffsetX > Utils.FLOAT_EPSILON || this.mTransOffsetY > Utils.FLOAT_EPSILON) {
            return false;
        }
        return true;
    }
    ...
    public boolean isInBoundsBottom(float f) {
        if (this.mContentRect.bottom >= ((float) ((int) (f * 100.0f))) / 100.0f) {
            return true;
        }
        return false;
    }
    ...
    public boolean isInBoundsRight(float f) {
        if (this.mContentRect.right >= (((float) ((int) (f * 100.0f))) / 100.0f) - 1.0f) {
            return true;
        }
        return false;
    }
