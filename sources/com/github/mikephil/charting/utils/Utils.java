...
public abstract class Utils {
    ...
    private static final int[] POW_10 = {1, 10, 100, 1000, 10000, NodeSerialization.LONGEST_EAGER_ALLOC, PlaybackException.CUSTOM_ERROR_CODE_BASE, 10000000, 100000000, Http2Connection.DEGRADED_PONG_TIMEOUT_NS};
    ...
    public static void drawImage(Canvas canvas, Drawable drawable, int i, int i2, int i3, int i4) {
        ...
        instance.f10199x = (float) (i - (i3 / 2));
        instance.f10200y = (float) (i2 - (i4 / 2));
        ...
        canvas.translate(instance.f10199x, instance.f10200y);
    ...
    public static void drawMultilineText(Canvas canvas, StaticLayout staticLayout, float f, float f2, TextPaint textPaint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != FLOAT_EPSILON) {
            ...
            if (!(mPPointF.f10199x == 0.5f && mPPointF.f10200y == 0.5f)) {
                FSize sizeOfRotatedRectangleByDegrees = getSizeOfRotatedRectangleByDegrees(width, lineCount, f3);
                f -= sizeOfRotatedRectangleByDegrees.width * (mPPointF.f10199x - 0.5f);
                f2 -= sizeOfRotatedRectangleByDegrees.height * (mPPointF.f10200y - 0.5f);
            ...
            float f8 = mPPointF.f10199x;
            if (!(f8 == FLOAT_EPSILON && mPPointF.f10200y == FLOAT_EPSILON)) {
                f4 -= width * f8;
                f5 -= lineCount * mPPointF.f10200y;
            }
            canvas.save();
    ...
    public static void drawXAxisValue(Canvas canvas, String str, float f, float f2, Paint paint, MPPointF mPPointF, float f3) {
        ...
        if (f3 != FLOAT_EPSILON) {
            ...
            if (!(mPPointF.f10199x == FLOAT_EPSILON && mPPointF.f10200y == FLOAT_EPSILON)) {
                f4 -= ((float) mDrawTextRectBuffer.width()) * mPPointF.f10199x;
                f5 -= fontMetrics * mPPointF.f10200y;
            }
