...
public class FileUtils {
    ...
    public static java.util.List<com.github.mikephil.charting.data.BarEntry> loadBarEntriesFromAssets(android.content.res.AssetManager r4, java.lang.String r5) {
        ...
        L_0x001a:
            ...
            float r4 = java.lang.Float.parseFloat(r4)     // Catch:{ IOException -> 0x0044, all -> 0x0041 }
            r5.<init>((float) r1, (float) r4)     // Catch:{ IOException -> 0x0044, all -> 0x0041 }
    ...
    public static java.util.List<com.github.mikephil.charting.data.Entry> loadEntriesFromAssets(android.content.res.AssetManager r6, java.lang.String r7) {
        /*
            ...
            java.io.InputStream r6 = r6.open(r7)     // Catch:{ IOException -> 0x0070 }
            java.lang.String r7 = "UTF-8"
            r3.<init>(r6, r7)     // Catch:{ IOException -> 0x0070 }
            r2.<init>(r3)     // Catch:{ IOException -> 0x0070 }
            java.lang.String r6 = r2.readLine()     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
        L_0x001a:
            if (r6 == 0) goto L_0x0064
            java.lang.String r7 = "#"
            java.lang.String[] r6 = r6.split(r7)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            int r7 = r6.length     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            r1 = 2
            r3 = 0
            r4 = 1
            if (r7 > r1) goto L_0x003d
            com.github.mikephil.charting.data.Entry r7 = new com.github.mikephil.charting.data.Entry     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            r1 = r6[r4]     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            float r1 = java.lang.Float.parseFloat(r1)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            r6 = r6[r3]     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            float r6 = java.lang.Float.parseFloat(r6)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            r7.<init>(r1, r6)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            r0.add(r7)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            goto L_0x005f
        L_0x003d:
            int r7 = r6.length     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            int r7 = r7 - r4
            float[] r1 = new float[r7]     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
        L_0x0041:
            if (r3 >= r7) goto L_0x004e
            r5 = r6[r3]     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            float r5 = java.lang.Float.parseFloat(r5)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            r1[r3] = r5     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            int r3 = r3 + 1
            goto L_0x0041
        L_0x004e:
            com.github.mikephil.charting.data.BarEntry r7 = new com.github.mikephil.charting.data.BarEntry     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            int r3 = r6.length     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            int r3 = r3 - r4
            r6 = r6[r3]     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            int r6 = java.lang.Integer.parseInt(r6)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            float r6 = (float) r6     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            r7.<init>((float) r6, (float[]) r1)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            r0.add(r7)     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
        L_0x005f:
            java.lang.String r6 = r2.readLine()     // Catch:{ IOException -> 0x006b, all -> 0x0068 }
            goto L_0x001a
