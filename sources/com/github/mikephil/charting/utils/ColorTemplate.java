...
public class ColorTemplate {
    ...
    public static final int[] LIBERTY_COLORS = {Color.rgb(MlKitException.CODE_SCANNER_GOOGLE_PLAY_SERVICES_VERSION_TOO_OLD, 248, 246), Color.rgb(Code39Reader.ASTERISK_ENCODING, 212, 212), Color.rgb(136, 180, 187), Color.rgb(118, 174, 175), Color.rgb(42, 109, 130)};
