...
public class MoveViewJob extends ViewPortJob {
    ...
    static {
        ObjectPool<MoveViewJob> create = ObjectPool.create(2, new MoveViewJob((ViewPortHandler) null, Utils.FLOAT_EPSILON, Utils.FLOAT_EPSILON, (Transformer) null, (View) null));
        pool = create;
