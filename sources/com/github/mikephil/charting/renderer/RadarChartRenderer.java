...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    public void drawDataSet(Canvas canvas, IRadarDataSet iRadarDataSet, int i) {
        ...
        for (int i2 = 0; i2 < iRadarDataSet.getEntryCount(); i2++) {
            ...
            if (!Float.isNaN(instance.f10199x)) {
                if (!z) {
        ...
        if (iRadarDataSet.getEntryCount() > i) {
            path.lineTo(centerOffsets.f10199x, centerOffsets.f10200y);
        }
        path.close();
    ...
    public void drawHighlightCircle(Canvas canvas, MPPointF mPPointF, float f, float f2, int i, int i2, float f3) {
        ...
        if (i != 1122867) {
            ...
            path.reset();
            path.addCircle(mPPointF.f10199x, mPPointF.f10200y, convertDpToPixel, Path.Direction.CW);
            if (convertDpToPixel2 > Utils.FLOAT_EPSILON) {
                path.addCircle(mPPointF.f10199x, mPPointF.f10200y, convertDpToPixel2, Path.Direction.CCW);
            }
        ...
        if (i2 != 1122867) {
            ...
            canvas.drawCircle(mPPointF.f10199x, mPPointF.f10200y, convertDpToPixel, this.mHighlightCirclePaint);
        }
        canvas.restore();
    }
        ...
        while (i4 < length) {
            ...
            if (iRadarDataSet != null && iRadarDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(radarEntry, iRadarDataSet)) {
                    ...
                    highlight.setDraw(instance.f10199x, instance.f10200y);
                    drawHighlightLines(canvas, instance.f10199x, instance.f10200y, iRadarDataSet);
                    if (iRadarDataSet.isDrawHighlightCircleEnabled() && !Float.isNaN(instance.f10199x) && !Float.isNaN(instance.f10200y)) {
    ...
    public void drawValues(Canvas canvas) {
        ...
        while (i4 < ((RadarData) this.mChart.getData()).getDataSetCount()) {
            ...
            if (!shouldDrawValues(iRadarDataSet2)) {
                ...
                instance3.f10199x = Utils.convertDpToPixel(instance3.f10199x);
                instance3.f10200y = Utils.convertDpToPixel(instance3.f10200y);
                int i5 = 0;
                while (i5 < iRadarDataSet2.getEntryCount()) {
                    ...
                    if (iRadarDataSet2.isDrawValuesEnabled()) {
                        ...
                        float f4 = instance.f10199x;
                        radarEntry = radarEntry2;
                        float f5 = instance.f10200y - convertDpToPixel;
                    ...
                    if (radarEntry.getIcon() != null && iRadarDataSet.isDrawIconsEnabled()) {
                        ...
                        Utils.getPosition(centerOffsets, (radarEntry.getY() * factor * phaseY) + mPPointF.f10200y, f3 + this.mChart.getRotationAngle(), instance2);
                        float f8 = instance2.f10200y + mPPointF.f10199x;
                        instance2.f10200y = f8;
                        Utils.drawImage(canvas, icon, (int) instance2.f10199x, (int) f8, icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                    }
                    i5 = i2 + 1;
                    instance3 = mPPointF;
    ...
    public void drawWeb(Canvas canvas) {
        ...
        for (int i = 0; i < entryCount; i += skipWebLineCount) {
            ...
            canvas.drawLine(centerOffsets.f10199x, centerOffsets.f10200y, instance.f10199x, instance.f10200y, this.mWebPaint);
        }
        MPPointF.recycleInstance(instance);
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            while (i4 < ((RadarData) this.mChart.getData()).getEntryCount()) {
                ...
                canvas.drawLine(instance2.f10199x, instance2.f10200y, instance3.f10199x, instance3.f10200y, this.mWebPaint);
            }
        }
        MPPointF.recycleInstance(instance2);
        MPPointF.recycleInstance(instance3);
