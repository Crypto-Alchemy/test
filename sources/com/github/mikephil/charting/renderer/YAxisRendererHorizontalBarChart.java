...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f10197x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f10197x) - 1.0f, this.mViewPortHandler.contentBottom());
