...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public void calculateOffsets() {
        ...
        if (this.mData != null) {
            ...
            float f = centerOffsets.f10199x;
            float f2 = centerOffsets.f10200y;
    ...
    public MPPointF getCenterTextOffset() {
        ...
        return MPPointF.getInstance(mPPointF.f10199x, mPPointF.f10200y);
    }
    ...
    public float[] getMarkerPosition(Highlight highlight) {
        ...
        double d = (double) f2;
        float cos = (float) ((Math.cos(Math.toRadians((double) (((this.mAbsoluteAngles[x] + rotationAngle) - f3) * this.mAnimator.getPhaseY()))) * d) + ((double) centerCircleBox.f10199x));
        MPPointF.recycleInstance(centerCircleBox);
        return new float[]{cos, (float) ((d * Math.sin(Math.toRadians((double) (((rotationAngle + this.mAbsoluteAngles[x]) - f3) * this.mAnimator.getPhaseY())))) + ((double) centerCircleBox.f10200y))};
    }
    ...
    public void setCenterTextOffset(float f, float f2) {
        this.mCenterTextOffset.f10199x = Utils.convertDpToPixel(f);
        this.mCenterTextOffset.f10200y = Utils.convertDpToPixel(f2);
    }
