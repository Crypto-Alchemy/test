...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>> extends Chart<T> {
    ...
    public static /* synthetic */ class C20932 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f10176x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r2 = f10175x2787f53e     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r2 = f10175x2787f53e     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0054:
                int[] r1 = f10177xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005e }
            ...
            L_0x005e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.PieRadarChartBase.C20932.<clinit>():void");
        }
    }
    ...
    public void calculateOffsets() {
        /*
            ...
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C20932.f10176x9c9dbef
            com.github.mikephil.charting.components.Legend r3 = r11.mLegend
        ...
        L_0x0051:
            ...
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C20932.f10177xc926f1ec
            com.github.mikephil.charting.components.Legend r5 = r11.mLegend
        ...
        L_0x0122:
            int[] r2 = com.github.mikephil.charting.charts.PieRadarChartBase.C20932.f10175x2787f53e
            com.github.mikephil.charting.components.Legend r5 = r11.mLegend
            ...
            goto L_0x014a
        L_0x0138:
            int[] r0 = com.github.mikephil.charting.charts.PieRadarChartBase.C20932.f10177xc926f1ec
            com.github.mikephil.charting.components.Legend r2 = r11.mLegend
            com.github.mikephil.charting.components.Legend$LegendVerticalAlignment r2 = r2.getVerticalAlignment()
            int r2 = r2.ordinal()
            r0 = r0[r2]
    ...
    public float distanceToCenter(float f, float f2) {
        ...
        float f5 = centerOffsets.f10199x;
        if (f > f5) {
            f3 = f - f5;
        } else {
            f3 = f5 - f;
        }
        float f6 = centerOffsets.f10200y;
        if (f2 > f6) {
            f4 = f2 - f6;
        } else {
            f4 = f6 - f2;
    ...
    public float getAngleForPoint(float f, float f2) {
        MPPointF centerOffsets = getCenterOffsets();
        double d = (double) (f - centerOffsets.f10199x);
        double d2 = (double) (f2 - centerOffsets.f10200y);
        float degrees = (float) Math.toDegrees(Math.acos(d2 / Math.sqrt((d * d) + (d2 * d2))));
        if (f > centerOffsets.f10199x) {
    ...
    public void getPosition(MPPointF mPPointF, float f, float f2, MPPointF mPPointF2) {
        double d = (double) f;
        double d2 = (double) f2;
        mPPointF2.f10199x = (float) (((double) mPPointF.f10199x) + (Math.cos(Math.toRadians(d2)) * d));
        mPPointF2.f10200y = (float) (((double) mPPointF.f10200y) + (d * Math.sin(Math.toRadians(d2))));
    }
