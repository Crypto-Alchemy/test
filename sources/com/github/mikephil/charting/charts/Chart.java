...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    public float mMaxHighlightDistance = Utils.FLOAT_EPSILON;
    ...
    public static /* synthetic */ class C20912 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.Chart.C20912.<clinit>():void");
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.mNoDataText)) {
                ...
                canvas.drawText(this.mNoDataText, center.f10199x, center.f10200y, this.mInfoPaint);
            }
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        int i2 = C20912.$SwitchMap$android$graphics$Bitmap$CompressFormat[compressFormat.ordinal()];
