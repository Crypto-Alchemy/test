...
public final class ScheduledRunnable extends AtomicReferenceArray<Object> implements Runnable, Callable<Object>, th1 {
    ...
    public ScheduledRunnable(Runnable runnable, uh1 uh1) {
        super(3);
    ...
    public void dispose() {
        ...
        L_0x004b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p018io.reactivex.internal.schedulers.ScheduledRunnable.dispose():void");
    }
